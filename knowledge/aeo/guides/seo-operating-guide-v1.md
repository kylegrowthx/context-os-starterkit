<metadata>
purpose: Complete operating system for running SEO engagements — mental models, scoring frameworks, and the EM practitioner playbook
audience: GrowthX Engagement Managers running client SEO work
summary: Mental models, site scoring framework (8 dimensions), content scoring framework (7 dimensions), and the practitioner playbook for running SEO engagements at GrowthX.
...
For the full evidence behind these signals, see the SEO ranking factors guide. For now, what matters is the mental model: every recommendation you make to a client should improve either their perceived quality or their real-world popularity. If it doesn't do either, question why you're doing it.
...
**Layer 2: Content.** Where we spend most of our time. Topics organized into clusters, not keyword lists. Each page targets a group of related keywords. Content matches the searcher's actual intent. Depth demonstrates expertise. Refreshed quarterly.

**Layer 3: Authority.** Content alone won't rank in competitive spaces. You need external validation. Backlinks from relevant sources. Topical authority through consistent deep coverage. Author credentials that show real experience. This layer compounds over time.

**Layer 4: Visibility.** The new frontier. Being cited in AI Overviews, ChatGPT, Perplexity. Getting featured snippets. Brand recognition that drives people to search for your client by name. This is where the game is shifting fastest. See our AEO playbooks for the tactical frameworks.
...
Your job is to make sure the work compounds. Not to chase one-off tactics. This is the same system mindset that drives all of GrowthX delivery.
...
"We're doing this because Google confirmed it under oath" lands differently than "this is SEO best practice." Use the hierarchy when reporting to clients.

---

## What actually moves rankings

Ordered by evidence strength and impact. The full data behind each of these lives in the ranking factors guide.
...
2. **Content relevance.** Text relevance appears in 90.6% of top-10 results (Semrush). Content must match the searcher's intent. Not just contain the right keywords. Actually answer what they're looking for, in the format they expect. See our content quality standards for what "good" looks like.
...
4. **Content depth and topical authority.** Google's leaked docs confirm siteFocusScore and siteRadius. They literally measure how deep your coverage is. Pages with high topical authority gain traffic 57% faster (Graphite). Content grouped into clusters drives 30% more traffic and holds rankings 2.5x longer (HireGrowth, 2025).
...
8. **Schema markup.** Not a direct ranking factor, but drives rich results (82% higher CTR). Increasingly important for AI citation.

9. **Content freshness.** 85% of AI Overview citations come from content published in the last 2 years.

10. **AI search optimization.** Answer-first formatting, citation-ready content, semantic completeness. 47% of AI Overview citations come from pages ranking below position 5. You can get cited without traditional top rankings.
...
- **Publishing AI-only content.** Position 16.8 vs. 5.2 for human-edited content.
- **One keyword per page.** Outdated. Cluster related keywords.
...
**The clustering principle.** If Google ranks the same pages for two keywords, those keywords belong on the same page. Different results? Separate pages. This is the SERP Overlap Method. The backbone of all serious keyword work.
...
**The architecture.** Every client engagement should produce a topic map. Not a keyword list. Pillar pages covering core topics. Cluster pages going deep on subtopics. Everything interlinked.
...
For the full framework including tool methodologies, see the keyword optimization guide.
...
See creating good content for what each quality level looks like in practice.

### Dimension 3: Keyword architecture (Layer 2)

| Signal | How to check | Score 1 | Score 3 | Score 5 |
|--------|-------------|---------|---------|---------|
| Cluster structure | Content mapping audit | No topic organization | Some loose groupings | Clear pillar-cluster architecture with internal linking |
...
For AEO-specific scoring and strategy, see the buyer evaluation playbook and prompt prioritization guide.
...
Use this before anything publishes. Score each dimension 1-5. This pairs directly with our content quality standards.
...
**Check:** Would Google's quality raters see this as coming from someone with genuine experience? The ranking factors guide covers E-E-A-T in detail.
...
**Check:** Read it aloud. If you wouldn't say it to a smart friend, rewrite it. Our writing style guide has the full framework.
...
This dovetails directly with the 8-week engagement plan. Week 1 kickoff includes the content audit. The site score gives you the data to shape weeks 2-8.
...
1. Build the topic map. Clusters, not keyword lists. Use the clustering frameworks.
...
> **Note:** This guide synthesizes the SEO ranking factors guide and keyword optimization guide into what you need to run engagements. For full evidence, source citations, and learning paths, see those guides.
