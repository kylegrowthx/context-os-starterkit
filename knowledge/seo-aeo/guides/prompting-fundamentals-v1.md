<metadata>
purpose: Practical guide for writing effective prompts and using AI tools across every role at GrowthX
audience: All GrowthX team members — technical and non-technical
summary: How to write clear prompts, use AI for drafting, editing, and brainstorming, choose the right tools, and troubleshoot when you're stuck.
...
For deeper coverage of prompt structure, techniques like chain-of-thought and few-shot examples, and building production-grade prompts, see our Prompt design fundamentals guide.
...
> **Tip:** For how we build AI-powered workflows and agentic pipelines at GrowthX, see Agentic pipelines.
...
**Products (ChatGPT, Claude.ai)** — Internet access, conversation memory, file upload, plugin integrations.

**APIs (raw)** — No memory between calls, no internet access, text-only, needs custom code for features.

> **Warning:** When using GrowthX workflows, always assume **API-level capabilities**. Workflows don't have web search or database access — they will fabricate information if asked to provide examples or case studies they don't have context for.
...
> **Tip:** You don't need the perfect prompt on the first try. Ask the AI to revise and improve its answer.
...
> **Note:** This works best for people with substantial public writing. Otherwise, provide voice samples directly in your prompt.
...
### Beginner, Advanced, and Expert prompts
...
### Prompts to improve output quality
...
### Prompts to break out of safe mode
...
### Prompts to realign understanding
