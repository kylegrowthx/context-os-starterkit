...
participants: Tiandra Burns, Feyisayo Odedeyi
...
To guide Feyisayo through the Airby Article Refresher workflow and troubleshoot Surfer SEO scoring inconsistencies.
...
**Feyisayo Odedeyi:** The second one I did was 91, and the first one was very low, the first one was 30, and all of them have the same content throughout, this is straight from Abyte, this is like without edits or anything, so it's the same content, but with different scores, so I'm not sure why it's asking that.
...
**Feyisayo Odedeyi:** mean, this is one and this is the other one.
...
**Feyisayo Odedeyi:** Let me stop sharing for lunch.

**Feyisayo Odedeyi:** me or.
...
**Tiandra Burns:** I need you to look Yeah.
...
**Feyisayo Odedeyi:** And I'll work with this one, and I'll try and use Aerops to fix the article, and hopefully this will be nice.
...
**Tiandra Burns:** I'm going to share this recording with you, and so that way you can look back at the Aerops workflow, and if you need anything, me.
