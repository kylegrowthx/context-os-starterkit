...
participants: Ademosu Oluwatimilehin 210807112, Matthew Panzarino, Mariana Marins, Bisera Stankovska, Fatima Tahir, Simran Sethi, Ehtisham Hussain, Usman Adepoju, Martha Martins, Ismail Ajagbe, Moses, Tiandra Burns, Jessica Nicole Manificiar Gayo, Jürgen Linde, Ademilade Shodipe-Dosunmu, Elvis, Sucheta, Josip Sovar, Nemanja, Mariana, Matthew Hill, David, Carrie Chowske, rachelpasche, vivek@growthxlabs.com, Jess Scott, Usman Ghani, Nika Narimanidze, Jenn, Jessalynn, Feyisayo, Sydney Go, Jenny Macrohon Dabon, Deya, Saskia Wartnaby, Andi Bailey
...
Daily standup to discuss Atlas workflow setup and transition from AirOps
...
**Ademosu Oluwatimilehin 210807112**
- Review+update artifacts (company context, user contacts, etc.). Ensure dense, robust info. Check if ported correctly from AirOps.
...
**Matthew Panzarino**
- Check w/ EPD team re mapping of assignment direction field in Atlas pipelines. Clarify its function+proper usage.

- Follow up w/ Kirkland re blank outline output bug in Atlas. Ensure issue addressed ASAP.

- Verify status of TERO workspace in Atlas. Ensure all necessary artifacts present+correctly populated.

---

## Transcript
**Ademosu Oluwatimilehin 210807112:** Thank Thank you.
...
**Jenn:** For me, it's currently Dimmel is the one.

**Jenn:** So, I kind of just assumed it was me putting it in the wrong format.

**Jenn:** So, I didn't have the same issue as Jess.

**Jenn:** Mine actually did have an output in mine.

**Jenn:** But, yeah, like the format.
...
**Jenn:** Yeah, for this batch.

**Jenn:** We're currently in backlog, so yeah, for this batch, for sure.

**Jenn:** But yeah, it sounds like it's like everybody's experiencing it.

**Jenn:** So I thought it was me like formatting it wrong or whatever.
...
**rachelpasche:** I have a quick thing I just want to flag.

**rachelpasche:** I submitted a ticket for it.

**rachelpasche:** One of my workspaces was set up as the wrong company, which is something to be aware of if anybody's getting, like, funky results, because I couldn't figure out why my things were coming through completely wrong.

**rachelpasche:** And then I went in and I looked at, like, all the instructions, and I was like, this is not supposed to be an email marketing campaign.

**rachelpasche:** It's supposed to be, you know, a dentist hiring platform.
...
**rachelpasche:** I'm already

**rachelpasche:** Can I, yeah, I took everything out, and I've been putting stuff back in.

**rachelpasche:** The one thing I wasn't sure about was the writing instructions, like for tone and voice and stuff.

**rachelpasche:** I couldn't figure out where that was in Atlas, and maybe that's just, like, having a hard time.
...
**rachelpasche:** Hero, T-E-R-O.

**rachelpasche:** T-E-O.

**Matthew Panzarino:** I'm sorry, it's, the T was a little soft.

**rachelpasche:** I was looking for hero, I'm like.
...
**rachelpasche:** Yeah, I've done that one.
...
**rachelpasche:** I didn't know if it was, like, not fleshed out enough because it was – they're, like, an early-days customer, so their Notion board is, like, a lot more sparse than – It might be.

**Matthew Panzarino:** Yeah, it's true.

**rachelpasche:** Some of the more recent ones, so I didn't know if that was a problem or if I should just kind of work with what I have.
...
**rachelpasche:** Uh, you can start there.
...
**Ademosu Oluwatimilehin 210807112:** Hi, Panzer.

**Matthew Panzarino:** Yeah.

**Ademosu Oluwatimilehin 210807112:** Thanks for the demo.

**Ademosu Oluwatimilehin 210807112:** So, this isn't about the workflows.

**Ademosu Oluwatimilehin 210807112:** I just wanted to ask about the rationale behind the recent port changes and the scenes that were just moved around.

**Ademosu Oluwatimilehin 210807112:** So, this would be there.
...
**Matthew Hill:** Yeah, I was just gonna say, on using Aerobs, I don't know if it's related, or it's just my grid, but,

**Matthew Hill:** I actually tried to run a VAPI article through Aerofs earlier, and I was getting, like, random errors that seemed like bugs.

**Matthew Hill:** It was telling me it couldn't find, like, certain fields.

**Matthew Hill:** So I don't know if that's part of, like, the decommissioning or whatever, but people might find that it's not going to work anyway.
...
**Ademosu Oluwatimilehin 210807112:** And so if those are being deprecated or shut down, it's very possible the Aerofs flows could not work at all.
