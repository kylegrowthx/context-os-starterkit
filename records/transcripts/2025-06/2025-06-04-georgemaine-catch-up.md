...
participants: Georgemaine Lourens, Daniel Lopes
...
Onboarding and project update for new team member Georgemaine
...
### Company Structure and Projects
  ...
  - Two main teams: strategy and execution
  - Strategy team: Marcel, George, Marisol, Jason (ideation, client pitching)
  - Execution team: Content creation and project management
  - Client ops engineering team: Marcus, Kirkland (workflow creation, client requests)
  - Platform team: Experienced engineers building core tools

### Product Overview

1.  AI Workflow Engine (Flow)
    
      - Core system for creating and running workflows
      - Currently combined with workflow code, plans to separate into a package
      - Potential for multiple verticals (marketing, recruiting, VA/EA services)

2.  Flow Studio
    
      - Web UI for workflow visualization and execution
      - Future plans to evolve into a full IDE for workflow creation and editing
      - Inspired by tools like DBT, aiming for a balance between code and visual interfaces

### Atlas Project

  - Comprehensive content management and SEO tool for clients
  - Key features:
      - Dashboard with metrics (AI visibility, published content)
      - Page and opportunity management
      - Content inventory and SEO auditing
      - Assignment manager for content creation process

### Transition from Third-party Tools

  - Moving away from AirOps and Airtable
  - Developing in-house solutions to reduce costs and improve efficiency
  - Deadline for exiting AirOps platform: June 16th

---

## Action Items

- Georgemaine to complete onboarding and watch Marcel's workshop videos
- Spend next week with client ops engineering team to understand workflows and processes
- Potentially assist with Atlas project development in the following weeks
- Prepare for San Francisco visit at the end of July for in-person team meetings
...
**Daniel Lopes:** So, and he wants to, and he wanted to make the switch to be an engineer, so he's a perfect person for that time.
...
**Daniel Lopes:** So air cable, I think we're paying like something like...

**Daniel Lopes:** We $15,000 a month, and Air Ops were paying like 20 plus, so just on that justifies building the software, but it's also causing confusion, and it's not ideal either.

**Daniel Lopes:** So those are the top two main things in Atlas.

**Daniel Lopes:** And then Brad is also working on making almost like a cursor-like experience, GPT Canvas, where when you're creating the text-based things, you have a chat, but the chat has the context of everything around the company, around the account that you're working for.

**Daniel Lopes:** So that's the priority number three.

**Daniel Lopes:** And then priority number four, essentially in parallel, ideally, we will be building an assignment manager.

**Daniel Lopes:** So assignment is a big part of content creation, where you create, you find the opportunity first, maybe let's say, this is a reflection that we want to do.

**Daniel Lopes:** Then the next step is like, how, you know, and how is the assignment, and this is like a document.

**Daniel Lopes:** Like, a director, a content director would come up with, or a managing editor, and that would be passed down to the people, to the execution team to create it.

**Daniel Lopes:** So, those are the top things, and I'm also working on this, probably I'll do a first pass, if I have time, this week, as the documents that can be used for AI throughout the creation process.

**Daniel Lopes:** Like, that's the document of the products that the company sells, and documents of their personas, and their style guide, and stuff like this.

**Georgemaine Lourens:** Right, so those would kind of be like, the templates that everyone could kind of use to start running off this stuff.

**Daniel Lopes:** Yeah, it's almost like the templates to inform the LLM.

**Daniel Lopes:** So, just like, imagine over the ChatGPT, if you have, if you load a bunch of documents, and then you can ask questions, so that would be the same idea.

**Daniel Lopes:** So, our workflows would like, load those documents, and then the workflows run with that.

**Daniel Lopes:** So, we kind of need that already.

**Daniel Lopes:** And, okay.

**Daniel Lopes:** We hack this today in different ways, but it's kind of like an easier feature.

**Daniel Lopes:** So I was thinking like, I could get your help on either making this, let's say like next week we get you to spend some time with the client ops engineering team helping them with things.

**Daniel Lopes:** have a couple of microapps that they want to try for two different clients.

**Daniel Lopes:** They have our fact checker microapp, too, and they have a handful of like small workflows that are good for like putting something live just to get to the swing of things.

**Daniel Lopes:** And then like the following week, ideally you would get your help in one of these projects.

**Daniel Lopes:** Depending on how far REN is, like it could like hand this to you to actually make the, because the way I'm asking him to work there is just make it rough.

**Daniel Lopes:** Like don't worry about making the super detail, just like, just give us the general sense of like the flow of the screen.

**Daniel Lopes:** Like what are the main areas?

**Daniel Lopes:** The content architecture here, what are the potential rabbit holes, and then have the team figure out the rest.

**Daniel Lopes:** Don't make it super policy details, and then move on to the next thing, because we have so many things to figure out.

**Daniel Lopes:** And I'm more concerned about just information architecture and potential rabbit holes and potential MVPs that we can have to get the agency running on this as soon as possible.

**Daniel Lopes:** If we got the agency to use 50% of this on an MVP that's slightly better than what we do today, which is non-ideal, that would mean we can take in more clients, we can make the clients more happy, and the sooner we can do that, the better.

**Daniel Lopes:** So that's a top priority.

**Daniel Lopes:** And then we have all the workflow stuff that's also the guys are starting to think about, and this would be cool to get your help.

**Daniel Lopes:** Eventually, but maybe for the first month and while you're on board and getting the context of all the things, like helping us get out of the hole with the Atlas project and get the agency scaling would be like a big, big help.
...
**Daniel Lopes:** Yeah, it makes a lot of sense.

**Georgemaine Lourens:** I think the best thing that I can probably do now is just kind of like meet the people on the strategic team and just complete my onboarding and then be a part of the client ops team next week to kind of like get a sense of how they work and also play around with the workflows and then jump in.

**Georgemaine Lourens:** Yeah.

**Daniel Lopes:** Cool, man.

**Daniel Lopes:** Is there any questions that you have?

**Daniel Lopes:** Anything that I can?

**Georgemaine Lourens:** No, I think this pretty much covered it all.

**Georgemaine Lourens:** I just wanted to say hi and get a sense of where your head is at right now and get a feel of my plan for the week.

**Georgemaine Lourens:** It's kind of like on the right track, it kind of seems like it, so, yeah.

**Georgemaine Lourens:** Yeah.

**Daniel Lopes:** Perfect, all right.

**Daniel Lopes:** And, yeah, it'll be cool to have you here and meet you in person with all the other guys.

**Georgemaine Lourens:** Yeah, no, I'll be there at the end of July, so I'll be excited to see you and the rest of the team, It's going to be fun.

**Daniel Lopes:** Have you been to San Francisco, right?

**Georgemaine Lourens:** No, I've never been, so this is the first time.

**Georgemaine Lourens:** But I'm going to be my partner, so we're going to, the first five days, we're going to be hanging out with you guys, and then in the weekend, I'll hang out with my partner in time of July.

**Daniel Lopes:** Nice, yeah, that's a good idea.

**Daniel Lopes:** There's so many cool things around here.

**Daniel Lopes:** All right, thanks for your time.

**Daniel Lopes:** We're super excited to have you here, and so many things to do, and I really need your help.

**Daniel Lopes:** Yeah, likewise.

**Georgemaine Lourens:** All right, have a good one, and I'll talk to you soon.

**Georgemaine Lourens:** All right, see you, man.
