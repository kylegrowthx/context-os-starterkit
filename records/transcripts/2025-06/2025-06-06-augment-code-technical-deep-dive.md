...
participants: Anshuman Pandey, Kirkland Gee, Marisol Smith, George Haikal
...
Deep dive into Augment Code's technical differentiators and product roadmap
...
**Anshuman Pandey**
- Send detailed materials (slides/docs) on Augment features/differentiators to George
...
**George Haikal:** You've already used Dogman, right?
...
**Kirkland Gee:** mean, I know their kind of selling point is we do more on larger code bases, but it'll be good to just chat with them a little bit.

**Kirkland Gee:** But I feel good, like, I understand most of how it works.

**George Haikal:** Love it.

**George Haikal:** Yeah, it's super interesting because I've been doing user interviews with their head of research, too.

**George Haikal:** And the...

**George Haikal:** I mean, you're one of their users, right?
...
**Kirkland Gee:** Someone opened an ad by his Windsor for $3 billion and Cursor gets a $9 billion evaluation in like...

**George Haikal:** Yeah, almost 10, yeah.

**Kirkland Gee:** Like two weeks.

**Kirkland Gee:** That's crazy.

**George Haikal:** Good for Augment.

**George Haikal:** Hopefully, people get a little FOMO.

**Anshuman Pandey:** How you doing, Anshuman?

**Anshuman Pandey:** Hey, what's guys?

**George Haikal:** Good.

**George Haikal:** Am I pronouncing that right, by the way?

**Anshuman Pandey:** Anshuman.

**George Haikal:** Close.

**George Haikal:** Anshuman.

**George Haikal:** see Okay.

**George Haikal:** Thank

**George Haikal:** Jermon, close.

**George Haikal:** Nice, man.

**George Haikal:** Thanks for joining.

**Anshuman Pandey:** Yeah, no worries.

**Anshuman Pandey:** How do you guys know Sill?

**Anshuman Pandey:** What's the background there?

**George Haikal:** Yeah, so where Marcel, our CEO, and Sill go back a year, maybe a little longer.

**George Haikal:** They've been part of the same CMO breakfasts and in the same marketing communities.

**George Haikal:** so that's how they initially met.
...
**Anshuman Pandey:** We're the quality prompt, or and we'll...

**Anshuman Pandey:** We route between multiple models depending on the task at hand.
...
**Anshuman Pandey:** We can do...

**Anshuman Pandey:** search, URL fetching.
...
**Anshuman Pandey:** Because, you know, we built out this large infrastructure and we didn't do a fork and make everything hosted on the user machine, the goal is to do a full platform.

**Anshuman Pandey:** this is kind of going in with our remote agents, right?
...
**Kirkland Gee:** And at this point with augment, like obviously there's JetBrains Vim.
...
**Kirkland Gee:** We partnered with Glean to bring that Glean context inside of the IDE as well.

**Anshuman Pandey:** No CLI or API exposed endpoint, but that's a super common request we get.
...
**Anshuman Pandey:** And I saw, was that a Chrome logo?

**Anshuman Pandey:** Like, you could just use this in the browser also, or?

**Anshuman Pandey:** So that is something we were beta set up.

**Anshuman Pandey:** We're saying Chrome extension for PR reviews.

**Anshuman Pandey:** Okay.

**Anshuman Pandey:** No formalized roadmap to be delivered, so I wouldn't harp on it too much.

**Kirkland Gee:** Yeah, okay.

**Kirkland Gee:** Yeah, that makes sense.

**Kirkland Gee:** Because I'm thinking about, like, for some of these things, like, for if we, say, did a directory of MC servers, right, that we want to be able to directly have an install button, you know, if we just have JetBrains.

**Kirkland Gee:** VS Code, Vim, as install button.

**Kirkland Gee:** That's all we need, right?

**Kirkland Gee:** Because that's what Augment is supported in.

**Anshuman Pandey:** So that's why I ask that kind of question.
...
**Kirkland Gee:** I already set up.

**Kirkland Gee:** I used the Superbase one to get this site going, and it worked flawlessly.
...
**Anshuman Pandey:** What a lot of people say is I'm inside of, you know, a chat thread, and I want to keep that context before I go to agent.
...
**Anshuman Pandey:** We have something different that's memories.

**Anshuman Pandey:** don't know if you played around with memories at all.
...
**Anshuman Pandey:** there.

**Anshuman Pandey:** Let's stack.
...
**Anshuman Pandey:** Yeah, so if I do something, like, super simple, like, write tests for this, you know, it can kind of go awry.

**Anshuman Pandey:** It's like going to Google and saying, find a cat.

**Anshuman Pandey:** Yeah.

**Anshuman Pandey:** you're actually looking for, like, the, you know, heavy machinery sort of.

**Kirkland Gee:** Yeah, yeah, okay.

**Anshuman Pandey:** You see pictures of cats, like, this is where the prompt enhancer comes in.
...
**Kirkland Gee:** Have you gotten a chance to kind of...

**Kirkland Gee:** haven't used the remote one, no, I was just doing everything local.
...
**Anshuman Pandey:** You can, you know, create a different, what's it called, branch.

**Anshuman Pandey:** But what I really like is this remote agents panel where I can kind of...

**Kirkland Gee:** Ah, very good, okay.

**Anshuman Pandey:** All the different agents I've started out, I can open the thread.

**Kirkland Gee:** So I can see the changes that we've done.
...
**Anshuman Pandey:** And then the beauty of it is, like, I can actually SSH into the remote environment.

**Anshuman Pandey:** So then I can edit the files inside of that local SSH dev environment.

**Anshuman Pandey:** I can bring them locally or whatever it might be, or just create a PR directly from the IDE.
...
**Anshuman Pandey:** Same scenario, you connect it with...

**Anshuman Pandey:** GitHub repositories.

**Anshuman Pandey:** Per channel, we can give it a subset of repositories to have access to, and it's sort of a feature parody with chat.
...
**Kirkland Gee:** No, this is...

**Kirkland Gee:** All making sense.

**Kirkland Gee:** I'm just trying to think.

**Anshuman Pandey:** So I'll highlight a couple of other technical separators.
...
**Anshuman Pandey:** Actually, what happens is all the code...

**Anshuman Pandey:** And data is sent to the sub-processes in the cloud where the embeddings are calculated, and then it's stored on a local machine.
...
**Anshuman Pandey:** So we have customer-managed encryption keys, we have the ISO 4201, we never try on any customer data or code.
...
**Anshuman Pandey:** If I come in secondly, Augment's to realize I'm in the same tenant, I don't need to do duplication, so I'm not going to...

**Anshuman Pandey:** So we reduced the amount of copies of code that is out there, and we reduced the index timing for every subsequent user.
...
**Kirkland Gee:** Yeah, this.

**Kirkland Gee:** Oh, I was struck out why I hadn't tried the remote agents yet.

**Kirkland Gee:** I still have to get them the request approved for our growthx GitHub org.

**Kirkland Gee:** I'm Daniel had time to look at it.

**Kirkland Gee:** Because I was like, oh, let me go see this for a second.

**Kirkland Gee:** And then that's why that hasn't happened yet.

**Kirkland Gee:** I'm on Thank

**Anshuman Pandey:** Yeah.

**Anshuman Pandey:** Like the next phase of this is right now sort of all user iterative.

**Anshuman Pandey:** Give it an input, it doesn't output, which is an end state.
...
**Anshuman Pandey:** You know, we're running on.

**Anshuman Pandey:** Clicking notes and whiteboards over here.
...
**Anshuman Pandey:** One is that hyperskill index, and two is a context engine that's able to gather the right data, not the most data.
...
**Anshuman Pandey:** How do we help with...

**Anshuman Pandey:** Documentation.
...
**Anshuman Pandey:** Right now, our primary offering is IDE and agents in the IDE.

**Anshuman Pandey:** Then we're able to abstract that out into like the Slack bot.
...
**Anshuman Pandey:** Then the IDE level where we're like pairing with developers.

**Anshuman Pandey:** And then Augment, I think is the only one set up in the

**Anshuman Pandey:** Future to abstract at a level higher where we can do business logic to code because of how we understand code.
...
**Kirkland Gee:** And you've talked about like target audience.

**Kirkland Gee:** know me and Derek talked a little bit about it.
...
**Anshuman Pandey:** Our ICP in general is like these orgs with from 100 developers to 5,000 developers.
...
**Anshuman Pandey:** Pressure's great.
...
**Anshuman Pandey:** How do I temporatize that?
...
**Anshuman Pandey:** Doing PR reviews.

**Anshuman Pandey:** Because I need to do.

**Anshuman Pandey:** do.

**Anshuman Pandey:** This, you know, language upgrade.
...
**George Haikal:** There might not be a good answer for this one, but what is it is not.

**George Haikal:** Sorry.

**George Haikal:** What is Augment not doing right now that people are asking for?

**Anshuman Pandey:** So niche cases like, you know, you're can you do copal code or Fortran code?

**Anshuman Pandey:** In words, there's not enough data out there and we're never claiming to be good to be good at that.

**Anshuman Pandey:** that.

**Anshuman Pandey:** So

**Anshuman Pandey:** Right?

**Anshuman Pandey:** Yeah, go ahead and use IBM WatsonX for your COBOL to Java upgrade module.
...
**George Haikal:** I mean, I'm pretty clear.

**George Haikal:** This was great.

**George Haikal:** can all get a little time back as well.

**George Haikal:** Anshuman, do you have any materials you could share with us as well that kind of go into the same, if not more, level of depth on everything we talked about?

**George Haikal:** Like a slider or any.

**George Haikal:** Share externally?
...
**George Haikal:** We'll share this recording with our team, obviously, but it would be helpful to have contacts that they can look over.
...
**Anshuman Pandey:** Cheers.

**Anshuman Pandey:** Bye, guys.
