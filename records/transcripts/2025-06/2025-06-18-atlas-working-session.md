...
participants: Jürgen Linde, Matthew Alves-Hill, Carrie Chowske, Jenny Macrohon Dabon, Darrell Etherington, Jessica Nicole Manificiar Gayo, Joe Sovar, Ehtisham Hussain (2), Saskia Wartnaby
...
Atlas working session to discuss initial experiences, issues, and next steps with the new content production tool.
...
**Carrie Chowske**
- Schedule 1-on-1 w/ Joe re Zuplo/Yurko/Good Call work assignments + Atlas transition

- Meet Sadir post-call re Yurko assignments. Determine 8-10 articles/wk. Prep for Joe

- Run Zuplo assignments by client contact. Prep for Joe post-approval

- Continue reviewing Yurko content. Prep feedback for Sadir/Joe
...
**Joe Sovar:** I also did one for Zuclo today, and I also used to carry, like you said, that direction.

**Joe Sovar:** I told him I want a listicle article, and I want all the tools to have the same structure, have pros, cons, and use best for, etc.

**Joe Sovar:** So yeah, it did great.

**Joe Sovar:** In the outline, everything for every tool was the same for every tool.

**Joe Sovar:** And sometimes in Europe, it had to do that manually to structure it, but this was very great.

**Joe Sovar:** Yep, I think the article I had so far, the formatting was also better.
...
**Joe Sovar:** So yeah, we need to put links in that.

**Joe Sovar:** So there is no link in the, in the first person how it's called.

**Joe Sovar:** So yeah, it won't, it won't give us a fact checking internal link.

**Jenny Macrohon Dabon:** So yeah, we need to put that link there.

**Joe Sovar:** Yep.

**Joe Sovar:** This, yeah, right now, it's not even loaded for me.
...
**Joe Sovar:** He said that that's a broader problem, and it's quite common, so then they will fix it.

**Joe Sovar:** So she, he just placed mine as a result.
...
**Ehtisham Hussain (2):** Yeah, filed one, I filed one yesterday, uh, and they filed it under duplicate, uh, because, uh, I was getting an outline in the raw form, but I couldn't edit it.

**Ehtisham Hussain (2):** Check

**Ehtisham Hussain (2):** And the field, the rich text editor field at the output stage was empty, but it was allowing me to move forward and move forward with the article.

**Ehtisham Hussain (2):** I had, I would just quickly summarize my experience with Atlas so far.

**Ehtisham Hussain (2):** I generated the same articles through Aeroops on Friday, and I forgot to save it somewhere.

**Ehtisham Hussain (2):** So I completely, I lost it like on Monday, and I had to use Atlas to generate the exact same article.

**Ehtisham Hussain (2):** That was for Smith AI.

**Ehtisham Hussain (2):** In the workflow, think, Elvis had another step in there, Aeroops, where the AI, I don't know what technology was being used at that step, but it searched for relevant images and then it recommended relevant images to be included in the article.

**Ehtisham Hussain (2):** But I didn't see that in Atlas.

**Ehtisham Hussain (2):** So I don't think that step at least.

**Ehtisham Hussain (2):** It's not there for smith.ai.

**Ehtisham Hussain (2):** The other thing is internal linking didn't work very well even though it took me through the step and it produced an output and it allowed me to get from internal linking to the next step but internal linking in aerobs was actually placing some seriously good internal links throughout the article and in this version I didn't even see like one internal link that was then the workflow placed in there.

**Ehtisham Hussain (2):** I placed it later on.

**Ehtisham Hussain (2):** So, and the total word count because I was unable to go and edit the outline the total word count was still pretty much on the heavy side with Atlas as well.

**Ehtisham Hussain (2):** So, overall I think with aerobs I think because Elvis had gone in there and he had done some serious customization of his own results were a little bit better and in this case I think a couple of steps were missing a couple of steps.

**Ehtisham Hussain (2):** steps were not working.

**Ehtisham Hussain (2):** The final

**Ehtisham Hussain (2):** The output was very similar to what I got from Aerox, but it didn't have images, didn't have internal links, and yet to shorten it, I have to go out of the system and use Gemini.

**Ehtisham Hussain (2):** That could be a feature request too, I think.

**Ehtisham Hussain (2):** At the end, there was an editing step as well in Aerox, where you could go in and you could, with four forward-facing slashes, you could put in an incredible amount of editing instructions in there.

**Ehtisham Hussain (2):** I don't think that's there in Atlas 2.

**Ehtisham Hussain (2):** Oh, interesting.

**Ehtisham Hussain (2):** I think they said that they're working on it, and they will give us something like a feedback column.

**Ehtisham Hussain (2):** Yeah, there should be, at least before the final draft or even after the final draft, there should be a step where we can go in with custom editing instructions.

**Ehtisham Hussain (2):** Yeah, you're right, because I was assuming that that was included.
...
**Joe Sovar:** Yeah, in a meet with CMS and Panzer yesterday, he said that maybe a day or two and everybody will be cut off.

**Joe Sovar:** But for now, only like 20 people still have access to it.

**Joe Sovar:** Oh, well, I can find that article if you want to know which math it is.
...
**Ehtisham Hussain (2):** No, that one is specific.

**Ehtisham Hussain (2):** The image generation stuff is not universal.
...
**Ehtisham Hussain (2):** Because this is the last thing I'm doing for SMIT AI for now.

**Ehtisham Hussain (2):** Yeah.
...
**Joe Sovar:** Today I edited the conclusion on my end because mine was missing a conclusion.

**Joe Sovar:** I had frequently asked questions, nothing else.

**Joe Sovar:** So I added the conclusion, but I used GPT for it.

**Joe Sovar:** I think that's okay.

**Joe Sovar:** I gave my whole outline to chat GPT and told him to give me just the conclusion for that part.

**Joe Sovar:** So he gave me three bullet points to mention in the conclusion.
...
**Joe Sovar:** I think it's called integrity.
...
**Joe Sovar:** Can I just ask one question regarding Atlas?

**Joe Sovar:** Yeah.

**Joe Sovar:** So what's with the Airtable and Atlas?

**Joe Sovar:** I'm not sure is there any use for Airtable anymore?

**Joe Sovar:** Because for me personally, I had their article title and everything I needed.

**Joe Sovar:** In Atlas, it's kind of weird for me personally.

**Joe Sovar:** I don't know if all the articles that are listed there are there for the generating.

**Joe Sovar:** Because in Airtable, we always had this week, I, for example, have 10 articles to generate.

**Joe Sovar:** And I knew.

**Joe Sovar:** Which one articles I had to generate, but in Atlas, there are 50 articles there, so I don't know which one to focus on that week, if that makes sense.

**Joe Sovar:** Oh, yeah.

**Joe Sovar:** does.

**Joe Sovar:** Oh, go ahead, Carrie.
...
**Joe Sovar:** So we still use the information from Airtable, like keyword and the article title to generate our articles in Atlas.
...
**Joe Sovar:** Thank you, because it's much easier for me to know this week I had to do this, and I know what to do.

**Joe Sovar:** Yeah, for sure.
...
**Ehtisham Hussain (2):** Yeah, so I'm going to set up meetings with Saskia and Jessica, too, hopefully, like, I'm just going to get, like, completely organized about the two songs, Prophecy and Aftershooter Day, and then tomorrow we can have one-on-one, hopefully, and we can plan out for, we'll go forward.

**Ehtisham Hussain (2):** Yeah, I'm kind of, I'm kind of in the same boat.
...
**Joe Sovar:** What are my expectations for this week?

**Joe Sovar:** Do I need to generate any number of articles for Zoopla or for Yurko?

**Joe Sovar:** Let me look.
...
**Joe Sovar:** Yeah, I chatted with Zadira for a brief moment yesterday, and she told me that she can revise the first batch of articles for first week once I start, so that we know are we on the right path or not.

**Joe Sovar:** Right, yeah, and I've been reviewing some content for her all day, too, so I've got a pretty good handle on it.
