...
participants: Ben Church, Daniel Lopes
...
Onboard Ben Church to GrowthX.ai's engineering team and provide an overview of current projects and future goals.
...
**Ben Church**
- Talk to engineers + client-side people re: product understanding

- Chat w/ Jason Gong re: how Flow/Flow Studio used today

- Start editing in Flow/Flow Studio by EOD tomorrow

- Set up weekly meeting w/ Daniel for first month
...
**Daniel Lopes:** Like I think now we are at the point where it's like pretty much feature complete compared to what we needed from Aerobs.

**Daniel Lopes:** So I don't know how much you understand about how we were working already, but we have, we were using Aerobs quite a bit as a user interface and Aerobs would trigger the API calls to the, to the flow project that Clint is working on.
...
**Daniel Lopes:** So you have like one spectrum of this space is Aerobs, or Aerobs and N8N, and even like ZAC and IFT.
