...
participants: David Galic, Jakub Rudnik, Simran Sethi, Feyisayo Odedeyi, Matthew Panzarino
...
Discuss workflow insights and process improvements for Sunbit, Airbyte, and Hamlet clients.
...
**David Galic**
- Create new artifacts for Sunbit top-of-funnel content; name "Sunbit broad context" or "top of funnel company context", ensure matches original artifact name format

- Gen comprehensive Hamlet writing instructions via LLM; use before/after edits, client feedback, terminology prefs; input to custom workflow

- Discuss w/ Daryl re: Hamlet workflows/artifacts; understand existing custom work, avoid duplication


**Feyisayo Odedeyi**
- Proactively report any workflow issues/misalignments to David/Jacob/Matthew; focus on mechanical/tool/process problems
...
**David Galic:** I know Jacob's, like, on a train.
...
**Matthew Panzarino:** I can talk a

**Matthew Panzarino:** Catch up with David separately.
...
**David Galic:** So, like, I don't think, I don't think any of our, like, 50 articles were ever to flatten for anything, which is great.
...
**David Galic:** So the biggest thing here is that what Suddenbit does has nothing to do with what we're writing about mostly.
...
**David Galic:** I think he actually, for the first time, because now he's collaborating with his demand generation team, who are kind of leading this project.
...
**David Galic:** Can you guys hear me, Jake?

**David Galic:** Oh, hey, Jacob.
...
**Jakub Rudnik:** Well, yeah, we can talk to you about that, but I would just say with answer, that was good timing.

**Jakub Rudnik:** I put a note in here, but they were.

**Jakub Rudnik:** Legitimately, like, they want our recommendations, and David, this is a little bit of like, I'm glad you called that out, but call it out faster and more assertively in the future, because they, it was like what they just did before they started using us, and we just continued on, but we're fighting like a natural battle and not happy, and they, you know, are wondering why something takes longer, why we're giving them mixed results and things, and so, Mario's like, he's talked to me before about this, but say, he's just like, we want you guys to sell us those recommendations.

**Jakub Rudnik:** We want you to be our experts, like, Tammy is good, but he also hasn't done this before, so if it's, like, often, or much so, he's learning, still wants to learn from us, so don't, I mean, it needs to be collaborative, and they want to collaborate, but don't, like, lean on them to have the opinion, they want our opinion, they want us to tell, and so, yeah, I'll push you to do more of that, I think this is, like, a good start there, but think of it that way, and don't think of, like, them as having a rigid process, they're like, whatever gets us traffic, whatever gets us.

**Jakub Rudnik:** It's revenue.

**Jakub Rudnik:** That's all they care about.

**Jakub Rudnik:** And so if we're doing anything that slows that down or slows the production and we're not saying something, that actually is causing more of an issue than just going with what they were hoping, what they had aimed to us with three months ago.

**Jakub Rudnik:** So, again, this is like a good launching point for that and with all these new things.

**Jakub Rudnik:** But if you see that with them, and I think that goes for most of our clients, but especially everybody, it's like Mario's got to ping me and just like keeping me extra, us what to do if we're doing it wrong.
...
**Jakub Rudnik:** They oversimplify, and so they have these connector pages already, how to connect this to AirBite.
...
**Matthew Panzarino:** Cricklin has actually detailed it a couple of places.
...
**Matthew Panzarino:** Let's do this here.

**Matthew Panzarino:** Let's this.
...
**Matthew Panzarino:** So brief.

**Matthew Panzarino:** Okay, so we go to the brief.

**Matthew Panzarino:** This is Airby, obviously.
...
**David Galic:** Go ahead, I wanted to ask, like, if you have a longer list, like your things in the server, would it be better to, like, list them and separate them with commas or do, like, a bullet list?

**David Galic:** I don't know.

**Matthew Panzarino:** Yeah.

**Matthew Panzarino:** To honest, I don't know.
...
**Matthew Panzarino:** Were these ported over from Aerofs, or were you manually creating these?
...
**Matthew Panzarino:** But it is a stress test for the system to help figure out, okay, what sources of truth can

**Matthew Panzarino:** The limit here, you know, what can we build that can get us a lot closer to our ICP?
...
**David Galic:** So right now I gave them like two about secrets management and they still had comments, but it seems like it was a lot quicker to edit.

**Matthew Panzarino:** And they were pretty happy with it.

**David Galic:** Okay.

**David Galic:** Whereas the other stuff, the stuff that's directly related to them, everything goes like three or four rounds of edits.

**David Galic:** Because it's just the terminology.

**David Galic:** I'm not never getting it right in either of the AI.
...
**David Galic:** Do we just like run a fake workflow and just add the final thing at the end?

**David Galic:** And then that final output will, like, be there as, like, something that the workflow will look at later?
...
**Matthew Panzarino:** Yeah, I would say you can feed those dips to an LLM and ask it, hey, I have done it.
...
**Matthew Panzarino:** Or are using a chat window to edit these specifically?
...
**David Galic:** And then I'll do like a whole thing of the work.

**David Galic:** then the LLM will take a look at it and give you that.
...
**Matthew Panzarino:** Ask me for each one.

**Matthew Panzarino:** Don't just dump stuff into here.

**Matthew Panzarino:** hates that.

**Matthew Panzarino:** Or it will just get confused.

**Matthew Panzarino:** Ask me for each one of these as soon as we're done talking here.
...
**Matthew Panzarino:** Given the conversations we've had about.
...
**Matthew Panzarino:** Yeah, I would do, I would try to do a comprehensive one that is, you know, concentrate on it and give it.

**Matthew Panzarino:** Some context too.
...
**Matthew Panzarino:** And the output that I would like from this is no more than, or you don't even specify length.

**Matthew Panzarino:** The output I would like from this is a document that I can use to give someone else instructions on how to write for this in incredibly specific detail.
