...
participants: Daniel Lopes, Yousef Hamade, Alice, Jason Gong, Felipe Lima, Sucheta, Andi Bailey, David, Jessalynn, Georgemaine Lourens, Bridget McGillivray, Matthew Panzarino, Marcel Santilli, Cristina Caceres, Megan Dickey, Clint Shryock, Marcus Derencius, Jessica Nicole Manificiar Gayo, Darrell Etherington, Stéfano Zanata, Renato, Kyle Gaudreau, Brad Herman, Kirkland Gee, Usman Ghani, Sydney Go, Jo Kaminska, Delivery, Bianca, Ehtisham Hussain, Mariana Montezzana, Carrie Chowske, Jess Scott
...
Train team on new Atlas platform replacing AirOps for content generation workflows
...
**Daniel Lopes**
- Setup Adventurous Group account in Atlas w/ 5 projects; add real grids/stats for Adventurous Group & Zuplo

- Fix Crappy fact checker for relevant client; adjust dual tone & XML steps for Rapid; implement data grid post to Webflow; add title/metadata fields to All Workflows final output; setup Zoopo programmatic APIs grid

- Add URL generator/slug workflow to relevant client pipelines

- Send follow-up msg w/ Atlas usage guides, testing instructions, practice tasks
...
**Daniel Lopes:** And once you have the values imported, same idea as aeroops, you can select.

**Daniel Lopes:** track I themutions I'll,alkalki So

**Daniel Lopes:** As many things as you want, and you can run then, so, and you run then with this run button.
...
**Daniel Lopes:** In this case because I have a board load of things added here and we still have to tweak the pagination it got pushed to the top so you can see here.

**Daniel Lopes:** And let me...

**Daniel Lopes:** me...

**Daniel Lopes:** me...

**Daniel Lopes:** Let this run, so like you can either run from the grid, like same way you had with drops, you can run these things from here, so if you hover over the play button, can see run this step.
...
**Daniel Lopes:** So, like this pipeline was built to take in this search of inputs.

**Daniel Lopes:** really this.

**Daniel Lopes:** Thank

**Daniel Lopes:** With those form fields, and then we run whatever kind of steps we want, and at the end, we run whatever kind of outputs we want.
...
**Daniel Lopes:** If you want the JSON-LD.

**Daniel Lopes:** a we the can can you.

**Daniel Lopes:** If you want markdowns and things like that.
...
**Daniel Lopes:** We have this like little hidden placeholders.

**Daniel Lopes:** is for future features.

**Daniel Lopes:** I'm going to remove that just so the interface is cleaner.
...
**Daniel Lopes:** So like all those things are set up as different pipelines.

**Daniel Lopes:** So we can build whatever type of

**Daniel Lopes:** So in this case, it's just one call, it's like a step with like one call, and we'll generate everything at the end.
...
**Daniel Lopes:** So in air ops, you would have like these super long grids of stuff that you already finished.

**Daniel Lopes:** future.

**Daniel Lopes:** this image of to So

**Daniel Lopes:** So one thing that I ask you to do now is like every time you finish something end-to-end and you put in their table or you published, just archive that.
...
**Daniel Lopes:** And all that should be fixed pretty easily.

**Daniel Lopes:** then we have, like in this case, for example, let's say I'm done with this, or let's say I don't want to work with this.

**Daniel Lopes:** We have two options.

**Daniel Lopes:** have archiving and we have deleting.

**Daniel Lopes:** So if don't want to work on these three rows there, I could just delete them.
