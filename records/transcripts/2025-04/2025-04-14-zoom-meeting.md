...
Discuss and resolve discrepancies in 2024 tax calculations for Marcel's LLC, focusing on revenue recognition, expense categorization, and potential tax liability.
...
**Ericksson Abad**
- Add back home office expenses to tax calculations. Research/apply appropriate limitations.
- Adjust revenue in tax calculations from 1.4M to 1.141M (cash basis). Communicate change to Anderson Tax.
- Include Section 179 accelerated depreciation for vehicle purchase (~$110k) in tax calculations.
- Compare Airtable model entries w/ QuickBooks. Adjust QuickBooks as needed for accuracy.
- Review/adjust QuickBooks categorizations, focus on gas expenses. Compare w/ Chase 5042 credit card statement.
...
**Marcel Santilli:** Fun Monday morning stuff, you know?

**Ericksson Abad:** I'm trying to imagine how you feel.

**Ericksson Abad:** I just want you to know I'm really trying to get it down for you, too.

**Marcel Santilli:** No, I know.

**Marcel Santilli:** It's not your fault or anything.

**Marcel Santilli:** It's just like, I hate tactics.
