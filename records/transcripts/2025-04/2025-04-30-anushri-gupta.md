...
participants: Anushri Gupta, Vic Plummer, Jason Gong
...
Discuss Webflow's developer documentation strategy and explore opportunities for improvement and expansion.
...
**Jason Gong:** Yeah, where are you located?
...
**Jason Gong:** Yeah, it's not like, it doesn't get hot here.

**Jason Gong:** At least I've only been here like six months so far.

**Jason Gong:** Oh, really?

**Vic Plummer:** Where were you before?

**Vic Plummer:** But it's sunny.

**Jason Gong:** I've been in California for the last eight years, so we were in Mountain View before that.

**Jason Gong:** We were in L.A.

**Jason Gong:** before that.

**Vic Plummer:** Yeah, but the temperatures are so different in the Bay, depending on where you are, for sure.

**Vic Plummer:** Super different, yeah.

**Jason Gong:** Whereabouts are you?

**Jason Gong:** I'm in New York, but I'm in Jersey today.
...
**Jason Gong:** Are you late?

**Anushri Gupta:** No problem.

**Jason Gong:** Cool.

**Jason Gong:** So I guess I scheduled this.

**Jason Gong:** Oh, and then maybe just for context, for who I am and what I'm doing.

**Jason Gong:** Basically, we're GrowthX.

**Jason Gong:** We're kind of like a growth agency that, you know, uses AI and people to deliver some outcome within growth right now.

**Jason Gong:** We're working with Anushri, Karat, and Rachel on kind of developer awareness, which looks like a bunch of content of various forms.

**Jason Gong:** And one of the ideas that was initially thrown was like something for the doc site.

**Jason Gong:** It wasn't like super defined, but it seems like you guys have a lot of like snippets that give a peek into how developers, I guess, use Webflow.

**Jason Gong:** And there's an idea of maybe surfacing that on the doc site.

**Jason Gong:** There's also a bunch of other ideas around the doc site.

**Jason Gong:** So I scheduled this call just to kind of hear from you guys if there's kind of a vision for the doc site.

**Jason Gong:** What do you think makes the most sense as far as like the structure for it?

**Jason Gong:** Yeah, and then just to start there and then see if we can get somewhere with like where to add new content.
...
**Jason Gong:** I got to like switch that for all my calls.

**Jason Gong:** I don't Somewhere there's a default.

**Jason Gong:** Can I just be lazy to switch it off?

**Jason Gong:** I don't think you can, actually.

**Vic Plummer:** think Google is doing it.

**Vic Plummer:** Okay, can you see my screen now?

**Jason Gong:** Yes.

**Jason Gong:** Perfect.

**Vic Plummer:** I can't see my screen because there's a huge tab.

**Vic Plummer:** There we go.

**Vic Plummer:** Okay.

**Vic Plummer:** So this is our developer doc site.

**Vic Plummer:** Actually, this is kind of like an older version.

**Vic Plummer:** We are trying to ship a newer version that shows our different APIs, and I can find it.

**Vic Plummer:** I think it would be a better version to show you.

**Vic Plummer:** Please.

**Vic Plummer:** It's okay.

**Vic Plummer:** Anyway.

**Vic Plummer:** We're looking at your Slack.
...
**Anushri Gupta:** Somebody has mentioned in the comment, they didn't reply within 48 hours, trigger another message, and so on.
...
**Vic Plummer:** Although, with, like, your technology, it sounds like...

**Vic Plummer:** ...

**Vic Plummer:** ...

**Vic Plummer:** You know, you would be able to do that across all.
...
**Jason Gong:** Yeah, something I would have to send to you.

**Jason Gong:** out later, but I can't do that.

**Jason Gong:** Yeah, and then, are you good?

**Jason Gong:** Sorry, Jason.
...
**Anushri Gupta:** So it will be really good to see.

**Anushri Gupta:** Oh, wow.

**Anushri Gupta:** Yeah, there we go.
...
**Jason Gong:** have guide, you have the reference, and then you have the log.
...
**Vic Plummer:** And I like GSAP stocks as well.
...
**Jason Gong:** I'm trying to think of like what the beginning and end of that.

**Jason Gong:** Like just the snippet itself is like, you you kind of have to like take it and build with it.

**Jason Gong:** But like how much of the front end can you show?

**Jason Gong:** Yeah.

**Jason Gong:** Depending on the example.

**Jason Gong:** Yeah.

**Vic Plummer:** I would say obviously Wix.dev is all right.

**Vic Plummer:** But like, so I think instead of a showcase of user-generated content, we would just have code snippets that we did ourselves.

**Vic Plummer:** These are actually, okay.

**Jason Gong:** These are actually all really, really good.

**Jason Gong:** Okay.

**Jason Gong:** So I guess just finishing a thought here.

**Jason Gong:** think as a next step, if you send that wishlist, what I would try to get to you both is, I guess, just like a map of like what it is today.
...
**Jason Gong:** Like, when I land on glossary, when I land on blog, when I land on university, it's like, crystal clear to me, this is written for the people that are using, like, the visual builder, right?

**Jason Gong:** Like, non- people.

**Jason Gong:** And I think even Stripe has this problem, which is interesting, because I would just assume their content is for developers.

**Jason Gong:** don't don't

**Jason Gong:** But like even for them, like they need a place where if I'm a developer, I land on it and I trust it immediately and I understand it's for me.
...
**Jason Gong:** And with Karat, I think, like, however we're thinking about this is, like, a lot of the stuff we're doing is, like, more about, like, enablement.

**Jason Gong:** So, like, the integrations, it's, like, I'm already a Webflow user.

**Vic Plummer:** Absolutely.

**Vic Plummer:** Same with the docs.

**Jason Gong:** But then we want to make it that in, like, organic.
...
**Jason Gong:** So it sounds like for anything doc-related, that'll be you, Vic.
...
**Jason Gong:** So expect that in the next two weeks, I guess.

**Jason Gong:** Awesome.

**Jason Gong:** I will send you wishlist stuff.
...
**Jason Gong:** Well, have a good rest of your Wednesday.

**Jason Gong:** Thank

**Jason Gong:** And I will see you all soon.
