...
participants: Kirkland Gee, Mark Boyes-Smith, Bailey Seybolt, Franki Chaffin-Edwards, Erik O'Brien
...
Align on the Framer publishing workflow and AI image generation strategy.
...
**Erik O'Brien:** This have conclusion.

**Erik O'Brien:** get well, I'll.ilen...

**Erik O'Brien:** Lamb...

**Erik O'Brien:** mean...

**Erik O'Brien:** You But they're
...
**Erik O'Brien:** So I know, I don't know as much as Kirkland does on the framer and MCP setup, but I don't know, Mark, if there's anywhere you kind of wanted to start, or if there's anything else that you've learned from the framer side of kind of any requirements that they've passed along to you.

**Mark Boyes-Smith:** Not from my side.

**Mark Boyes-Smith:** Is it worth me starting with just a bit of context?

**Mark Boyes-Smith:** I'm coming in totally fresh to this conversation, so I can maybe go from the beginning with what I know, and then we can join the dots.

**Mark Boyes-Smith:** That sounds great.

**Mark Boyes-Smith:** Okay, cool.

**Mark Boyes-Smith:** So I oversee design at HX on the product side, but then also on the brand side as well.

**Mark Boyes-Smith:** And we've been obviously thinking about how to elevate our brand experience.

**Mark Boyes-Smith:** We're launching a new brand over the next.

**Mark Boyes-Smith:** Thanks.

**Mark Boyes-Smith:** right back.

**Mark Boyes-Smith:** A month or so.

**Mark Boyes-Smith:** And as part of that, we're rethinking about the website.
...
**Erik O'Brien:** So we are working with David, kind of, as the AI pipelines that are generating content.

**Erik O'Brien:** So he's guiding Bailey and team, kind of, very closely on, kind of, what type of content we want to go for.

**Erik O'Brien:** And and and You You You You You You

**Erik O'Brien:** How do we get that to go from zero to one?
...
**Mark Boyes-Smith:** So the, when we started to produce this website, I immediately went down the route of the API plugin as well, the API as well, and then realized that they've decommissioned it and it's all MCP now.

**Mark Boyes-Smith:** So a lot of the work that I've been doing is figuring out, we have a product engine internally built with cloud code and we kind of insert things that.

**Mark Boyes-Smith:** product You

**Mark Boyes-Smith:** I had mixed success with it, if I'm honest.
...
**Kirkland Gee:** No, same thing.

**Kirkland Gee:** mean, especially, like, placements sometimes.

**Mark Boyes-Smith:** I think
...
**Mark Boyes-Smith:** And then exactly as TR.Kirkland, we came into the CMS, we built out a very, very simple metadata schema for this.
...
**Mark Boyes-Smith:** The other thing as well, mean, David's been looking at bringing in, like, a standard FAQ block for the bottom of key pages.
...
**Kirkland Gee:** It's going be, like, a little bit fiddly, but I don't think it's anything too complicated.

**Mark Boyes-Smith:** Just tedious.

**Mark Boyes-Smith:** Yeah.

**Mark Boyes-Smith:** I wonder if they've, I wonder if they've got anything.

**Mark Boyes-Smith:** wonder if they're to

**Mark Boyes-Smith:** Roadmap about just having a permanent MCP.

**Kirkland Gee:** There's something weird about that.

**Kirkland Gee:** didn't know if it was like a third-party plugin for a while.
...
**Erik O'Brien:** Yeah, we can take that back.

**Erik O'Brien:** back.

**Erik O'Brien:** Yeah, take

**Erik O'Brien:** We are transitioning from pod zero to another pod, and I know those emails are also changing.
...
**Kirkland Gee:** She can give you all the access.

**Kirkland Gee:** has everything in it that you need.
...
**Mark Boyes-Smith:** I don't have one to hand, but again, that feels like, I feel like if we kind of turn up the level of complexity, it's going to require a

**Mark Boyes-Smith:** A bit more refinement and review from us.
...
**Mark Boyes-Smith:** Like, what would we consider, like, a good bar to hit?

**Mark Boyes-Smith:** I don't know, that's a really big, tough question.

**Kirkland Gee:** I actually, maybe, just.

**Kirkland Gee:** To give some perspective, some different things we've done on this.
...
**Kirkland Gee:** Or we've done things where maybe we design a...

**Kirkland Gee:** Set of four or five different backgrounds that are in our brand color.
...
**Kirkland Gee:** And then sort of piecing in some little things here and there.

**Kirkland Gee:** That's helped get around.

**Kirkland Gee:** It makes it a little less variable, right?
...
**Mark Boyes-Smith:** What we can do is I can regroup with my brand designer, pull together a couple of examples of things that we really love, and just see if we can send something our way and put that to the test.

**Mark Boyes-Smith:** That would be great.
...
**Erik O'Brien:** Bailey, to give your designer some better feedback.
