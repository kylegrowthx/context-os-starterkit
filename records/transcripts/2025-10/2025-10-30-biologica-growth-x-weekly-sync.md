...
participants: Brian Magida, Matthew Panzarino, Elizabeth Zwillinger, Team GrowthX
...
Sync on content quality and refine the medical review process.
...
**Brian Magida:** Will you then be able to like, will you run every article like through that?
...
**Brian Magida:** We don't have any that like maybe slipped through the cracks or what is that?
...
**Brian Magida:** It's, like, more medical review side.

**Brian Magida:** So, if we can.

**Brian Magida:** can.

**Brian Magida:** Make some of these tweaks, I think it'll just make, it'll put everything in a really good, good spot.
...
**Matthew Panzarino:** Those two things should be in effect for your next.
...
**Elizabeth Zwillinger:** I guess, man, I don't want to interfere with your process.
...
**Brian Magida:** You'd have to stage it.

**Brian Magida:** then...

**Brian Magida:** Yeah, I

**Brian Magida:** I think for this, when you deliver the Google Doc, if you could just have like a hyperlink to the image in Airtable, if that's like possible, or just like a hyperlink to just the image stored on Google Drive, like I think that would be sufficient.
...
**Matthew Panzarino:** I personally do not want us to place the images in the articles.

**Matthew Panzarino:** I think you should decide where you want it and put it in there.

**Matthew Panzarino:** And then that way it appears at the same place in every article.

**Matthew Panzarino:** You know, I don't think it's why.

**Matthew Panzarino:** think it's

**Matthew Panzarino:** I used for us to just start suddenly throw them in, just from a formatting perspective, because they could flow differently on your site.
...
**Matthew Panzarino:** If there is one that It's not critical, but I'm just curious.
...
**Matthew Panzarino:** And you're already serving some of those needs, but I'm close.

**Matthew Panzarino:** I'm close.

**Matthew Panzarino:** Let me get.

**Matthew Panzarino:** I'm you something probably tomorrow.

**Matthew Panzarino:** Rather than like going to down the rabbit hole, let me provide you with a few options and you can give me some just succinct brief input of like, yeah, further down this path or not that path.
...
**Matthew Panzarino:** Again, if we want to generate new images for those to, like, make them all adherent or get the interstitial images for the previous ones, we'll just go through and do a batch of those, and then the publisher will just go do them all in one batch probably next week.
...
**Brian Magida:** Mm-hmm.-hmm.

**Brian Magida:** We should just talk about, and we can just do this over Slack, but how do we sort of migrate the topic cluster convention that you have within Airtable to a consumer-facing tag?
