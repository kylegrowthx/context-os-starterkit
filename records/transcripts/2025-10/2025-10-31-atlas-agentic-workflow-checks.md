...
participants: Marcel Santilli, Bisera Stankovska, Nika Narimanidze, Vivek Shankar, Marcus Derencius, Ismail Ajagbe, Rachel, Jakub Rudnik, Aida Knezevic, Mara Leighton, Sydney Go, Kyle Gaudreau, Mariana, Matthew Panzarino, Jason Gong, Oluwatimilehin Ademosu, Kirkland Gee, Martha Martins, Usman Ghani, Matthew Alves-Hill, Carrie Chowske, Sucheta, Usman Adepoju, Tiandra Burns, Marisol Smith, Jenny Macrohon Dabon, Mariana Marins, Darrell Etherington, Megan Dickey, Andi Bailey, Ademilade Shodipe-Dosunmu, Feyisayo, Jessalynn, Josip Sovar, Moses, Saskia Wartnaby, Ehtisham Hussain, Jo Kaminska, Nicolas Castellanos, Stevie Kim, Iana, Kavishka Kanayake, Nathalie Schrans, Ifeoluwa Adekoya, Tamara, Bailey Seybolt, Katya Luscomb, Patricia, Hassan, Will, Kelvin_Njiru, Felix Morgan, Lawrence Neves, Nathan Navidzadeh, Najam, Jenn Peters, Andrea’s iPhone
...
Reviewing and troubleshooting Atlas Agentic workflows.
...
**Marcel Santilli:** And so, like, this should give us, like, a lot of the, I mean, this is insanely powerful, right?

**Marcel Santilli:** It's just, we're overwhelming this thing by saying, hey, you're going to do a hundred things, and let me give you a thousand rules to think about.

**Marcel Santilli:** And it's like, ah, , like, I don't know what to do.

**Marcel Santilli:** You know, we wouldn't be able to do it either, you know?
...
**Marcel Santilli:** So I don't know if anyone can share their screen, because I'm logged out of Notion.
...
**Andrea’s iPhone:** I have one, and I'm sorry that my camera's not on, and I'm not wearing a costume, but I wanted to ask if Kirkland or Marcus could, I know there are a couple of pipelines that are in the interview, Lanier, I was wondering if you guys could give us an outline or steps that you'd like, ideally, for everybody to be taking, when they're reviewing a pipeline, like, best practices for reviewing pipelines, because I think a couple we've been waiting to get, like, in review, and I'm not sure everybody knows, like.
...
**Andrea’s iPhone:** Okay.

**Andrea’s iPhone:** So, when it's in review, everyone, I think that's the time to optimize.

**Andrea’s iPhone:** And that's when you have, like, kind of client ops is dedicated time to your pipeline.

**Andrea’s iPhone:** So, try and get those reviewed as quickly as possible.

**Andrea’s iPhone:** And that's when you'll get, I think, the most help and collaboration.

**Andrea’s iPhone:** Just because the ticket's being worked on right then.

**Marcel Santilli:** So, that's that's try three different of things

**Marcel Santilli:** All right, let's wrap up, and then we'll do what we did last time, but don't hit enter yet.

**Marcel Santilli:** So we're going to do two scores.

**Marcel Santilli:** The first score is how much fun did you have in the session, one to five.

**Marcel Santilli:** One is I was, you know, half asleep.

**Marcel Santilli:** And the second score is how useful this was, one, waste of time, five, extremely useful.

**Marcel Santilli:** So put the scores and then in the chat, and then on the count on three, we can all hit enter at the same time.

**Marcel Santilli:** Okay, or not.

**Marcel Santilli:** I hit enter.

**Marcel Santilli:** All right, cool.

**Marcel Santilli:** Hey, we did okay on having fun.

**Marcel Santilli:** All right, so maybe we'll start a new tradition where it would be avatar classroom only, but the stuff, you know, this is actually kind of fun.
