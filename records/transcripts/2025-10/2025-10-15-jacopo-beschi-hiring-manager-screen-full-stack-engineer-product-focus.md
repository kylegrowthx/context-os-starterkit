...
participants: Daniel Lopes, jbeschi
...
Discuss potential full stack engineering role at growthx.ai with Jacopo Beschi
...
**jbeschi:** I don't know if you've been here before.

**jbeschi:** Never been to the West Coast ever.

**jbeschi:** Only to the East.

**jbeschi:** I've been to the East Coast and then to Miami and New Orleans.

**jbeschi:** I think that was it.

**jbeschi:** Yeah, for you, for the United States.
...
**jbeschi:** Sorry, just to understand the context a little bit more.

**jbeschi:** So basically, you have two apps that interact via API to basically, I'm not sure, but kind of a temporal API, is it?

**jbeschi:** Yeah, it's a...

**jbeschi:** run a workflow, and then the workflow will just connect with the AI provider, like ChatGPT or other provider, and then response back via webbook.

**jbeschi:** We

**jbeschi:** Information with the result, basically, is something like that, because I'm not totally fine with it properly, so just on a live level.
...
**jbeschi:** And converts to Markdown.

**jbeschi:** Yeah, converts to Markdown, yeah.
...
**jbeschi:** The timeline was too small, think, like, less than five seconds, I didn't think it was something else.
...
**jbeschi:** Okay, now our hours work as well.

**jbeschi:** So I think ours is longer, so that's why I was saying that.
...
**jbeschi:** The activities are implementation, then.
...
**jbeschi:** How does it handle error, like automatically, without knowing what to do with depending on the error?
...
**jbeschi:** So you can use exponential retries, or you can use also linear if you prefer.

**jbeschi:** Yeah, like, you know, it depends.
...
**jbeschi:** Sorry, have a question, if you don't mind.

**jbeschi:** How does the framework, I mean, maybe it's not the framework, maybe it's just AI that decides it, but anyways, how does it decide whether to use AI to do something or just implement it straight away?

**jbeschi:** Like if it's something that you don't need AI to do it, like how does it decide that?

**jbeschi:** Because if you need to start something, you don't need to do it via AI, right?
...
**jbeschi:** Maybe some security filter on Cloudflare.

**jbeschi:** It's really annoying.

**jbeschi:** Like I remember having a lot of fish with that in base camp, like people posting code.

**jbeschi:** InBaseCamp document, and then weren't able to upload that because Cloudflash sees the code and is like, no, no, no, don't do that.
...
**jbeschi:** So it's like looking at the...

**Daniel Lopes:** This is very powerful.

**jbeschi:** Yeah.

**jbeschi:** I mean, you just say, okay, it is not working, fix that.
...
**jbeschi:** So the system also control, like, excessive use of token or issues like that?

**jbeschi:** Because maybe you trigger something that by mistake and it's going to use too many tokens and it's going to be too expensive.
...
**jbeschi:** And these are stored in the Rails app now.
...
**jbeschi:** But does Flow S, does Temporal always reply?

**jbeschi:** I mean, if you have a webhook implementation.

**jbeschi:** Can you ensure that temporal rules reply with the web code is like?
...
**jbeschi:** It's like Stripe, you know, if you have a very integrated with Stripe, you have the web, and then you can also, like, ask proactively.

**jbeschi:** So you could end-end for, like, a developer dashboard and error listing for, like, webhooks error so you can monitor because it's going to happen that you're not going to receive the webhook for multiple reasons.

**Daniel Lopes:** can even be just a network issue.

**jbeschi:** Yeah.

**jbeschi:** But maybe it's just on temporal also.

**jbeschi:** So, yeah.

**jbeschi:** I was wondering about implementation, like, if you maybe should use an hybrid approach or something else just to make sure that you aren't stuck.
...
**jbeschi:** Does that make sense?

**jbeschi:** Does that work?
...
**jbeschi:** So I have this zipped here.
...
**jbeschi:** Yeah, I'm okay.

**jbeschi:** I can see that.

**jbeschi:** Yes, I downloaded it and opened it.
...
**jbeschi:** I'm gonna add a timer.

**jbeschi:** Okay.

**jbeschi:** Thanks.

**jbeschi:** Thanks, The end.
...
**jbeschi:** Okay, maybe I can share my screen and we go together through the two implementation first, because I'm not sure I understood everything.
...
**jbeschi:** Okay, let me see.

**jbeschi:** I'll share the screen, because I totally forgot.

**jbeschi:** Then I get there.

**jbeschi:** Share.

**jbeschi:** Okay, I'm just going to share everything.

**jbeschi:** Okay, should be able to.

**Daniel Lopes:** Can you see it now?

**jbeschi:** Yeah.

**jbeschi:** Okay, so starting from Jose implementation, which looks familiar to me.

**jbeschi:** So what I understand now, so far, is that basically, you have this class.

**jbeschi:** client, right, which two method, I noticed.

**jbeschi:** And basically what they do is call execute workflow, which is going to call the API, which I suppose is our internal service API.

**jbeschi:** Right.

**jbeschi:** It's correct.

**jbeschi:** And so, and then basically it's going to handle the response, like if there is an error, it's going to basically build an error response and return an execute workflow.

**jbeschi:** Sorry.

**jbeschi:** Yeah.

**jbeschi:** It's execute workflow response with success false and basically the error, the global ID.

**Daniel Lopes:** I'm not sure how it's built, but it's a detail.

**jbeschi:** Anyways, and then we have a lot of, we have a bunch of like web books.

**jbeschi:** So I'm not sure.

**jbeschi:** I mean, I've seen the web book controller, so, but what I see here is that it's just logic to,

**jbeschi:** So I'm going be a route that gets cold from the TypeScript code because I can see them, but I suppose there is an end point that receives the web book.
...
**jbeschi:** And this is going to create a web book, which is basically this class, and what it does is basically initialize a processor, which is one of these.

**jbeschi:** So depending on the source, so I think it's a parameter for sure, somewhere like...

**jbeschi:** Yeah.

**jbeschi:** Yeah, it should be somewhere like...

**jbeschi:** So that's the last parameter.

**jbeschi:** Okay.

**jbeschi:** They're not permit.

**jbeschi:** Okay, it's not the explicit.

**jbeschi:** This is a parameter, and so the webbook will basically call the right processor, right?

**jbeschi:** And depending on what you, which kind of processing you need to do, it calls a different class, basically, from my understanding, right?

**jbeschi:** Because you have the controller, it will create, and then the webbook will just, after create commit, will run a job, basically, to process.

**jbeschi:** And the job will just call the processor processor, which is basically going to figure out the class, based on the action, okay?

**jbeschi:** So you can use, you can run, no, sorry, wait, hold on, double check.

**jbeschi:** Yeah, search classifier processor, okay?

**jbeschi:** And so it can be, like, either, like, I suppose, basic research or flow or anything.
...
**jbeschi:** But then those workflows, I mean, what, I'm not totally sure, like, just give me a sec, maybe.

**jbeschi:** Let me see where we use the flow client.

**jbeschi:** Probe, onboarding, okay.

**jbeschi:** Okay.

**jbeschi:** Okay.

**jbeschi:** So the flow client is called from the probe or from the onboarding?

**jbeschi:** Yeah.

**jbeschi:** Okay.

**jbeschi:** So when you create an onboarding, for example, you're going to do the basic research.
...
**jbeschi:** Do the basic research.

**jbeschi:** And then the flow client, we call basically this and basically search workflow.

**jbeschi:** It's going to execute the workflow, but I don't, I don't understand how this works, to be honest, because you have the webhook controller that creates a webhook, right?

**jbeschi:** But then, but then the part that calls the API is not this, but it's basically either like, you know, the probe or the onboarding, right?
...
**jbeschi:** So then, then we create this.
...
**jbeschi:** Yeah, I see, because you have two type of source, and so, okay, so, for example, the flow processor, we call the processor class, and then process, so, okay,

**jbeschi:** For example, if you do a probe, you know, probe, yeah, for example, yeah, you just do a bunch of logic, like, you receive the payload somewhere, like, probably, payload is here, so, yeah, here, so, the payload is from the web book, and the web book is created here with the payload, okay, so yes, the payload, okay, I see, okay, now I see, okay, And then this one, instead, I haven't took it deeply, I haven't taken a look deeper at this one, but, I've seen that, we basically, this is the one you created.
...
**jbeschi:** Yeah, I mean, this is something we, this is the implementation data that we can decide.

**jbeschi:** From my understanding is, I mean, if we need to do a lot of parallel HTTP requests, maybe HTTPX might be a little bit better.

**jbeschi:** I've used HTTPX in the Action Push Native Jam, actually, because it supports a lot of stuff, such as HTTP2, persistent connection, and so on.

**jbeschi:** But I don't think we need any of them, right?

**jbeschi:** We're just doing HTTP calls, and, I mean, slow HTTP calls, basically, right?

**jbeschi:** Yeah.

**jbeschi:** So we don't have, the performance is not an issue in this case, I suppose.
...
**jbeschi:** But it's not here.

**jbeschi:** We had a list.

**jbeschi:** It's not here, yeah.
...
**jbeschi:** That's in this code base.

**jbeschi:** There is no web hook.

**jbeschi:** Yeah, yeah, I see.

**jbeschi:** I see, I see, see there is a, um,

**jbeschi:** Methods to look for status, which I suppose, this is the logic for the polling on the status.

**jbeschi:** And there are similar parameters, of course, I suppose, because it's the same API.

**jbeschi:** Yeah.

**jbeschi:** Like I noticed that in the client, you have, sorry, we have a, where it was.

**jbeschi:** Sorry, I'm going a little bit quick, because there is a lot of context to learn.

**jbeschi:** yeah, yeah.

**jbeschi:** have to do it as quickly as possible, but I might lose some bits for sure.

**jbeschi:** No problem.

**jbeschi:** Okay, call it, oh, no, no, never mind.

**jbeschi:** No, I said something, I'm not sure about that, but the response, no, never mind.

**jbeschi:** Let me go back here.

**jbeschi:** Okay.

**jbeschi:** The entry point, I'm not sure, do you know what is the entry point here?
...
**jbeschi:** Okay, it's on the job here.
...
**jbeschi:** Prepare Prepare workflow params.

**jbeschi:** Prepare Prepare Prepare You

**jbeschi:** Based on the input, like if you do a company research or a content suite, you just buy a different, okay, and then, okay, and then you call the, okay, then you call the, think, okay, I see.

**Daniel Lopes:** Yeah, so that's where the client is getting, getting triggered.

**jbeschi:** Okay, and then you just, okay, then it's the job to pull, basically, this one.
...
**jbeschi:** Okay, and then it's just gonna, okay, check status, right, if it's done, basically, so this should be if it's completed, okay, if it's done or failed, and then use the client here to pull, okay, I see.

**jbeschi:** Okay, okay.

**jbeschi:** I'm trying to understand, okay, I understand it more now.

**jbeschi:** Okay, and then here you have your logic based on the status, basic status name.

**jbeschi:** Yeah.

**jbeschi:** Completion and failure.
...
**jbeschi:** So I think we...

**Daniel Lopes:** If you had a gen, you would probably have to support.

**jbeschi:** Yeah, but I'm wondering, like, I mean, the webbook is called when all the processing is done.

**jbeschi:** Yeah.

**Daniel Lopes:** Or, okay.

**jbeschi:** When the workflow is So if you have, when all the workflow is done.

**jbeschi:** But the workflow is made of multiple steps, right?
...
**jbeschi:** I'm not sure.

**jbeschi:** Without the data, it's difficult to say, like, how problematic it will be.

**jbeschi:** But, no, because I'm wondering, like, if you can do, like, status updates more frequent via Webhook or something like that.

**jbeschi:** I mean, the polling is not bad, per se.

**Daniel Lopes:** Yeah.

**jbeschi:** But you're going to have a lot of jobs running.

**jbeschi:** Yeah.

**jbeschi:** And maybe doing nothing, a lot of time, I suppose.

**jbeschi:** So it's a little bit of a waste.

**jbeschi:** But the webbook you said, I'm not following the part where you said that the webbook will just do us.

**jbeschi:** I mean, you can rate limit, do a bunch of work around for that, but I don't understand the fact that you said that we would do us the race up if it's called only at the end.
...
**jbeschi:** I'm not completely following everything.

**jbeschi:** Sorry.

**jbeschi:** So I'm just doing some stuff.
...
**jbeschi:** So I think that's why he did Atomic.

**jbeschi:** But let me see one thing, but the, sorry, the page scanning is the big one, right?

**jbeschi:** And check workflow start to job, I suppose it's what is on hold of taking a look at, I mean, just taking a look at the status, right?

**jbeschi:** And you said you have a lot of workflows, but how does it take sort of time?

**jbeschi:** Yeah, I'm just trying to understand, if it's just one job for each, so for thousands of pages, or it's just one job that takes multiple pages, I suppose it's thousands of jobs.

**Daniel Lopes:** No, batch size, okay.

**jbeschi:** So as you mentioned, so do you have one job for batching through the multiple workflows?

**jbeschi:** Okay.

**jbeschi:** Now I see what you mean.
...
**jbeschi:** And this is going to do that.

**Daniel Lopes:** Ah, okay.

**Daniel Lopes:** It's totally ready.

**jbeschi:** the idea, I suppose.

**jbeschi:** Something probably that is.
...
**jbeschi:** So you go to the idea, you extract the data from a JSON, retry count.
...
**jbeschi:** at some point, okay.

**jbeschi:** have max retries of five.
...
**jbeschi:** Now I understand more.

**jbeschi:** Okay.

**jbeschi:** So to recap, the workflow, sorry, the webbooks approach can be problematic if you have a lot of workflows, because you have a lot of, I mean, honestly, it's going to be a problem.

**jbeschi:** I need to figure it out because, because it's like, what it's going to be like.

**jbeschi:** Basically, in this implementation, it's going to be like, each workflow completion is a code on this method.

**jbeschi:** And, I mean, they can complete at a different time.

**jbeschi:** Yeah, it's more expensive.
...
**jbeschi:** But this process in the background, the workflow logic is in the background.

**jbeschi:** Yeah.

**jbeschi:** So, it should be fast to respond, like, 100 MS or 200 or something like that, I suppose.

**jbeschi:** Yeah.

**jbeschi:** So, you shouldn't have request queuing, and then you have one job.

**jbeschi:** For each, like, stats update, let's say.

**jbeschi:** So, it's quite similar, but you're going to have a lot of jobs, like...

**jbeschi:** I don't think, I'm not sure.

**Daniel Lopes:** I think we need to do some expectation.

**jbeschi:** I think I prefer the webhook approach because then you move all the complexity of batching and all that kind of stuff out of the code.

**jbeschi:** Yeah, the only problem with the webhook, I mean, not only, but one problem would be like, what's going to happen if you don't receive it?

**jbeschi:** You need to take care of that somehow.

**jbeschi:** Like, you can, you need to handle that in some way.

**jbeschi:** So if you want to follow, like, a webhook approach, you need to have some sort of long-term following to make sure that it's not going to be, like, left dead, you know?

**jbeschi:** It can even be a job, like, a recurring job that take a look at the webhook status and it is, like, processing more than whatever minutes you need to do something to handle that.

**jbeschi:** It could be either...

**jbeschi:** At this point, pull for the status of the workflow and see what's going on and all that.

**jbeschi:** So maybe you can do something like webhook, logic, and then figure a job.

**jbeschi:** Like the webhook creation, I'm just wondering.

**jbeschi:** So the webhook creation could just, for example, after create, commit, process later, and then also, I don't know, something like this.

**jbeschi:** Sorry.

**jbeschi:** I'm still learning this new editor.

**jbeschi:** Or remember, or very, very, I'll check, I don't like this name, but check tattoos later or something like that.

**jbeschi:** That's an idea.

**jbeschi:** And then it's going to enqueue a job.

**jbeschi:** Like, that's one idea, but they have also another, like, then you do this check status later.

**jbeschi:** And it is going to do, like, enqueue a check job in X minutes or something.

**jbeschi:** Because I don't if you have, like, an idea of how long it's

**jbeschi:** And this can, I don't love this pattern, so I'm going to go for the other one, but the pattern is your job in the future, like 30 minutes from now, okay, and it's going to check for the status.

**jbeschi:** If it's done, it's done.

**jbeschi:** If it's not done, let's see what's going on, and then check the status again later, or check the status again later if it's working, for example.

**jbeschi:** So, the other approach is you can, I don't love this approach because it has a lot of problems.

**jbeschi:** We had a lot of problems in basic account for this approach because it's very easy to implement, like, do this something in the future and then do it again and again and again, but if lose a job, you basically, you're blocked, you know?

**jbeschi:** So, you may be, it can happen because this is not, like, super reliable that you lose a job, and then you basically are left with that status.

**jbeschi:** Another approach is to have a cron job.

**jbeschi:** or something recurring, like a recurring job in a solid queue, I think there is also something similar, that just batches to the webhooks, through all the webhooks, and take a look at their status, like, you can store probably when it started, right?

**jbeschi:** So you can look for, like, jobs that started, you have, yeah, you have creation that did, you can use that already, so you can just look through all the jobs that are created, loop through all the, you don't have a status here, scope, processed, work, yeah, you have processed, so you can use processed, so you can loop through all the not processed jobs created 30 minutes ago, more than 30 minutes ago, and check for the status, basically.

**jbeschi:** You can do that, you can do do barge through that, you should be fine.

**jbeschi:** Unless you have million jobs, then you can't need to handle that differently, but you can just barge through all of them.

**jbeschi:** At this point, I don't know what the scale of the app, but batching should work.

**jbeschi:** And that's one option, like batching all the jobs that are created six minutes ago and are not done yet.

**jbeschi:** I mean, if you have like a million of job processing, okay, maybe you need to implement something else, but I don't think you're going to have them.

**jbeschi:** So batching to the job that are still processing and are way back, it's probably going to be an issue.

**jbeschi:** I mean, most of them would probably be broken or have some issues, so you need to take care of them.

**jbeschi:** So don't expect like a huge amount of these jobs to be fair.

**jbeschi:** So you can basically use the webhook approach, which is something on the line of these, paired with the status check, and you are covered from that job, I mean, that webhook call.

**jbeschi:** Yeah.

**jbeschi:** And you have a lot of webhook.

**jbeschi:** You said that you can...

**jbeschi:** I have a lot of HTTP calls, but I don't think it's a big deal, to be honest.

**Daniel Lopes:** I mean, should be a good job.

**jbeschi:** Yeah.

**jbeschi:** Yeah, it should be cheap.

**jbeschi:** And the main difference is that basically as soon as something is done, you process it.

**jbeschi:** So the load will spread depending on when our workflows are completed.

**jbeschi:** And the other approach with the polling, you have this long-running job that's going to keep on polling.

**jbeschi:** And I don't think it's a difference in demo's performance, to be honest.

**jbeschi:** Because if the processing, actually, I believe that this one with the web scales more.

**jbeschi:** Because let's say you're using the polling, you need to process each workflow that is completed sequentially, right?

**jbeschi:** Yeah.

**jbeschi:** In the other case, if multiple workflows, like multiple page scan workflows completes in parallel, you can process them in parallel.

**jbeschi:** And then even if you have a lot of data to process, it's not a big deal, you have a queue in the job, right?

**jbeschi:** And queuing in the background job is a different issue compared to queuing in the HTTP server.

**jbeschi:** Yeah, you can handle that, can scale worker, you can do lot of things.

**jbeschi:** mean, it can happen, but you can deal with that, and it's not like something urgent.

**jbeschi:** You know, you can, if you have monitoring, see the alert, and you deal with it in one hour, it's fine.
...
**jbeschi:** It doesn't work separate to separate.

**jbeschi:** Yeah, you can also separate the server pool for this endpoint, yeah, as you mentioned, yeah.

**jbeschi:** And what I was saying, sorry, I forgot.
...
**jbeschi:** Yeah, this is an active model, which, okay, pull up data and save.
...
**jbeschi:** And yeah, yeah.

**jbeschi:** Yeah.

**jbeschi:** Yes, I see what you mean.

**jbeschi:** If you, I mean, the webhook approach, I think we can create a gem that, you know, you can do like abstract the webhook class.

**jbeschi:** Could be like, I don't know what is a good name, maybe.

**jbeschi:** Let's say application webhook for both.

**jbeschi:** And then you just basically, in your app, you inherit from that.

**jbeschi:** You can handle that by initiating from that.

**jbeschi:** then you just, if you expose like, it can even be like exposing like the process.

**jbeschi:** I mean, the webhook will handle all the retries in queuing the job to, sorry, in queuing the job to monitor the status, which is what I mentioned earlier.

**jbeschi:** And basically, sorry, I'm just thinking loud.

**jbeschi:** Yeah, yeah.

**jbeschi:** So if you want to extract this into a gem, think you can have like controller.

**jbeschi:** Like it can be a Rails engine, for example, okay, where you can define routes, okay?

**jbeschi:** And at that point in the engine, you can define a route for receiving the webhook.

**Daniel Lopes:** Yeah.

**jbeschi:** Which is, it doesn't have to be exactly this, but just something on the line of deals with different naming and maybe, okay, different naming.

**jbeschi:** mean, then we need to figure out like how to define like the endpoint, if it's just going to be one, and then some logic to dispatch.

**jbeschi:** Like, for example, in this case, you have the flow, and then you have the dispatch to figure the, sorry, the webhook process, webhook process job is going to call the webhook processor.

**jbeschi:** So, yes, so, right, okay, so you need to.

**jbeschi:** To figure out, like, okay, so, Ricardo, I was thinking it loud first.

**jbeschi:** Create a controller, create any, I would create an engine that exposes an endpoint, that endpoint and whatever class you want to use, okay.

**jbeschi:** It can even be actually configured, in my opinion, like, you can even have, like, optional configuration that you can add.

**jbeschi:** So, for example, like, given a certain input field, which is part of the payload, use this class, or it can even be, like, So, given this input, it's still outside speaking, so, given this input, you dispatch this class.

**jbeschi:** And then, you can create a base web class in the library that you need to inherit from, okay.

**jbeschi:** So, and then the client, basically, what he needs to do is install the engine, create his own web classes.
...
**jbeschi:** Like what we're essentially talking about.

**jbeschi:** And then it came up with like a potential.

**jbeschi:** It included like the idea of tracking the status, because that's what Brad had with the Redis, but had like different patterns for webhook, pulling, and streaming.

**jbeschi:** So streaming is the one that the knowledge base uses, I didn't even know we were using streaming for that.

**jbeschi:** So that was interesting to see.

**jbeschi:** Then it was using a rail type for routes, had model concerns for dealing with the result, and a job helper for your application job, and some configurations.

**jbeschi:** There's some interesting ideas, you know, so I think.
...
**jbeschi:** That is the part I think we need it, like, if we just go through the webhook approach, that doesn't make sense.

**jbeschi:** Start with your workflow, tracking radius, okay.

**jbeschi:** Okay.

**jbeschi:** There are some design choices that I don't agree with, but I keep on reading.

**jbeschi:** Yeah.

**jbeschi:** Check the work of the job.
...
**jbeschi:** So, basically, you start a sync, you track the radius, the IDs, to monitor them afterwards, and then, okay, work of tracking workflow.

**jbeschi:** Okay, this is the job to, to, to pull, basically, okay, and then complete, okay, pattern D, okay.

**jbeschi:** Yes, Daniel, that true?

**jbeschi:** Okay.

**jbeschi:** I'm going through.

**jbeschi:** Are you scheming quickly just to use?

**jbeschi:** Yeah, yeah, yeah, yeah.

**jbeschi:** Okay, this is the tracking, the track status, I suppose.
...
**jbeschi:** Yeah, I will design this a little bit different, but it makes sense.

**jbeschi:** Yes, mean, it's an interesting grain down.

**jbeschi:** Completely different.

**jbeschi:** Yeah, but I mean, what I will do is create a record.

**jbeschi:** mean, generally, I wouldn't store in radius persistent information, like anything that can be lost.

**jbeschi:** Will be lost.

**jbeschi:** Yeah, because it can be lost, will be lost.

**jbeschi:** I've been, I mean, it depends how important it is, of course, but still, I will store every important bit in the database, because it's more reliable, reliable, and it also reduces.

**jbeschi:** So what I will do, let me just finish before speaking, okay, okay, I'm not sure about this, but okay, migration strategy, okay, let me pause it here, so what I would basically maybe do is something like, let me try to type, if I can, so I will create like a class, as I mentioned, I will repeat myself a bit, but I create a class like, it is the base class, that handles all the webbook status, so I don't, I'm not sure I'll name it webbook, but let me name it like webbook, in Rails, you just generally do like, webbook base, you do this kind of naming in library, like, webbook base, so in the library, you create a business class, I'm fiddling a bit, yeah, I'm fiddling a bit with this,

**jbeschi:** Okay, web-based class, and this will have basically a new status, you know, where I just define, like, probably, like, I don't think it's pending, so you can have, like, processing, right?

**jbeschi:** Maybe just this for now.

**jbeschi:** Maybe just processing a Fathom, maybe.

**jbeschi:** And then, you you'll have, like, a process method, which is what is on hold of taking care of all the processing on the high level, not what the actual processing is, but taking care of the high-level processing.

**jbeschi:** So, I mean, the default is, like, default.

**jbeschi:** I don't want to quote it all, but default will be, like, processing.

**jbeschi:** In this case, for example, it can be...

**jbeschi:** Something like this, sorry, this is the processing, and then you do like after create commit, okay, process later, okay, and process later, we'll do basically the job, you know, process, I don't know, webhook, base job, okay, but also, it should also include, like, remember to check later, something like this, it's a bit trash code now, okay, but that's the idea, and then remember to check later, we just, this will just include a job, like, webhook, check status job, I don't know, this can have the full wait time, or you can even set the year, like, set the wait, I don't

**jbeschi:** Default, wait, I don't know, I don't love this name, but, and this is going to be a constant, like 30 minutes from now, okay, I'm going to write it now, and this is basically the base class, and in your app you do the class, I don't know, basic search processor, inherit from, you can even implement, like, application, application, webbook, where you can define the configuration and stuff like that, that we didn't have, we don't have right now, but you can have them, like, for example, the default wait time can be configured, and whatever else, okay, and then here you just define, you do a private, you know, dev, do process, sorry, and you do whatever you want, you know, yeah, blah, blah, and, So that, you're thinking, thinking would be, like, in the models folder,

**jbeschi:** And it would be, um, this should be in the app.

**jbeschi:** So the app should be engine, my opinion, because you need routing, you need, uh, you need writing.

**jbeschi:** And you might even want to inject that into your application.

**jbeschi:** You might want to have like a generator or stuff like that.

**jbeschi:** Yeah.

**jbeschi:** Like to generate a processor if you want to, or whatever else.

**jbeschi:** So this will be like in the library app, uh, models folder, like Webboot.
...
**jbeschi:** In your project.

**jbeschi:** Yeah.

**jbeschi:** Yeah.

**jbeschi:** And this is the, uh, live code.

**jbeschi:** And the, and the, and the generator would create the processor in the models folder.

**jbeschi:** And you can have as many as you want for whatever workflows.

**jbeschi:** So, yeah, so these can be generated, for example, also.

**jbeschi:** Then the workflow, so the problem of generating the workflow, finishing this part first, and then you're going to have a controller, like webhook controller, blah, blah, blah, webhooks controller, and this is going to have that create, something like this, it depends how we name the route, yeah, and this is going to do like the, you think you would mount this route in the routes file from the, and the gem would provide the controller, so this can be a route, you can have a route in the gem, and then you mount the routes in the app, so this belongs, I might try to visit this, as we go through this, to be honest, this is a, this this

**jbeschi:** Route in the live, and then you mount the engine in the app to expose it.

**jbeschi:** Yeah.

**jbeschi:** Okay.

**jbeschi:** But then thinking of the polymorphia dispatch, like, I don't like the fact that it shouldn't be done here.

**jbeschi:** Okay.

**jbeschi:** So you can have, like, so one option.

**jbeschi:** Is that it's not the web book that is on all of that, but some other class, like, so could be, like, web, I don't know, dispatcher, let me just name it like this, and this is going to receive an input, like, uh, it can even be a class method for now.

**jbeschi:** Okay, and this is going to be receiving an input payload, as a hash, so you can even name it as payload hash, and this is going to do the polymorphic dispatch, it can be automatic, you know, it can be like payload hash, action, or whatever, you know, and you do constantize, dot, uh, you know, um, yeah, dot create, you know, and then you pass an input, like, uh, the payload, you know, and I don't know, whatever else, I, um, maybe, I can think of additional parameter for now, because I don't know all the, you know, all the context, so it's difficult, to be honest, and then here, you just use a web dispatcher at this point, uh, it's not applicable to completing, okay,

**jbeschi:** Oh, okay, I did use a different case, but in order, .dispatch, you know, and then you just have the request, it can even be like payload, param, you know, so you can, or just push params to be simple like for now, okay?

**jbeschi:** Yeah.

**jbeschi:** And so this is going to create the class, and then the webhook is going to process in the background, right?

**jbeschi:** And remember to process later.

**jbeschi:** So that's what is exposed to handle the webhook thing, and then you need to have a logic to trigger the webhook.

**jbeschi:** So how can we do that?

**jbeschi:** It can be like, so how did do that to you?

**jbeschi:** Like, sorry, my screen is a mess.

**jbeschi:** So here you go the flow client, okay, of course this is going to be internal, so the HTTP client is going to be internal in the library, it's not going be exposed at this point, anyways, it can be like, I don't know, I don't love this name, I mean, I need to revisit it, but it can be like workflow, okay, it is a workflow, it creates workflow, trigger, triggers workflow, so, yeah, my name is a bit, but okay, that's just to give you an idea, so this is going to trigger the workflow, and again, this is going to be like, probably like, I don't think any distance variables, it can be also a static cluster, like, yeah, and then, and I don't know what we have, like, is it only a name, or maybe something more, I suppose, yeah.

**jbeschi:** Yeah, right.

**jbeschi:** And this is going to use the client, which is going to be like whatever.

**jbeschi:** Inside the library.

**jbeschi:** Yeah, client.process, I don't know, perform.

**jbeschi:** It's going to be actually, I don't know, perform.

**jbeschi:** It's going to do an HP call, so I've got to think about a good name.

**jbeschi:** But do request or, it's going to do request for now, okay?

**jbeschi:** Or request, request, and then you pass the, yeah, you can accept this.

**jbeschi:** Actually, why do we need this at this point?

**jbeschi:** I can see the controller, guess.

**jbeschi:** Yeah.

**jbeschi:** I mean, you can.

**jbeschi:** I'm sure if we need.
...
**jbeschi:** The idea is this, you, in your app, you know, this is the app code, so, this is the class, and then you're going to have a controller, like, or I don't know where you want to do it, like, it can even be a model, like, I don't mind, in the code, app code, what you do is, workflow trigger, or, actually, it is this, actually, workflow.trigger, for example.

**jbeschi:** Yeah.

**jbeschi:** Yeah.

**jbeschi:** Trigger, right, and then you just...

**jbeschi:** Fathom, name, research, I don't know, and then params, I don't know what they are, whatever they are.

**jbeschi:** That's a very, very, very basic, I don't know if you can see it all, very basic idea of what I was thinking about.

**jbeschi:** And then there is basically, you need to update the status, but again, it can be this, like, when it's done, it can do, like, sorry, I forgot, processing, right, and processed or complete process, that I like more processed in this case, right, so when, sorry, this is not in the ear, right, again, the do process is going to do something, right, it can even be, like, fail at some point, like, for whatever reason, like, reason, so you can,

**jbeschi:** Yeah, you can handle this via exception, via exception, so rescue for now, so it's going to rescue whatever, you know, error.

**jbeschi:** This is going to rescue every standard error, for example, and then it's going to be like failed.

**jbeschi:** So now I realize maybe you need like a field to track the failure reason, for example.

**jbeschi:** Like, for example, it can be like, so it can be like, something like, not this, but update status failed, and then reason error.

**jbeschi:** Just, it might be something more smart, but let's do like this to give an idea.

**jbeschi:** So at least if it fails whilst processing, you know that it failed for whatever reason, and then in your app, you handle that via exception.

**jbeschi:** I mean, in your app, can, if error,

**Daniel Lopes:** That's what I mean.

**jbeschi:** This is the app code.

**jbeschi:** So in the app, you can handle error via exception, then the workflow engine, call it engine.

**jbeschi:** And then you can add a lot of stuff.

**jbeschi:** You can add, like, event tracking, for example, like, if you need to, logging and so on.

**jbeschi:** And then you need to implement also, like, the check status, right?

**jbeschi:** And this can be, like, a different, it can be handled, like, with probably, probably can be done from, I'm thinking, like, if you can be handling the web, because you might need a separate class, maybe a separate.

**jbeschi:** Or, it can, maybe even, for now, end of the year, like, I mean, oh, nice.

**jbeschi:** Yes, good point.

**jbeschi:** We need to have an ID to track.

**jbeschi:** Yeah, so when you trigger, need to get the...

**jbeschi:** Yeah, so when you do process, the do process actually is not as simple as this.

**jbeschi:** No, sorry.

**jbeschi:** When you trigger, as you mentioned, yeah, when you trigger, yeah, you need to have an ID.

**jbeschi:** So you can actually create...

**jbeschi:** No.

**jbeschi:** It would be nice to be able to pass your own ID so you...

**jbeschi:** Yeah.

**jbeschi:** backend actually can do that today.

**jbeschi:** So like the API, if you pass an ID, we use it.

**jbeschi:** So we could generate an ID from here and send it.

**jbeschi:** Yeah, so you can generate it here and then you can use it on the controller, like for, I don't know, let's say like ID, whatever, secure random dot...

**jbeschi:** Yeah.

**jbeschi:** Okay, just to use something now.

**jbeschi:** And then in the response, in the control...

**jbeschi:** So here you can use, here you create the payload, but then you can extract the ID also, like, you can do, like, payload, I'm doing something naive, but, you know, ID, and then you just pass the ID payload, okay, and so here, now you have a, so sorry, you it's not going to be the ID, but it's going to be, like, the workflow ID, okay, so here now you have the workflow ID, and you can use it, like, in the logic to check the status, which is something I was implementing, it doesn't exist yet, okay, it's going to be probably a public method, like, it can be a separate class, but let's do it here, and then check status, and then
...
**jbeschi:** I don't know, might be redundant status is okay for now, and then you just pass the ID, and then you just have some payload.

**jbeschi:** But I don't know which payload it is for now, you know, and then you handle the payload here, like, handle payload, and whatever, like, you can do like, payload dot status, sorry, status, and then, you know, I don't know what to do here for now.

**jbeschi:** No, that makes sense.

**Daniel Lopes:** Okay.

**Daniel Lopes:** Cool.

**jbeschi:** Yeah, I think, I think that, like, that's pretty close to how I would want it to look like.

**jbeschi:** And, yeah, I would.

**jbeschi:** It would of like a bulky-ish gem that you'd have routes, you'd have like models, you would have, but I get, like, what do you think?
...
**jbeschi:** What we generally do, what I generally do is first put whatever can be extracted into lib, and then extract into lib.

**jbeschi:** And then if you need to use multiple apps, at this point, you make a gem, and then use the gem in every app.

**jbeschi:** But first, I do the move to the lib from the app code base.

**jbeschi:** So you have this, you know, single folder, let's say, that stores whatever you need, and then you extract to a gem before doing the extraction.

**jbeschi:** So you do a multiple-step work, and you can have an idea, because the extraction will also give you more information, like, what you actually really need to put into the lib before you...

**jbeschi:** And then you create the lib and yeah, probably it's going to be in an engine where you have the routes and the model.

**jbeschi:** You don't need anything else probably.

**Daniel Lopes:** And as concerning the client, I don't know what to do.

**jbeschi:** It needs a migration as well.

**jbeschi:** It probably makes sense to have like a migration generator with like how you store some of the stuff, right?

**jbeschi:** Oh, yeah.

**jbeschi:** You mean migration in a sense for the database models?

**jbeschi:** Yeah.

**jbeschi:** For storing like this.

**jbeschi:** Or to migrate from...

**jbeschi:** Yeah, yeah.

**jbeschi:** So in the engine, just have the...

**jbeschi:** Let me show you.

**jbeschi:** I want to make sure you have enough time because like we are over...

**Daniel Lopes:** Yeah, yeah.

**jbeschi:** Don't worry about my time.

**jbeschi:** It's not my concern in time.

**jbeschi:** If it's your concern, okay.

**jbeschi:** So it's very simple.

**jbeschi:** Like this...

**jbeschi:** And then you have your app controller, app model, you know, here you have, you don't have controllers, you have just jobs and model, but you can have app model, controller, jobs.

**jbeschi:** Sorry, and then you have, you know, the jobs here and the models and the controller, and then you have the lab where you define, you know, the whatever generator you might need if you want to generate something.

**jbeschi:** And then you, here you expose the basic methods, if you need, and here you're not going to put the client, the client is going to live here.

**jbeschi:** Like, it's going to be something similar to, yeah, so for example, here, what I did was like, depending on the services,

**jbeschi:** We use the same service, we just go on our API, so you don't need the separation, but you're to have one client, and so you're going to have, for example, this, this is going to be the client class, in this case, the trigger method and the status methods, and then internally, it's going to do whatever it needs to do, it's going to read, you can have a shared config if you want or not.

**jbeschi:** We can decide that later, and it's going to do the HTTP call, and return basically the hash, that's what it needs to do, and concerning the library to use, I don't know, but if it's something, something like simple HTTP calls, where you don't need persistent connection, you can even use just net HTTP, you know, because the way it is going to be working here, is that you don't need to, don't need and

**jbeschi:** Makes sense.

**jbeschi:** Have a pull, connection, connection pull, sorry.

**jbeschi:** I mean, not connection pull, but a pull of, you don't need to do parallel requests, okay?

**jbeschi:** Here, you just, you just client figure, that's one HTTP request.

**jbeschi:** Yeah, yeah.

**jbeschi:** It's not a performance concern, right?

**jbeschi:** And here, too.

**jbeschi:** And so, what you can do, if you want to make it faster, is use persistent connection and have a connection pull, but I don't think it's an issue in our case, right?

**jbeschi:** So, for example, in this library, you need to do a ton of requests.

**jbeschi:** So, the way it works is that it basically uses a connection pull, like, it's a session, HTTPX, for example, this was a session.

**jbeschi:** You call this a session, I think.

**jbeschi:** It's the, no, I call it a

**jbeschi:** Like, how many connections you're going to have, if you want to keep a persistent connection, and you basically save the round trip of the TCP and shake.

**jbeschi:** That's what you save.

**jbeschi:** But in our case, we don't need that.

**jbeschi:** We can just use HTTP, in my opinion, just do the pull, if it makes sense.

**jbeschi:** Like, it's not a constant.

**jbeschi:** Like, what is slow here is the workflow process, right?

**jbeschi:** I don't think you're going to, yeah, the scalability issue is there.

**jbeschi:** In the app side, you only need to worry about processing the web book async, so you don't overload the web server.
...
**jbeschi:** Of course, you need to implement something on the client, but I don't think it's going to happen.

**jbeschi:** It's not like, you know, if it was like MailChimp, where you need to send a newsletter to a million of users, and then, of course, in that case, maybe you have a webhook, like, oh, tell me when they opened the email, something like that.

**jbeschi:** And then when you send this massive amount, you're going have a massive amount to request on the way back.
...
**jbeschi:** And then I left GIFT, took over the company code base.

**jbeschi:** So I worked on the code base afterwards.
...
**jbeschi:** But do you have anything else I can answer?

**jbeschi:** Like, do you want me to show you anything?

**jbeschi:** Like, I want to make sure you have time as well.

**jbeschi:** Like I said, I'm good on time.

**jbeschi:** Yeah, but do you have any more questions?
...
**jbeschi:** Yeah, and I thought that I messed at you know, HBM.

**jbeschi:** No, this is my worst.

**jbeschi:** No, no, no, this is super helpful.

**jbeschi:** Okay.

**jbeschi:** Yes, maybe I'll stop the share if you don't mind.

**jbeschi:** Yeah, yeah.

**jbeschi:** Share screen, okay.

**jbeschi:** Okay.

**jbeschi:** We'll send you an offer probably tomorrow.

**jbeschi:** I'll talk to Tucker and we can plan anything out.
...
**jbeschi:** So I was there when Ryan and Jason were thinking about the shape-up stuff.

**jbeschi:** So like I, and they were thinking about the process.

**jbeschi:** I'm very much aligned, but we use linear.

**jbeschi:** I don't love linear.

**jbeschi:** It's just that the integration of Slack is so good.
...
**jbeschi:** have a channel for every project and a GitHub branch.

**jbeschi:** So we do, like, long-lived branches throughout the cycle instead of, like, continuous merge just to be easier to review things.
...
**jbeschi:** So those are the milestones in linear, very similar to the to-do list in Basecamp.

**jbeschi:** So let's say this case issues here.

**jbeschi:** We have the milestones of the probing, public directory, sign-up, and the stuff that is on school.

**jbeschi:** So that's, it's very, pretty similar to probably how you guys, guys worked.

**jbeschi:** Yes, yes.

**jbeschi:** I was about to ask about the big PR versus small PRs.

**jbeschi:** then, yeah, the general approach.

**jbeschi:** What's your feeling there?

**jbeschi:** Like, that's something that I've actually, like, introduced bigger PRs recently.

**jbeschi:** Like, because that's how we worked at IFTTT and Kanopy.

**jbeschi:** And, like, folks were merging things constantly before.

**jbeschi:** And, like, I just added cycles to the product team as well.

**jbeschi:** This is the first cycle that's going come to me.

**jbeschi:** Yeah.

**jbeschi:** My take is that if you're building a new feature, for example, new functionality, whatever, it's easier to review and to see the bulk of changes with a one big PR.

**jbeschi:** And so I generally prefer that.

**jbeschi:** Approach versus a lot of small PR where you don't get the whole context.

**jbeschi:** There are some cases where small PR makes sense.

**jbeschi:** And it's when you're doing, especially when you're doing something less related to specific feature, more of like a migration approach or something like that that is naturally divided into multiple steps.

**jbeschi:** So, for example, back then, like a few years ago, I did some work to, we had an incident in Basecamp where we basically lost data from Redis.

**jbeschi:** Nobody figured out why in the Ops team, why that happened, but we lost data.

**jbeschi:** So we were used to store some data that is not a theme running Redis.

**jbeschi:** Like, I don't know if you ever used Basecamp.

**jbeschi:** Okay, you did.

**jbeschi:** Like, okay, for example, things like...

**jbeschi:** years.

**jbeschi:** Okay.

**jbeschi:** Yeah, I wasn't expecting that answer, but yes, just in case.

**jbeschi:** Anyways.

**jbeschi:** For example, the theme color and some settings that they were stored in Redis, right?

**jbeschi:** David implemented that in this way and he said, it's fine.

**jbeschi:** I mean, you can lose that information.

**jbeschi:** Well, turns out that when we actually lost that information was not something we could lose, like, without issues, like, you know?

**jbeschi:** so we spin off a work to migrate, basically, all the data, non-ephemeral, stored in Redis from Redis to the database.

**jbeschi:** And so in this case, where you basically have a bunch of application code base spread across different parts of the application, right?

**jbeschi:** It's not, like, one single feature.

**jbeschi:** have, like, notification logic.

**jbeschi:** You have theme settings.

**jbeschi:** You have whatever else.

**jbeschi:** It was, like, 20 different features, right?

**jbeschi:** And you need to change each of them.

**jbeschi:** In this case, it makes sense to just split the work in 20 whatever PRs and handle the deploy and the migration for each one separately because making one big PR is not going to work because you need to also take care, for example, of data migration, right?

**jbeschi:** So you need to have multiple steps, like one step where you basically read the, I mean, you can't just do one step migration because you're going to have some time where you don't have the data, right?

**jbeschi:** So you need to have like a double read, like read from the Redis database and read from the database, sorry, read from the database and for Redis as a fullback.

**jbeschi:** And that's the first thing that you deploy.
...
**jbeschi:** Let's just cut off the part reading from the Redis.

**jbeschi:** And then you're going to also clear the Redis store, right?

**jbeschi:** Because you don't want to waste that space.

**Daniel Lopes:** Because it's not going to be evicted automatically.

**jbeschi:** It's not like a cache that is going to be evicted.

**jbeschi:** And you do it for each part of the app.
...
**jbeschi:** And cursor had, was the first AI coding editor that had the ways for you to define the rules.

**jbeschi:** But we're moving out of cursor to be cloud code focused.

**jbeschi:** So, and cloud code, you can trigger from anything.

**jbeschi:** So you can trigger from terminal, you can trigger from VS code.

**jbeschi:** VS code, they have a browser extension that has UI.

**jbeschi:** But if you're using NIL, or if you're using terminal, No.

**jbeschi:** They have the terminal interface, and they're all going to use the same rules.

**jbeschi:** So for coding workflows, that's the only thing that we have that's atypical, it's just like probably like we have to use cloud code.

**jbeschi:** And then web, like the development wise for the other areas, Mac ideal, in my opinion.

**jbeschi:** And then we have one person that I think uses Windows.

**jbeschi:** I think that, I think Stefano uses Windows, but I think we got him on Mac.

**jbeschi:** He should be using Mac, I think.

**jbeschi:** If I can give you an advice, it's good to have like, didn't meant to interrupt, but I forget stuff.

**jbeschi:** So I just, I'm sorry.
...
**jbeschi:** Yeah, no, no, I agree, yeah, so like, I think, yeah, so like Mac is ideal, it's what everybody gets when they join, so like, I think we have, that's the standard laptop we have, and then we have for development.

**jbeschi:** So the happy path for Rails, for the Rails apps is not non-Docker, but I know some folks use Docker for development as well.

**jbeschi:** That's one thing that would be, like if you were to join, it would cool to align is have you help us polish the setup of a new app and like document and like come up, have us come up with the happy path and that's the standard way and like have seeds and all that stuff.
...
**jbeschi:** And we have also one person that is pretty advanced with all the different AWS services and Kubernetes as well.

**jbeschi:** But they're coding the framework, the AI framework.

**jbeschi:** That one would be an interesting area to get your help to have one more person.

**jbeschi:** Even though you haven't done a lot of TypeScript work or AI work, it would be nice to have your library mindset and the taste for good, well-designed...

**jbeschi:** And framework to, to support there.

**jbeschi:** We're expecting to do like a big, like if you were to join, the two areas you probably would need your help would be the project that Jose is working on.

**jbeschi:** He's going to go in paternity leave soon.

**jbeschi:** So next month.
...
**jbeschi:** Probably going to have like some of the other product guys join.

**jbeschi:** And if you were to join, we probably need your help to review whatever they do as well there.

**jbeschi:** That's the thing that I was thinking, like you being in the Italy time zone, you kind of overlap with a lot of the other folks that are in the East Coast.

**jbeschi:** So it wouldn't be a problem at all, even if we're doing like product stuff, because you overlap with like, we have in Italy, for example, as well.

**jbeschi:** So, and he's one of our product designers.
...
**jbeschi:** We're going to scrape the results and analyze the pages.

**jbeschi:** And like, what are the things that make, increase the probability of a page to, to be, uh.

**jbeschi:** Mentioned or not.
...
**jbeschi:** And if there are product issues, like if there's like a bug on Atlas or if there's like a bug on CheckNet, that would be like a ticket that we either would see through Sentry as an exception, or we would get a ticket report from one of our teammates to the client ops.

**jbeschi:** And they would pass that to the other side, to the product lane.

**jbeschi:** And we usually, we're thinking about, like, the way we're doing now, it's like we have one of the folks there on the cycle be the point of contact.

**jbeschi:** But we don't have the own call for, like, at down mid of the night.

**jbeschi:** I'm the only person on call for that.

**jbeschi:** So I'm going to, I get the first pager duty.

**jbeschi:** We're small enough.

**jbeschi:** But, like, it hasn't happened much.

**jbeschi:** So, and sometimes Marcos will pick up, he's in Portugal.

**jbeschi:** So he'll, like, get the other shifts automatically.

**jbeschi:** He will notice when things are down.

**jbeschi:** So, but I'm the U.S.

**jbeschi:** or the first line of defense for app down.

**jbeschi:** Yeah.

**jbeschi:** Yeah, well, the thing is that when you, now that most of the customers are internal, it's completely fine.
...
**jbeschi:** But if you open to the public, I mean, of course, I don't imagine things like, you know, in Basecamp where you have millions of users, a few minions, not that many, but still enough to do very weird edge cases or to have very weird issues.

**jbeschi:** But still, it's going to open a lot of doors for issues.

**jbeschi:** I think check that will be like that.

**jbeschi:** So that was kind of like, if it was like this, where like, at 10 million users, or like every...

**jbeschi:** If is like 30 minutes, it would be enough for the change to show up as a bug.

**jbeschi:** So I think check that, we're probably going to have thousands of users in the first month, I'm pretty sure.

**jbeschi:** Because that's what some of the competitors that we're competing with there get.

**jbeschi:** And our goal there is to ship a product that is essentially free, and the competitors are charging $1,000 a month.

**jbeschi:** so we expect to get a ton of demand there.

**jbeschi:** Wow.

**jbeschi:** Yeah, so that's why I'm like, oh, Jose is going to have opportunity to leave.

**jbeschi:** We're probably going to have to put most of the team there anyway, so for the launch.

**jbeschi:** The launch is the painful, more painful part.

**jbeschi:** I know because in this camp, every time there is a launch, it's a pain.

**jbeschi:** Like when they launched the launch date, it was a mess.

**jbeschi:** When they launched the calendar, it was a mess.

**jbeschi:** And now they're going to launch a new product in the future.

**Daniel Lopes:** And it's going to be every time there is.

**jbeschi:** The first, like, at least two or three weeks, at least even three weeks, probably, is going to be a lot of problems.

**jbeschi:** Like, the first weeks, for sure, but then also the following couple of weeks, it's going to be a lot of issues raising.

**jbeschi:** No, I was asking about the on-call because there was this issue in Basecamp where, you know, they have product programmer and they have SIP team.

**jbeschi:** Back in the days, the SIP team were the only people on-call.

**jbeschi:** So the programmer were only just, the product programmer would only be a new feature.

**jbeschi:** So what happened was that the product programmer, sometimes, to cut the scope, they cut the scope on error handling and potential issues.

**jbeschi:** And so the SIP team was on hold of taking care of all of them.

**jbeschi:** And I remember Rosa was, like, very tired because of that.

**jbeschi:** And Jorge, I don't know if you know him, but his ex-collegue was very tired of those things.

**jbeschi:** So he proposed, okay, now on-call needs to be handled by everyone, also by the product programmer.
...
**jbeschi:** Sorry, I was about to say something, but it's not important.

**jbeschi:** Yeah, I think I don't have any more questions, more important ones.

**jbeschi:** I mean, you answered all of them very clearly.

**jbeschi:** And I really appreciate, I mean, all the time you spent with me.

**jbeschi:** I know you're a busy person, so it matters a lot for me.

**jbeschi:** Sorry if I interrupted you a lot.

**jbeschi:** No, no, no.

**jbeschi:** No, don't worry about that.

**jbeschi:** I offend you or anything like that.

**jbeschi:** I'm just saying, no.

**jbeschi:** No, no, no.

**jbeschi:** I'm the same.

**jbeschi:** Let me think if there's anything else.

**jbeschi:** Yeah, let me know if there's anything else you need to talk to more.

**jbeschi:** Anybody else?

**jbeschi:** Anything?

**jbeschi:** I'll talk to Tucker.

**jbeschi:** I don't know how much you shared with him.

**jbeschi:** Where are you in your research process?

**jbeschi:** And if you were to join, when would you be able to start?

**jbeschi:** Okay.

**jbeschi:** The search process.

**jbeschi:** mean, I told you the last time that basically what happened was that I left Basecamp and the week after I spoke with you.

**jbeschi:** And I was not happy to searching anything because it was like I need a little break before doing anything else.

**jbeschi:** After four years of uninterrupted work and also previously five years, same thing.

**jbeschi:** never had the chance to take a break.

**jbeschi:** Take a break.

**jbeschi:** Let's take a little break before starting to look for a new job.

**jbeschi:** But then Rosa just sent me an email.

**jbeschi:** I mean, I left on Monday, I think, and Rosa sent me an
...
**jbeschi:** Yeah, I can't imagine that.

**jbeschi:** Yeah, I was just going to say that, like, Jose is scheduled for November 15th, Caesarean.
...
**jbeschi:** Yeah, so, yeah, the time zone is not a problem.

**jbeschi:** Roles, like the role that I was like, titles and stuff like that, we're still pretty, like, early.
...
**jbeschi:** Is it correct?

**jbeschi:** You don't handle it?

**jbeschi:** No, you can...

**jbeschi:** Yeah, we don't track that.

**jbeschi:** So take whatever you want.

**jbeschi:** We usually have...

**jbeschi:** I don't know if we're going to do this year, but we used to do two weeks off by the end of...

**jbeschi:** The year, and we would just handle like on call.

**jbeschi:** So somebody would be on call for like part of that, but no active development or active work during that period.

**jbeschi:** I think we might do this year again.

**jbeschi:** I haven't talked to Marcel about that yet.

**jbeschi:** Yeah, but we don't track holidays either.
...
**jbeschi:** So if you hire the right people, so.
...
**jbeschi:** Massa, and I don't know, in Italy we have our own national holidays, so I was thinking, like, if I can take those days off, like, it doesn't need to be 10 days, but a few days at least for national holidays, and then, okay, you answered my question anyways.
...
**jbeschi:** But they're just probably going to burn out by themselves.

**jbeschi:** So, try to take at least 10 days a year, minimum.

**jbeschi:** Yeah, whatever needs to be done.

**jbeschi:** And also, like, illness.

**jbeschi:** Usually, I'm never sick, but it happened that one day or two days I was sick.

**jbeschi:** can't do anything for that.
...
**jbeschi:** Funny enough, think, like, at Basecamp, I think the only person that...
...
**jbeschi:** It's pretty good for a startup.
...
**jbeschi:** And after we make the output framework, open source.
...
**jbeschi:** So there is like a lot of that need for like moving fast on Atlas.

**jbeschi:** On CheckNet is different.

**jbeschi:** So CheckNet is more like a traditional product.

**jbeschi:** So we have to move a little bit slower and like more careful.

**jbeschi:** But it's also like a heavily, the competition on that space is moving fast.

**Daniel Lopes:** So there's that kind of time pressure, but it's never from like, oh, we got to  this.

**jbeschi:** For just because I made up a date, it's more like, yeah, you see, we open Slack and folks are like, oh , like, I'm working 70 hours.

**jbeschi:** like, okay, we got to systematize the things for you to get you back to 40 hours on this client instead of that.
...
**jbeschi:** So it's a, the benefit of the product team should help.

**jbeschi:** Yeah.

**jbeschi:** This is a transition phase, basically.

**jbeschi:** You need to move as quickly as possible to help them.
...
**jbeschi:** No, it's fine.

**jbeschi:** The computer, do you want me to use?

**jbeschi:** I have a computer, but I don't know if you want me to use it or get one.
...
**jbeschi:** So it's less of a security problem and anything.

**jbeschi:** But, okay, okay.

**jbeschi:** Sock compliant, do you need to, do you are afraid about that, like in the future?

**jbeschi:** Yeah, we might need to be Sock compliant in the future, but today we're not.
