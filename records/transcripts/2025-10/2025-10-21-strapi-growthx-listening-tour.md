...
participants: Victor’s iPhone, Andi Bailey, Marcel Santilli
...
Review account health and address Strapi's feedback on GrowthX services.
...
**Marcel Santilli**
- Add Strapi to ContentOS beta; notify Victor when ready
- Have Bridget email Victor re: OSS/IP; request intros (JJ/Heather)

---

## Transcript
**Victor’s iPhone:** What's going on, sir?

**Victor’s iPhone:** Hey, Marcel, how you doing?

**Marcel Santilli:** Really good, man.

**Victor’s iPhone:** I am driving, that's why I'm off camera, but yeah, I'm going to San Francisco for next GSConf tomorrow, and yeah, CPI on Thursday.
...
**Victor’s iPhone:** I am coming, I think, to your CMO breakfast.

**Victor’s iPhone:** I don't know how much I'll be able to stay, because I have to go to that other conference after, but yeah, up to you, whatever works best.
...
**Victor’s iPhone:** Yeah, give, like, seven or eight.

**Victor’s iPhone:** We've had some issues that, like, I think the team is catching.

**Victor’s iPhone:** So it's, and we also had, I think, a lot of changes in terms of account management.

**Victor’s iPhone:** So I think, like, there's a little bit of a learning curve for each folks.

**Victor’s iPhone:** So, yeah, I'd say, like, yeah, seven or eight, depending on the week.

**Marcel Santilli:** Yeah, exactly.

**Marcel Santilli:** Depending on how good of a day we're having.

**Victor’s iPhone:** Yeah, exactly.

**Marcel Santilli:** That's funny.

**Marcel Santilli:** What about volume of output?

**Victor’s iPhone:** I think volume's been pretty consistent.

**Victor’s iPhone:** Yeah, I'd say, like, yeah, I'd like, a nine.

**Marcel Santilli:** Cool.

**Marcel Santilli:** And then...

**Victor’s iPhone:** Performance is probably like, yeah, it's seven or eight.

**Victor’s iPhone:** think like we've seen growth over time, but I feel like it's, I don't know if it's, I don't know what it is.

**Victor’s iPhone:** I feel like he hasn't, you it's been a year and so, I don't know, maybe my expectation was too high.

**Victor’s iPhone:** But in terms of like the volume, I was expecting a bit more.

**Victor’s iPhone:** But then again, like you have to put things into context, right?

**Victor’s iPhone:** Like with the whole world shifting to, away from Google and into GEO.

**Victor’s iPhone:** So like, you know, I don't know how much of it is macroeconomic or like, you know, macro level changes versus like growthx performance.
...
**Victor’s iPhone:** Yeah, that sounds good.

**Victor’s iPhone:** Yeah, it's funny because, you know, Josh is also the partner at Hypergrove, so we do see, you know, Webpro, obviously, as a competitor.

**Victor’s iPhone:** But, yeah, no, overall, like, you know, like, some of the work that we do, like, I think, like, page that comes up is, like, our Next.js landing page, which was, we predest growthx, right?

**Victor’s iPhone:** So, like, these wheels are, like, trying to measure.

**Victor’s iPhone:** What DevRel is doing internally versus the contribution of ProSax is bringing, and I think, to me, there is some quicker wins that I'm trying to get to, which is making sure we get the fundamentals right, making sure we have the right metas, and making sure we have FAQ on all pages.

**Victor’s iPhone:** And I think that's what's, having those fundamentals right, I think it's what drives success in the long run.

**Victor’s iPhone:** So, you know, first, maybe let's finish your rating scale of 1 to 10, and then I can share a bit more of, like, what I see with this crosshack at the moment.
...
**Victor’s iPhone:** Yeah, I'd say I'd put it nine.

**Victor’s iPhone:** Like, think Vivek and Mara, they're doing a great job.

**Victor’s iPhone:** Yeah, overall, like, you know, we've had a lot of changes, so that was a challenge in and out of itself.

**Victor’s iPhone:** But at the same time, like, we got, I feel like we got a stronger team.

**Victor’s iPhone:** So I'm definitely happy with the folks we have now versus before.

**Marcel Santilli:** Okay, cool.

**Marcel Santilli:** So you've seen an improvement with the team managing things compared to before.

**Victor’s iPhone:** Correct.
...
**Victor’s iPhone:** Yeah, so, like, for me, like, at the moment, like, I'm struggling with, there's a couple of workflows that I feel like your team has dependencies with your engineering team.

**Victor’s iPhone:** And so this is where, like, some of.

**Victor’s iPhone:** Frustration comes because my team is like, yeah, this is super quick.

**Victor’s iPhone:** Like, we should be able to do it.

**Victor’s iPhone:** And I think we lost a little bit of, like, the self-serve that we, I think, we have initially thought we would have with Air Ops.

**Victor’s iPhone:** And I think as you guys transitioned to Atlas, I think there, we lost a little bit of that ability to self-serve.

**Victor’s iPhone:** And it creates a bit of bottleneck because we're, like, my team is like, hey, like, we want to, you know, we can do this.

**Victor’s iPhone:** Quickly, but we also don't want to make sure that we, we want to make sure we stay integrated with the other workflows.

**Victor’s iPhone:** So I think that's one point of frustration, especially on the, yeah, the workflow that requires, like, dependency with your engineering team, because that we see a bunch of bottlenecks there where, like, it's taking longer than, than we hope.

**Marcel Santilli:** Got it.

**Victor’s iPhone:** To give you a specific example, we had one around, like, image.

**Victor’s iPhone:** Thank .

**Victor’s iPhone:** Thank

**Victor’s iPhone:** image generation.

**Victor’s iPhone:** It took like almost six months to get something that's still like, it's not like mind blowing, right?

**Victor’s iPhone:** So that was, I think it's also due to the change in the team.

**Victor’s iPhone:** think there was some information that was probably lost in the transfer.

**Victor’s iPhone:** But yeah, so that's a specific example.

**Marcel Santilli:** Is the image good now?

**Marcel Santilli:** The image generation?

**Victor’s iPhone:** Yeah, yeah.

**Victor’s iPhone:** That one is, we addressed it.

**Victor’s iPhone:** But like, it's the indication, which is like, yeah.
...
**Victor’s iPhone:** Yeah, I'd say like, it's like, it's, it's fine.

**Victor’s iPhone:** I think like, it's on, on brand.

**Victor’s iPhone:** But it's, I was hoping for a little more given the time, you know, we had like a lot of back and forth.

**Victor’s iPhone:** So like, I guess my expectation was, where, you know,

**Victor’s iPhone:** Because we waited so long, I was expecting for something a little bit more, yeah, significant.
...
**Victor’s iPhone:** And the ability to self-serve, because like, I don't know, like...

**Victor’s iPhone:** For me, that's also, like, it's so core to what we do, especially because, you know, we are CMS.

**Victor’s iPhone:** So, like, that's, we have to also think about, like, what, where the roadmap is for us, the product, and what should be, like, you know, done within Strapi versus done in, outside of Strapi.

**Victor’s iPhone:** And so, I want to make sure my team is also, like, able to self-server in some capacity.

**Victor’s iPhone:** But that's where I'm struggling a little bit with, you know, not having access to Atlas the way we add access to Airsoft.

**Victor’s iPhone:** So, I'm curious, what's your philosophy on that?
...
**Victor’s iPhone:** Yeah, so, like, maybe, like, trying to understand, like, a bit more, like, what's the context you shared about the image gen?

**Victor’s iPhone:** Like, that's really good context that the team didn't provide.

**Victor’s iPhone:** So, that would be good to know, like, because maybe, like, you know, if we had known that it was so much work on your end, like, maybe we'd have focused on something else and, you know, eventually, like, not prioritize it in our discussion.

**Victor’s iPhone:** Because it felt like we still spent a bunch of cycles talking about it.

**Victor’s iPhone:** And so, like, it was fine for me, like, if the team would have said, okay, like, it's, you know, it's something that we've identified as critical across customers.

**Victor’s iPhone:** It's just not there yet.

**Victor’s iPhone:** Let's not focus on this, and we'll let you know when it's ready.

**Victor’s iPhone:** That's totally fine.

**Victor’s iPhone:** It just felt like we ended up talking about it too much when you had a bunch of dependency work.

**Victor’s iPhone:** So in terms of ideal workflow, maybe aligning a bit more on priority, understanding how much work is required on your end.

**Victor’s iPhone:** Because my understanding as well is because we're on legacy pricing, we have to be very careful with what work stream we prioritize.

**Victor’s iPhone:** So if we focus on that, that means we're not focusing on something else.

**Victor’s iPhone:** So I'd rather just the team tells me like, okay, like this is, yeah, this is basically too much work for like, you know, your level of pricing and where, you know, where the team is at in terms of R&D internally.

**Victor’s iPhone:** so much.

**Victor’s iPhone:** So we have to focus on lower effort, higher impact.
...
**Victor’s iPhone:** Yeah.

**Victor’s iPhone:** Yeah.

**Victor’s iPhone:** To me, it's like be very candid with us as far as like managing expectation for like where like this stands in terms of feasibility and, you priority in other, other people's like, just because you're not saying you mutualize across, across customers, just being very transparent.

**Victor’s iPhone:** And candid about that.

**Victor’s iPhone:** then ideally giving us a way to self-serve.

**Victor’s iPhone:** So some of those things is like, hey, the team doesn't have the bandwidth to do it.

**Victor’s iPhone:** We can go ahead and try to figure it out ourselves.
...
**Victor’s iPhone:** You know, give us and things like that and create an environment.
...
**Victor’s iPhone:** Okay.

**Victor’s iPhone:** Got it.

**Victor’s iPhone:** So, in all transparency, I was, like, thinking, like, you know, should we look at AirOps for, like, some of the workflow and, like, keep working with GrowthX on some stuff and work with AirOps for other things?

**Victor’s iPhone:** Like, or should we, so I'm really glad to hear it sounds like we'll have the ability to self-serve and I should probably not go down the path of, like, duplicating work with AirOps workflows.
...
**Victor’s iPhone:** Yes, we did, yeah.
...
**Victor’s iPhone:** Yeah, I love it.
...
**Victor’s iPhone:** Yeah, yeah, makes sense.

**Victor’s iPhone:** Thanks so much for the context.

**Victor’s iPhone:** I'm excited about this, and we should talk about, like, potentially the launch, because I think we would be happy to, you know, as a big open source project, we kind of love to support and see how we, you know, make sure.

**Victor’s iPhone:** Because you have the kind of strapi integration out of the box.

**Victor’s iPhone:** And, you know, NA10, we work with them.

**Victor’s iPhone:** They use strapi as well.

**Victor’s iPhone:** And so I feel like for us, we definitely see that kind of, like, workflow orchestration as leaving, it's out of scope.

**Victor’s iPhone:** But we obviously want to integrate very tightly with those frameworks.

**Victor’s iPhone:** And so if you open source, that's, like, perfect in terms of, you know, DNA.
...
**Victor’s iPhone:** I'm just trying to remember.

**Victor’s iPhone:** Series B, $31 million, like, a year and a half ago.
...
**Victor’s iPhone:** Oh, I do.

**Victor’s iPhone:** I do.

**Victor’s iPhone:** I do.

**Victor’s iPhone:** I mean, that's, you know, that's my bread and butter.

**Victor’s iPhone:** So I know a lot of people that, I know a lot myself about open source license, and I know a lot of people that, you know, actual lawyers that could help, you know, like, obviously, I'm thinking about JJ from OSS Capital.

**Victor’s iPhone:** I don't know if you know him.

**Victor’s iPhone:** But, yeah, he would be a good person to talk to.

**Victor’s iPhone:** He has, like, one of his GP is, he's a lawyer, Heather.

**Victor’s iPhone:** So I'm happy to connect you guys if you want.
...
**Victor’s iPhone:** Yeah, totally.

**Marcel Santilli:** Have you met her?

**Marcel Santilli:** Or have you connected with her before?

**Victor’s iPhone:** She used to be at AirBite.

**Victor’s iPhone:** AirBite, yeah, yeah, I've connected with them quite a bit.

**Victor’s iPhone:** I mean, I know Jean really well.
...
**Victor’s iPhone:** I know, I know.

**Victor’s iPhone:** I remember you guys being connected to each other.
...
**Victor’s iPhone:** Yeah, that sounds great.

**Victor’s iPhone:** And one last thing, I was on the Scaling DevTool podcast.

**Victor’s iPhone:** was Scaling DevTool I was
...
**Victor’s iPhone:** Awesome.

**Victor’s iPhone:** Appreciate it.
