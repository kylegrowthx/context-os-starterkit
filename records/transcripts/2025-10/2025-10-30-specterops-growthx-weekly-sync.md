...
participants: Kirsten Gibson, Team GrowthX, Ric Nguyen, Bryce Hein, Erik O'Brien, Meshach Cisero, Jason Wolfe, Tgomez, Aida Knežević
...
Sync on content strategy, review initial drafts, and align on next steps.
...
### Product & Brand Alignment
  ...
  - **Product Deep-Dive:** A product deep-dive is needed for content context.
      - **Presenter:** Jonathan Parfait (SE) is the best choice, as their customer-facing experience provides the most relevant context for content creation.
...
- Schedule product walkthrough w/ Jonathan Parfait + Erik for next week

**Erik O'Brien**
- Share Scrunch base prompts w/ SpecterOps team

**Ric Nguyen**
- Email brand standards guide to Aida + Erik
...
**Aida Knežević:** And yeah, so I've added everybody to the agenda.

**Aida Knežević:** So you should get an email from Notion with the agenda in your inbox.

**Aida Knežević:** But yeah, there are a couple of things that I wanted to go over with you all today.

**Aida Knežević:** The main, I mean, there are two really like major updates.
...
**Aida Knežević:** I'm sure that there are going to be some ideas where you're, like, where, you know, you're thinking, okay, we should, like, have a specific opinion about this topic, or there's something really unique we should add to the conversation.

**Aida Knežević:** And you can also provide those thoughts in the comment box as well.

**Aida Knežević:** conversation.

**Aida Knežević:** I'm sure that can add the I'm sure ideas

**Aida Knežević:** We are, like, creating SEO content and we were trying to, like, our goal is we want to get you organic search traffic and we want to improve your visibility in AI search.
...
**Aida Knežević:** So I am curious, I know that your blogs have a very unique like point of view and the writing style is also quite unique, but I was just, you know, curious to see.

**Aida Knežević:** See you next Bye.

**Aida Knežević:** Bye.

**Aida Knežević:** What do you think?
...
**Aida Knežević:** Yeah, yeah, that's very valuable.

**Aida Knežević:** I think, I don't think that comes across in the content.

**Aida Knežević:** So we do talk about, we do mention SpecterOps, but I think that portion is missing and that's something that we could add.
...
**Aida Knežević:** I mean, even if I, we've had like, with the clients that I've worked with previously, it really depends on the industry, but they might have like different opinions that they want to share that they want to come across in all of the articles.

**Aida Knežević:** So there, there's almost like, for example, we have one client, they're a web development agency, and they have this.

**Aida Knežević:** that's, that's, that's, that

**Aida Knežević:** Approach to web development that's all about, like, composable design, and they're, at least they used to be quite unique in that sense, so they kind of gave us, like, a two-page Google Doc with, like, just, like, talking points about how, what their approach is to, like, to web design and why, like, going composable is the way to go, and they had all these proof points.
...
**Aida Knežević:** And then once we feel like we're in a good spot with like the tone and everything, our goal was to generate three blogs next week.

**Aida Knežević:** And then the following week, we can scale to five.

**Aida Knežević:** That's the typical kind of cadence.

**Aida Knežević:** And I think, I mean, we can start publishing.

**Aida Knežević:** Like as soon as this one is, you know, greenlit and good to go, we could stage it in your CMS.

**Aida Knežević:** Okay, awesome.

**Aida Knežević:** Okay, another update that I had for you is that we have your Looker dashboard set up.

**Aida Knežević:** I'm not sure if Erik has covered this earlier, but we use Looker to combine data from problem, As soon

**Aida Knežević:** Google Analytics and Google Search Console in a single report, and it's a seven-page report that covers, like, different aspects of your website performance.
...
**Aida Knežević:** It would be great if you could kind of let us

**Aida Knežević:** No, you don't have to do that like right away, but at some point if we could just get like a quick explanation of the different conversion events, like where on the website are they located and what they do, I think this is pretty actually pretty self-explanatory, this is a lot better from what I usually see, so it is pretty straightforward, but if you want to give like additional insight into which events are more important right now, that would also be helpful.
...
**Aida Knežević:** The cohort report is a report that includes data from Google Analytics and Google Search Console.

**Aida Knežević:** So

**Aida Knežević:** It's going to, once we start publishing, it's going to include data from about blogs that we publish, and we can also compare it to like the rest of your website.
...
**Aida Knežević:** Most traffic comes from TradGPT, which is pretty standard.

**Aida Knežević:** Most of the customers that we work with also get like the most LLM traffic from TradGPT.
...
**Aida Knežević:** In around August this year, ChadGPT, they updated their algorithm so that they started favoring websites like Wikipedia and Reddit when they're citing different, like, when they're citing answers.
...
**Aida Knežević:** Anyways, yeah, did we, Erik, did we share the prompts with the SpecterOps team?

**Erik O'Brien:** No, we did not.

**Aida Knežević:** Yeah, so we could share, like, right now we're using, they're called, like, base prompts, which are generated in Scrunch.

**Aida Knežević:** We, like, we give Scrunch a description of your company, we give it descriptions of your audience, and then we also upload your competitors.

**Aida Knežević:** And then Scrunch will automatically generate base prompts, which are, they're just basically trying to guess.

**Aida Knežević:** So, yeah.

**Aida Knežević:** What your audience would be asking different LLMs, but we can also add like many, many more prompts here.
...
**Aida Knežević:** So your citation rate is 10%, which is actually quite high compared to what we're usually seeing.

**Aida Knežević:** What we're usually seeing is around like 2% 3%.

**Aida Knežević:** But this is just from the prompts that we're tracking.

**Aida Knežević:** Again, like, you know, the prompts could be sometimes.

**Aida Knežević:** Sometimes the prompts may be a little like leading the witness in the sense that they're kind of like could be maybe guiding the LLM to SpecterOps, but considering your competitors are trailing like close by, this is still quite good.
