...
Refine the AI tool architecture to improve SDR adoption and align with ABM strategy.
...
**Kyle Gaudreau:** You know, a ChatGBT, a Claude, whatever.
...
**Rachael Tiow:** But when it comes to Okta's customer identity versus odd zero, that one, I'm still, yeah, I told my boss, I said, I am taking a very strong stance and I'm going to develop a POV.
...
**Rachael Tiow:** So that's a very different reason than why a company like Salesforce would buy OddZero.

**Rachael Tiow:** Salesforce would buy OddZero because they have acquired so many tools.
