...
participants: Aida Knezevic (GrowthX), Dave Abbaszadeh (Witness AI), Stephanie Gilliam (Witness AI), Sharat Ganesh (Witness AI)
...
GrowthX and Witness AI reviewed the 75-topic content calendar launching the new security blog, approved the prompt injection rewritten article, and discussed performance tracking through a Looker dashboard that combines GA4 and Google Search Console data. The team identified an LLM traffic opportunity — blog content ranks well with ChatGPT and Perplexity, but product pages don't, so the strategy is to link product pages from high-ranking blog posts to drive deeper engagement. The team also set up CheckThat monitoring with 63 prompts aligned to the content calendar keywords.

---

## Context

Witness AI is a security-focused company building AI threat detection and response tools. GrowthX is delivering a content marketing engagement for Witness AI, launching a dedicated security blog to drive organic visibility and traffic to product pages. The relationship is a full-service content development and SEO execution project. This meeting is part of the weekly sync to review content progress, approve deliverables, and align on strategy as the blog grows from new to established authority in AI security topics. The previous week GrowthX delivered a 75-topic content calendar covering core security clusters (AI governance, compliance, shadow AI) plus emerging threat verticals (RAG security, AI fuzzing, chatbots in specific industries) — sourced from competitor keyword analysis and Witness AI's internal threat documentation.

---

## Relevance

- **To GrowthX Delivery:** Blog post structure now includes Key Takeaway sections and FAQs (AEO best practices), inline image strategy offloaded to client using AI tools, CheckThat integration validates prompt performance against 63 tracked keywords — emerging workflow for combining content + AI visibility tracking on client projects.

- **To CheckThat:** 63 prompts live in CheckThat workspace tracking performance on Witness AI's core keywords; data collection started this week. Witness AI moving forward with their own CheckThat workspace setup (free tier) to unblock access to shared workspace.

- **To GrowthX Business Development:** Witness AI blogging at 22 articles/month pace, mature publishing rhythm; audience includes executives (CEO, VP of Product) reviewing analytics and progress, indicating account depth and stakeholder buy-in. LLM referral traffic strategy shows product upsell potential via content linking — replicable methodology for other AI/security clients.

---

## Overview

- **Content Calendar Approved:** The 75-topic calendar is ready for review. Strategy: build baseline on core security topics (AI governance, compliance, shadow AI) before expanding to verticals with security angles. Airtable has commenting workflow; Slack automation will notify team when drafts are ready for review.
- **Performance Tracking Enhanced:** Looker dashboard now tracks all legacy content plus new GrowthX articles separately. Seven-page report includes GA4 cohort analysis, Google Search Console organic data, and LLM referral breakdown showing ChatGPT and Perplexity traffic. Dave to provide legacy URL list for complete picture.
- **Prompt Injection Article Drafted:** Rewritten deep-dive is ready for Slack review. Includes Key Takeaway bullets and FAQ section (AEO best practices). Dave will create inline diagrams using AI tool and share examples with GrowthX designer.
- **LLM Traffic Strategy Defined:** Blog gets significant LLM traffic but product pages don't. Strategy: link product pages and demo page from new, high-ranking blog content. Aida to draft CTA copy next week.
- **CheckThat Workspace Live:** 63 prompts live in shared CheckThat workspace, tracking performance on content calendar keywords. Dave to set up free workspace to unlock access to shared workspace.
...
- Schedule Looker walkthrough with Dave/Sharat/Stephanie next week, or record Loom video
- Draft CTA copy for blog posts linking to product pages and demo page; share with Dave next week
- Research bot versus human traffic tracking methods; report findings back to Dave

**Dave Abbaszadeh (Witness AI)**
- Add inline images/diagrams to new blog posts using AI tool; share examples with Aida for designer feedback
- Send legacy URL list with publish dates to Aida; Aida will update Looker to track old versus new content separately
- Review Airtable content calendar; comment/tag Aida on topics to prioritize, deprioritize, or expand
- Create Witness AI workspace in CheckThat (free tier); then access shared GrowthX workspace with 63 tracked prompts

**Sharat Ganesh (Witness AI)**
- Add blog versus Learning Center placement decision criteria to review workflow; determine per-draft placement based on educational vs. promotional intent

**Stephanie Gilliam (Witness AI)**
- Add Dan and Rick (executives) to Airtable content calendar and Google Docs for visibility into progress and metrics
...
**Aida Knezevic:** For SEO specifically, we add the key takeaway section with bullet points. LLMs pay more attention to content that appears in the introduction and toward the end. We also have a frequently asked question section with brief summaries, which is another SEO practice to help grow citations.

**Aida Knezevic:** We also use bullet points where necessary, but we really try to keep content comprehensive and helpful from a quality perspective. When we're writing content, we don't say we're writing for robots. We're writing for anybody who comes to your website, whether that's an LLM, a Google bot, or a human.
...
**Aida Knezevic:** We also analyze sources to avoid linking any report that was created by a competitor or was sponsored by a competitor.
...
**Aida Knezevic:** That was really helpful. For example, RAG security, AI fuzzing, payload splitting — these are all prompt obfuscation techniques listed in that document.
...
**Aida Knezevic:** We can also set up an Airtable automation that sends a message to Slack whenever a draft is ready for your review so you don't have to check Airtable manually.
...
**Aida Knezevic:** The URL tab contains your existing Witness AI URLs matched to specific keywords, so we want to avoid duplicate content.
...
**Aida Knezevic:** We can also drill down into the data. This is all Google Analytics data across different sources.
...
**Aida Knezevic:** It's been consistent, persistent, and focused.
...
**Aida Knezevic:** The product pages should definitely get more traffic. Once we start publishing more commercial content that compares you against competitors, we'll add links to those pages so LLMs can discover them.

**Dave Abbaszadeh:** The LLM will pick up the blog post because it's content-specific, and they'll follow the links to the product pages, surfacing those pages more often.
...
**Aida Knezevic:** I can create CTA text for your blog that links to product pages or your demo page.

**Aida Knezevic:** We can discuss how to incorporate those CTAs into your WordPress content.
...
**Dave Abbaszadeh:** It seems interesting to investigate.
...
**Dave Abbaszadeh:** I want to make sure the tracking is accurate, especially once we start publishing new content. Thanks for the context.
...
**Aida Knezevic:** It's important to get traffic and increase brand awareness, but we also want to ensure the traffic is qualified and high-quality. We're balancing both.
...
**Aida Knezevic:** Let me take this back to the team. There have been discussions about monitoring and tracking bot traffic.

**Dave Abbaszadeh:** No problem.

**Aida Knezevic:** I added you all to the CheckThat workspace with 63 prompts tracking data. They're based on the target keywords from our content calendar.

**Aida Knezevic:** We can walk through this next week, but you have an invite to this workspace in your inbox.

**Dave Abbaszadeh:** When I go to overview, it shows a setup screen instead of the data.

**Aida Knezevic:** What you need to do is set up a workspace for Witness AI. Once you do that, you'll be able to access all the workspaces you've been added to, including this one.

**Dave Abbaszadeh:** I'll continue that process.

**Aida Knezevic:** You can select the free trial tier.
...
**Aida Knezevic:** Thanks for the great work, everyone. I'll see you next week.
