...
Discuss and refine the scope of work (SOW) for a content creation partnership between Hims and fwd.digital.
...
### Proposal Adjustments and Scalability
  ...
  - Marcel will update the SOW to increase volume range and add language for content refreshes
  - Aim to provide flexibility for Hims to scale up once workflows are established
  - Considering a larger annual range instead of monthly commitments
  - fwd.digital is doubling the volume without changing the scope as an incentive

### Content Creation Process and Quality Assurance

  - fwd.digital uses complex AI workflows for research and content generation
  - Editorial review remains a significant cost driver, ensuring quality and fact-checking
  - Aim for 80% more efficient than traditional content creation methods
  - Automated QA and fact-checking capabilities to be included in the first work stream

### Cost Structure and Efficiency

  - Target cost range of 10-20 cents per word
  - Some research workflows cost a few dollars in compute alone
  - fwd.digital's approach balances cost-effectiveness with high-quality output
  - Potential for future cost reductions through model fine-tuning and workflow optimizations

### Medical Review and Compliance

  - Hims needs to determine internal capacity for medical review
  - Challenge in finding medical professionals willing to endorse content without thorough review
  - fwd.digital confident in AI capabilities for accuracy, but acknowledges need for trusted sources
  - Emphasis on setting clear standards for medical content verification

### AI Models and Technology

  - fwd.digital primarily uses GPT-4 and GPT-3.5 models
  - Not currently using or transitioning to models like Gemini
  - Focuses on building adaptable workflows to incorporate new models efficiently
...
**Marcel Santilli**
- Update proposal - ↑ volume range, add content refresh, yearly range vs monthly, ↑ flexibility for scaling. Double volume w/o changing scope. Send updated version ASAP.

**Mike Anderson**
- Connect w/ internal stakeholders next week re: updated proposal. Aim for final decision by end of next week.
