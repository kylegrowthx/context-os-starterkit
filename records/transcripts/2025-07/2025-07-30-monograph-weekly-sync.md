...
Weekly sync to discuss content strategy, updates, and improvements for Monograph's marketing efforts.
...
**Chris Morgan**
- Set up Gong access for GrowthX team (matthew@growthx.com, mariana.marins@growthx.ai, jo@growthx.com, team@growthxlabs.com)
...
**Aida Knezevic:** And there's significant, like, there's some overlap, but it gave us a good overview into, like, some of the differences between the audiences, notably how engineers.

**Aida Knezevic:** you.

**Aida Knezevic:** Thank Thank Thank

**Aida Knezevic:** Often deal with higher volumes of work than architects, so that's one thing that was a really big takeaway.
...
**Aida Knezevic:** What do you want?
...
**Matthew Panzarino:** Mariana, M-A-R-I-A-N-A dot Merin.
...
**Jo Kaminska:** I'm on the changes right now.

**Jo Kaminska:** So I just looked like checked your document, Gary, and I'll be making adjustments.

**Jo Kaminska:** yourself, some advice.

**Jo Kaminska:** And That's

**Jo Kaminska:** And also incorporating these into artifacts.
...
**Aida Knezevic:** They're building it this week for you.

**Aida Knezevic:** you.

**Aida Knezevic:** Thank And the way...

**Aida Knezevic:** That it's automated, it automatically pulls the URLs from Airtable into Looker, so we don't have to manually add the published logs to Looker, it kind of happens automatically.
...
**Aida Knezevic:** It's a tool that tracks and measures LLM visibility of different brands in LLMs like ChagiPT, Claude, Gemini, Perplexity.
...
**Aida Knezevic:** So this is internal right now.

**Aida Knezevic:** I know that the team is working on getting...

**Aida Knezevic:** I know are to take...

**Aida Knezevic:** ...

**Aida Knezevic:** Like, Scrunch integrated with Looker Dashboard, so you will have access, but right now we're going to be sharing the reports with you in our weekly syncs.
...
**Jo Kaminska:** We should have more information in the upcoming week.
...
**Chris Morgan:** It is in go into Webflow.
...
**Robert Yuen:** One, like, obviously we want to grow, but I think a lot of our prospects and customers aren't asking questions like, is the company truly built by Artiftex for Artiftex?
