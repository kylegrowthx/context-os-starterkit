...
participants: Mara Leighton, Megan, Andi Bailey, Darrell Etherington, Jakub Rudnik, Matthew Panzarino, Dave Capone, Renn, Jason Gong
...
Review GrowthX's approach to AI/LLM optimization and discuss strategies for client communication and implementation.
...
**Dave Capone:** I would like to...

**Dave Capone:** ...

**Dave Capone:** ...

**Dave Capone:** To get an engineer's take on vibe coding, because it has to be fun, right?
...
**Jason Gong:** I thought we were going do other.
...
**Jason Gong:** and she's kind of just, like, taking that instead of, like, surfacing it, you know, so just flagging that, and...
...
**Jason Gong:** Let's see, and then I have kind of a to-do for things that I want to do that like anyone can fill if you think this resource is missing, missing something.

**Jason Gong:** So I guess I'll just stop there, like what does everyone think, like is this useful, is there anything missing, do you just have general questions, Yeah, definitely thought it was...
...
**Megan:** So basically what I'm doing now is

**Megan:** Kind of going through all of them and just like, kind of doing like a mix of them.
