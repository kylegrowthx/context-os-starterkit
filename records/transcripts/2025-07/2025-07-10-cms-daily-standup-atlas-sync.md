...
participants: Oluwatimilehin Ademosu, Matthew Panzarino, Mariana Marins, Bisera Stankovska, Fatima Tahir, Simran Sethi, Ehtisham Hussain, Usman Adepoju, Martha Martins, Ismail Ajagbe, Moses, Tiandra Burns, Jessica Nicole Manificiar Gayo, Jürgen Linde, Ademilade Shodipe-dosunmu, Elvis, Sucheta, Josip Sovar, Nem Simic, Mariana, Matthew Alves-Hill, David, Carrie Chowske, Rachel Pasche, vivek@growthxlabs.com, Jess, Usman Ghani, Nika Narimanidze, Jenn Peters, Jessalynn, Feyisayo, Sydney Go, Jenny Macrohon Dabon, Deya, Saskia Wartnaby
...
Daily standup to discuss Atlas Sync workflow issues and updates.
...
**Matthew Panzarino:** So I don't know that you'll have a lot of success, to be honest, right?

**Matthew Panzarino:** Because the article generation flow, which comes at the mid-juncture of the process, is the one that the underlying prompt of that generation step is saying, basically, chill out on bullet points.

**Matthew Panzarino:** And so you're almost never going to be able to override that.

**Matthew Panzarino:** You'll have to then, you have to add it in as a polishing step.

**Nem Simic:** Okay, I guess the second part of that, too, is, and this is maybe a wider question for the rest of the team, is, has anybody had a lot of success with using that, like, Ask.ai chatbot feature, where it'll change it if you prompt it in that feature?

**Nem Simic:** Because often I'll try to tell it, like, put it in bullets or make it a table.

**Nem Simic:** And it just sometimes does, sometimes doesn't.

**Nem Simic:** I'd say, you know, more than 50% doesn't follow the instruction.

**Nem Simic:** So I'm curious if other people are running into the same issue and you and your experimentation.

**Nem Simic:** Kind of run into the same issue and trying to kind of play it.

**Matthew Panzarino:** Yeah, I'll let everybody else chime in, but as far as myself, so I've generated a couple of dozen articles over the past week for AIMBIT and used the ASCII feature probably three or four or five times on each one.

**Matthew Panzarino:** And in many cases, it was reflowing, know, bullet point reflowing.

**Matthew Panzarino:** My experience with it has been that it will reflow bullets for the most part, at least over the past week.

**Matthew Panzarino:** It's doing pretty well.

**Matthew Panzarino:** However, there are still some issues with bullet point formatting where it encapsulates the following sentence incorrectly.

**Matthew Panzarino:** So you'll have like, you know, five bullet points and then the sentence after will also be a bullet and you try to escape it out of bullets and it refuses.

**Matthew Panzarino:** So there's some formatting glitch there.

**Matthew Panzarino:** I think that is, I'm trying to remember if there's a ticket around that.

**Matthew Panzarino:** I'm almost positive there is, but I can check in on what the status is today.

**Matthew Panzarino:** I know that he jumped in and fixed the...

**Matthew Panzarino:** Or at least the bug appears to have been squashed where it will jump around when you edit.

**Matthew Panzarino:** So like when you make an edit and then it jumps to the bottom of the screen or top of the screen, you lose your place.

**Matthew Panzarino:** I think that's really annoying as an editor.

**Matthew Panzarino:** And I think he fixed that, but he continues to chew on it.

**Matthew Panzarino:** So we'll see where it goes from there.

**Matthew Panzarino:** But that's been my experience.

**Matthew Panzarino:** Bullet seed the field of lore.
...
**Matthew Panzarino:** Any other issues?

**Matthew Panzarino:** All right.

**Matthew Panzarino:** Thank you.

**Matthew Panzarino:** All I'll in a moment.

**Matthew Panzarino:** Thank

**Matthew Panzarino:** Okay, quiet morning.

**Matthew Panzarino:** All right.

**Matthew Panzarino:** I will get early.

**Matthew Panzarino:** Yeah, exactly.

**Jenn Peters:** That's fine.

**Matthew Panzarino:** But yeah, my admonition, of course, is to bring things like that to these meetings, which will happen on a weekly cadence now.

**Matthew Panzarino:** You can collect, you know, things that are nebulous that you're kind of don't really know if it's an exact bug or if it's an underlying issue, and I'll work on those.

**Matthew Panzarino:** But yeah, we're, Jason and I are kind of working pretty hard to update the prompts and get things in a better place to handle some of the bigger structural issues, like the rough structures of the articles being very similar, the bullet points being absent, things like that.

**Matthew Panzarino:** So we're cranking on that.
