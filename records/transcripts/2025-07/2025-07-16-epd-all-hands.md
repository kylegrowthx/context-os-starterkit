...
participants: Renato, Stéfano Zanata, Matthew Panzarino, Marcel Santilli, Brad Herman, Tucker Barker, George Haikal, Kirkland Gee, Clint Shryock, Gianpiero Puleo, Jason Gong, Georgemaine Lourens, Marcus Derencius, Nicolas Castellanos, Bridget McGillivray, Ben Church, Felipe Lima, Pedro Steimbruch, Kyle Gaudreau, Katia Pembayun, Daniel Lopes
...
First all-hands meeting for the Engineering, Product, and Design (EPD) team to align on company direction, share updates, and demo recent work.
...
**Brad Herman**
- Discuss w/ Kirkland re: improving prompts for TipTap AI assistant

- Demo TipTap AI features to delivery team once AI assistant + improved prompts ready


**Kirkland Gee**
- Discuss w/ Brad re: improving prompts for TipTap AI assistant


**Daniel Lopes**
- Schedule breakout room/shaping discussion next week re: AI editing features
