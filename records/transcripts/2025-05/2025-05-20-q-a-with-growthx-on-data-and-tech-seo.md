...
participants: Carmel Schetrit, Jess Scott, Branko Kral
...
Q\&A session with GrowthX on data and tech SEO for Siit.io, focusing on analytics setup, content performance, and optimization strategies.
...
- PostHog and Google Analytics 4 data need proper setup for accurate conversion tracking
- Content production and distribution should be prioritized over technical AI optimization
- Monthly reporting cadence agreed upon for more meaningful insights
- Focus on building authority through quality content and partnerships rather than solely technical SEO tactics
...
### Reporting and Decision Making
  ...
  - Branko to create a Loom video summarizing GA, PostHog, and Google Ads insights

### Travel and Personal Discussion

  - Brief chat about recent travels and sleep quality when away from home
  - Discussion on Jewish presence in Slovakia and repurposed synagogues
...
**Branko Kral**
- Investigate PostHog data for more conversion info. Record 5-10min Loom video on GA, PostHog, Google Ads data conclusions for Carmel & Jess

**Carmel Schetrit**
- Continue discussions re: Reddit visibility/investment for content distribution
