...
The GTM and Delivery leadership team reviewed pipeline health, CheckThat's early traction, content quality issues, and renewal risks. Renewals are tracking 6% below target with 50% of Q2 accounts flagged at risk. February saw a sharp drop in new deal creation due to follow-up gaps and CRM blind spots, while CheckThat has 300 signups but zero conversions from self-service.

---

## Context

This is a new recurring meeting designed to give Marcel visibility across the full customer journey — from top-of-funnel GTM through delivery quality and renewal health. It sits alongside the pipeline deep dive and focuses on cross-functional accountability between sales, marketing, delivery, and CS ops. Anna Baird joined as a venture partner and strategic advisor helping with sales hiring and team structure.
...
**To GrowthX Services:**
- February deal creation declined sharply; warm leads (Whisper Flow, others) not followed up in HubSpot
- Inbound leads arriving via email and social DMs are not being captured in CRM — Jeff (Rev Ops) is building the fix
- Events remain the strongest pipeline driver; September's event push correlated with the strongest pipeline
- Renewals at 74% healthy ARR; Prophecy and Ambit are likely churns; Udemy and Logic are at risk
- Procore acquisition creates a category saturation opportunity — adjacent accounts include Hilti and Slashwire
- Content quality is the primary publishing bottleneck; Panzer is now accountable for quality standards

**To CheckThat:**
- ~300 signups three weeks post-launch; ~10 daily new signups; zero self-service conversions
- Nigel is the sales driver: strategy sessions → two-week trial → demo call → conversion
- CheckThat not prominently featured on GrowthX website (intentional, but debated by Anna)
- Marcel is prototyping an embedded audit experience within GrowthX's platform (domain-in → insights-out)
- Marcel sees CheckThat as a service funnel entry point, not standalone product

---

## Overview

- Urgent lead follow-up needed: February saw a decline in new deals due to follow-up bottlenecks; warm leads like Whisper Flow need immediate attention
- CheckThat usage trends: launched three weeks ago, 300 signups but no conversions; sales push via Nigel's strategy calls
- Content quality as differentiator: content must align with client needs; bi-weekly editorial calibration sessions being introduced
- Current renewal risks: renewals 6% below target at 74%; 50% of accounts flagged at risk for upcoming quarters
- Operational improvements ongoing: new Rev Ops contractor (Jeff) building HubSpot and tool integration
...
February was a poor month for new deal creation. Several warm leads — including Whisper Flow — went weeks without follow-up. Tyler's bandwidth is the bottleneck; many deals stall after initial contact. The team plans to have Dig and Tyler create HubSpot opportunities retroactively for any inbound interest found in email. Marcel's EA has inbox access and can surface missed leads. Jeff (Rev Ops) will define the right deal stages for early inbound.

Marcel proposed a self-booking widget on the GrowthX website — previously drove a 50–60% win rate from single meetings but was disabled. Five inbound bookings per week still arrive via other channels.

### CheckThat Product and Conversion Strategy

CheckThat launched roughly three weeks ago with ~300 signups and ~10 daily new signups. No conversions from self-service yet. Nigel's strategy sessions are the primary conversion path: demo call → two-week trial → decision. Marcel also books some meetings separately.

Anna raised that CheckThat is difficult to find on the GrowthX website. Marcel's rationale: don't distract services-focused visitors. Anna's counterpoint: it should be a top-of-funnel lead generator with a clear path back to services. Marcel is prototyping an embedded presentation layer — enter a domain, get AEO audit insights without leaving GrowthX's environment. Strategy sessions currently validate the experience manually before any technical build-out.

### Content Quality and Editorial Challenges

A recent deep quality review surfaced disconnects between content output and client audience expectations. Sophisticated B2B audiences are receiving content that feels generic or off-target. William is fast-tracking EM hiring and onboarding. Bi-weekly calibration sessions between William, Sydney, Jen, and Panzer will be the editorial governance mechanism. Two "leads editor" roles are introduced to ensure cross-account consistency.

Marcel's framing: effectiveness (quality) before efficiency, even at a cost to margins. Publishing delays are mostly quality-related — not operational — and that accountability now sits with Panzer.

### Renewals and Client Health

Renewals are 6% below target at 74% for the quarter. Several contracts are out for signature (Airbyte, Abnormal, In a Rows). Q2 looks riskier: roughly 50% of accounts are red or at risk. Prophecy and Ambit are likely churns (CEO disengaged; technical mismatch). Udemy's restructuring is disrupting contacts. Logic faces a pipeline/go-to-market mismatch with small contracts.

Marcel's category saturation play: own all the accounts in a segment. Procore's recent acquisition of a B2B SaaS company opens adjacent budget — Hilti and Slashwire are named targets.

Healthy ARR currently at 72.25%. Leah is building combined Sheets + HubSpot tracking. Weekly ARR health tracking is recommended as the north star metric.

### Operational Visibility and Process Improvements

Jeff (Rev Ops) started February 5. He's building HubSpot syncs and a Linear board to manage incoming requests. First pipeline activity reports are just emerging. Jason is cleaning up the marketing calendar and funnel strategy for visibility. The team will document MQL volumes and lead sources to help Anna and others understand funnel health.
...
**William Leborgne:** Either that or I was having a very blonde moment.

**William Leborgne:** All right, let's go ahead and get started.

**William Leborgne:** I know some of these are converted, but I just want to check in on.

**William Leborgne:** On some of them.

**William Leborgne:** Cresta, Brex, Navon, Turnstile.

**William Leborgne:** Is Black Soul in here as well as Blackstone?

**William Leborgne:** Still over here.

**William Leborgne:** Okay, so just checking in on.

**William Leborgne:** On these with, like, the transition.
...
**William Leborgne:** Actually this is a great call out.

**William Leborgne:** Because I just met with Leah earlier and we are, I think I mentioned this to the whole group last week, but we're trying to make some improvements to the Sprint and one of the.

**William Leborgne:** Core ones that I'm pushing very hard.

**William Leborgne:** On is project management.

**William Leborgne:** So we're going to move away from this little kanban and we're going to.

**William Leborgne:** Have our own notion space which will.

**William Leborgne:** These meetings are going to change in the sense that we're going to open up each client and each Client will have a health score, meaning that once a week the EM will have to fill that out as well as a structured piece on you know, what's action items, blockers but also specifically what is the relationship health.

**William Leborgne:** And we're going to have this structured.

**William Leborgne:** In such a way that I think is going to work a little bit.

**William Leborgne:** Better and then underneath that we're going.

**William Leborgne:** To have the actual sort of micro.

**William Leborgne:** Combine of all the tasks that are happening.

**William Leborgne:** So we'll also be able to see.

**William Leborgne:** What'S pending that should have been done that week that hasn't been done.

**William Leborgne:** So all that should be coming hopefully next week, maybe by the end of next week.

**William Leborgne:** We just need to implement it and test it, make sure it works really well.

**William Leborgne:** But that will really help a lot with, with that piece.
...
**William Leborgne:** All right, no worries.

**William Leborgne:** So just checking in on these other ones.

**William Leborgne:** Cresta, Brex, Navon and Turnstile.
...
**William Leborgne:** Great, well, I'll just bring up then Turnstile.

**William Leborgne:** I spoke with Carly, she's going to be jumping on the call next week and.

**William Leborgne:** And then I'm going to stay on.

**William Leborgne:** The client would really prefer that I stand for a couple more weeks since this transition and this client is definitely in the yellow.

**William Leborgne:** The good news is we have gotten.

**William Leborgne:** Some really good results.

**William Leborgne:** The bad news is that they're not happy with the content quality yet.

**William Leborgne:** So we're going to have some conversations.

**William Leborgne:** About that today and figure out what we can do to move forward.

**William Leborgne:** But yeah, as I said, we.

**William Leborgne:** There they are, growing in keywords, growing in traffic, and also even growing in domain authority.
...
**William Leborgne:** If we tried to be a bit more concrete about when that trigger is.

**William Leborgne:** Because I hear what you're saying, and.

**William Leborgne:** I agree that we should wait until like, the perfect opportune time, but can we maybe add some color to that?

**William Leborgne:** Like, what is that opportune time?
...
**William Leborgne:** Hypothetically, would that be in, like.

**William Leborgne:** I mean, how.

**William Leborgne:** This sounds like a lot of work.

**William Leborgne:** Is this.
...
**William Leborgne:** Good news there is.

**William Leborgne:** We are publishing and we're moving things forward.

**William Leborgne:** We are.

**William Leborgne:** Hasan, correct me if I'm wrong, but.

**William Leborgne:** I think you're publishing either today or tomorrow.
...
**William Leborgne:** Incredible early signals.

**William Leborgne:** I've never seen such fast signals before.

**William Leborgne:** Like, day two, after it getting published, we were already ranking, like, in the top 10 for a bunch of keywords, which is amazing.

**William Leborgne:** So that was really good to see.

**William Leborgne:** The client was interested in getting LLM visibility as well.

**William Leborgne:** So we kind of discussed how there's.

**William Leborgne:** Going to be a little bit of more of a delay with that.

**William Leborgne:** But that pushes us to make sure.

**William Leborgne:** That they're fully set up in check.

**William Leborgne:** That.

**William Leborgne:** Unfortunately this client is on vacation again and we'll be gone is gone now all the way till the 20th, which is.
...
**William Leborgne:** So basically, yeah, basically all of next week.

**William Leborgne:** So we're going to get behind again on editing and then we'll have to catch up again the following week.

**William Leborgne:** The good news is that when now she is actually moving things forward when we give her stuff and is editing it like fairly quickly.

**William Leborgne:** The issue before is that we're getting nothing at all.

**William Leborgne:** So at least we're moving forward.

**William Leborgne:** And again, like, from a client health.

**William Leborgne:** Perspective, I would say this client is quite healthy.

**William Leborgne:** They're happy with how we're working.

**William Leborgne:** They're happy with the content quality.

**William Leborgne:** They've also shared it with the general partners.

**William Leborgne:** So it's not just this one stakeholder.

**William Leborgne:** But other general partners are reviewing the content.

**William Leborgne:** So that's also good for visibility.
...
**William Leborgne:** Staging three articles today?

**William Leborgne:** Yes, correct.
...
**William Leborgne:** Just to gut check this, are we a little bit behind in terms of publishing?

**William Leborgne:** Because we would have been ramping up in week with three.

**William Leborgne:** It would have been three articles in week four.
...
**William Leborgne:** Piggybacking off that.

**William Leborgne:** Something else that I think is important is what he wrote here.

**William Leborgne:** Come up with prompts.

**William Leborgne:** This is something I've now dealt with two different clients.

**William Leborgne:** And Ada was very helpful in giving me, like, direction on how she pulls prompts.

**William Leborgne:** But I think this is something that.

**William Leborgne:** We also need to formalize and create.

**William Leborgne:** A structure around, like, a repeatable system.

**William Leborgne:** That'S very, you know, 1, 2, 3, 4.

**William Leborgne:** Specifically for.

**William Leborgne:** For clients that are saying.

**William Leborgne:** Because again and again, I've had this, this moment where I ask the client.

**William Leborgne:** Do you have prompts?

**William Leborgne:** Do you have things that you want to be tracking?

**William Leborgne:** And they kind of shrug.

**William Leborgne:** And so I'm like, do you want me to come up with some?

**William Leborgne:** And then you, you review them and then we'll go add them.

**William Leborgne:** And that's typically the direction that I'm.

**William Leborgne:** I'm seeing it go.
...
**William Leborgne:** That we should just create the prompts.

**William Leborgne:** And throw them in there.

**William Leborgne:** I think we should give them the.

**William Leborgne:** Prompts and say these are the prompts that we are going to use.

**William Leborgne:** If they don't respond, fine.

**William Leborgne:** But I think a lot of times.

**William Leborgne:** You are going to.

**William Leborgne:** It's going to be a little bit off or it'll.

**William Leborgne:** Or it'll spark something in their mind of like hey, actually I want to include this.
...
**William Leborgne:** Okay, well I'll, I'll put that as a to do is just start to.

**William Leborgne:** Come up with like an SOP and.

**William Leborgne:** A structure on how we cover prompts and check that.

**William Leborgne:** And then.

**William Leborgne:** Yeah.

**William Leborgne:** Waiting for you Ella, at some point.

**William Leborgne:** On like what our talking points are for.

**William Leborgne:** Check that.

**William Leborgne:** Cool.

**William Leborgne:** Jumping back to.
...
**William Leborgne:** And then the five additional drafts, Ade, are those on track to get done?
...
**Ademilade Shodipe-Dosunmu:** Yeah, soundtrack should have those with Sydney later today.
...
**Sydney Arin Go:** They're publishing.

**Sydney Arin Go:** The CMS is a bit slow on adding internal links.

**Sydney Arin Go:** We've not been adding a ton of internal links to their content, which might affect performance down the line.

**Sydney Arin Go:** I don't think there's anything we can do about it because it's their own CMS problem.

**Sydney Arin Go:** Anytime you internal link, you have to look up the actual blog post.

**Sydney Arin Go:** And Ade, correct me if I'm wrong because it's in so many different languages.

**Sydney Arin Go:** So you have to link it manually.

**Sydney Arin Go:** Each and every link.

**Ademilade Shodipe-Dosunmu:** Yeah, you have to like the actual name of the article and sometimes like the names don't come up.

**Ademilade Shodipe-Dosunmu:** So like you're scrolling through like tens of pages to find the exact.

**Ademilade Shodipe-Dosunmu:** Yeah, it just makes staging like a pain.

**Ademilade Shodipe-Dosunmu:** And we do have automated publishing, but like that doesn't get automated.

**Ademilade Shodipe-Dosunmu:** So it's like the hard part isn't getting automated, but like the easy part of like pasting the content in there is getting automated.

**Ademilade Shodipe-Dosunmu:** So yeah, that's a big blocker.
...
**William Leborgne:** Parloa Dora and her team are out, but they, they're very happy with the calibration article.

**William Leborgne:** So did someone talk okay.

**William Leborgne:** The approval?

**William Leborgne:** Yeah, so I, I just, I just sent something in Slack about this.

**William Leborgne:** I think because we're not getting immediate responses from them, we can just pull an article directly from the content strategy.

**William Leborgne:** So that's what I've done.

**William Leborgne:** I think Natalie now has the article that we're going to move forward with.

**William Leborgne:** I think broadly speaking.

**William Leborgne:** By the way, if there's ever a blocker like this for this at this stage, let's just.

**William Leborgne:** We don't have to wait on the.

**William Leborgne:** Client to finalize the topic.

**William Leborgne:** Let's just pull it from the content.

**William Leborgne:** Strategy and move that thing forward.

**William Leborgne:** Yeah.

**William Leborgne:** Other than that, the client is.

**William Leborgne:** This is green.

**William Leborgne:** They're happy with the strategic support that we're providing them.

**William Leborgne:** I think the content quality is hitting the mark, broadly speaking.

**William Leborgne:** I think this is all on the green.

**William Leborgne:** Talon1.

**William Leborgne:** So we got the final okay on.

**William Leborgne:** The calibration this morning from the decision maker.

**William Leborgne:** So that's great.

**William Leborgne:** We can go ahead and move forward with the rest.

**William Leborgne:** Client is this is kind of quite a demanding client.

**William Leborgne:** They're asking for support on forecasting organic growth.

**William Leborgne:** I did that last week.

**William Leborgne:** Well, last week and earlier this week.

**William Leborgne:** And then they want to test out.

**William Leborgne:** Comparison articles and they also want us to research new topics that are not within the clusters.

**William Leborgne:** So this is just additional work that's, that's kind of like getting slotted on to this client.

**William Leborgne:** And aside from that, we're just waiting.

**William Leborgne:** On the blog cover image.

**William Leborgne:** I think we are.

**William Leborgne:** The ticket is in.

**William Leborgne:** I don't know what the status of it is.

**Ademilade Shodipe-Dosunmu:** We had the tickets in.

**Ademilade Shodipe-Dosunmu:** Katja said she was going to be working on it today.

**Ademilade Shodipe-Dosunmu:** So we should on that later today and should have something to send them to tomorrow.

**Ademilade Shodipe-Dosunmu:** I would also stage that calibration blog later today or tomorrow.

**William Leborgne:** Okay, great.

**Ademilade Shodipe-Dosunmu:** So you can just let them know as well.

**Ademilade Shodipe-Dosunmu:** For the competitor pipeline, it's been set up.

**Ademilade Shodipe-Dosunmu:** We set that up preemptively, actually, because they sent us back cars ahead of time.

**Ademilade Shodipe-Dosunmu:** So I think that was set up last week.

**Ademilade Shodipe-Dosunmu:** Testing it a bit this week.

**Ademilade Shodipe-Dosunmu:** But I wouldn't do a competitive blog till next week just based off of like what we already have lined up.

**Ademilade Shodipe-Dosunmu:** Yeah.

**Ademilade Shodipe-Dosunmu:** Then regarding like the new topics, that's like building out the competitive cluster.

**Ademilade Shodipe-Dosunmu:** I asked a question in the channel.

**Ademilade Shodipe-Dosunmu:** I can work on that probably the week after next week.

**Ademilade Shodipe-Dosunmu:** I would choose like a blog to start off with, but like, because like I'm out next week, Thursday and Friday and we'll be back like the next Tuesday.

**Ademilade Shodipe-Dosunmu:** I think just dividing my workload better to, you know, add those topics when I'm like, back.

**Ademilade Shodipe-Dosunmu:** I don't know what you think, though.

**Ademilade Shodipe-Dosunmu:** Just trying to prioritize that content production and like the existing content calendar already had some competitive content and they've already flagged some of them as like high priority or medium priority.

**Ademilade Shodipe-Dosunmu:** So I'll just mess around with that for the competitive blog next week so.

**William Leborgne:** That they have something that's perfectly fine.

**William Leborgne:** I don't think there was pressure to do it immediately.

**William Leborgne:** I had said like in a couple of weeks and they said that was fine.

**William Leborgne:** So I think let's just move forward.

**William Leborgne:** As soon, as soon as you have the bandwidth, let's go ahead and do the competitive piece.

**Ademilade Shodipe-Dosunmu:** Okay.

**William Leborgne:** Okay, great.

**William Leborgne:** All right, that's Talon one.

**William Leborgne:** I would say Talon one is also in the green.

**William Leborgne:** I don't see any issues with them.

**William Leborgne:** Okay.

**William Leborgne:** Tavis?
...
**William Leborgne:** So that'll give me an opportunity to walk them through it.

**William Leborgne:** Broadly speaking, they're happy with the movement that we're doing.

**William Leborgne:** They had some feedback on the content strategy last week, but I think it.

**William Leborgne:** Was all very positive.

**William Leborgne:** This is an interesting client because it's.

**William Leborgne:** Super new technology and their topics are new topics that people are not always necessarily searching for, but I think it gives us a lot of opportunity to own the space.

**William Leborgne:** This client is also green.
...
**William Leborgne:** Right field wire.

**William Leborgne:** I built out the content strategy yesterday.

**William Leborgne:** I just need to do a final review today and then prep it.

**William Leborgne:** I will be presenting that tomorrow.

**William Leborgne:** Broadly speaking, they're, they're green.

**William Leborgne:** All right.

**William Leborgne:** Last is the kickoff this week.

**William Leborgne:** I don't, I don't know if you.

**William Leborgne:** Have anything you want to share on Elementum.

**William Leborgne:** Broadly speaking, on my end, Spendesk went well.
...
**William Leborgne:** This this bit about it, like creating content for the sales team, I think.

**William Leborgne:** Is, is really important because I think.

**William Leborgne:** It can change a little bit of.

**William Leborgne:** The nature of the content itself.

**William Leborgne:** That's, that's really interesting.

**William Leborgne:** On the Spendesk, the one thing I'll.

**William Leborgne:** Just mention is this is an interesting client where they want multilingual.

**William Leborgne:** In fact, it's, it's a requirement.

**William Leborgne:** They are in Germany, France, the uk.

**William Leborgne:** I think, a couple of other markets.

**William Leborgne:** But those are the three main languages and so I set expectations very clearly within that.

**William Leborgne:** In phase one in the Sprint, we're not going to be doing all of those languages.

**William Leborgne:** However, we will explore doing at least.

**William Leborgne:** One to two articles in French.

**William Leborgne:** So I'm going to be reaching out to an old contact of mine who's a, an editor for French content, a.

**William Leborgne:** Native French speaker, which will have to coordinate ife.

**William Leborgne:** This is something you and I can.

**William Leborgne:** Discuss, you know, at a later, later stage, but that's not the priority.

**William Leborgne:** The priority is still to do our, our system to build the foundation in English and obviously focus on the UK market.

**William Leborgne:** So just something to keep in mind is in all of the artifacts and the structures and especially the writing guidelines, it needs to be UK English, not American English.
...
**William Leborgne:** All right, well, we'll have more for, for you guys probably in a couple days on the project management stuff.

**William Leborgne:** I'll send over a loom with some clarifying instructions on what it's going to look like.
