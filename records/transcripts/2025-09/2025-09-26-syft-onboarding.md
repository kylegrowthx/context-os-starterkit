...
participants: Imran Patel, Kyle Doherty, Claudia Ring, Jason Gong
...
Onboard GrowthX team to Syft data platform and explore potential use cases.
...
**Jason Gong**
- Play around with SIFT tool, focusing on motions related to upcoming webinar


**Imran Patel**
- Send calendar invite for follow-up meeting Wed 4pm


**Kyle Doherty**
- Review SIFT integration, prepare any questions for follow-up meeting
...
**Imran Patel:** Yeah, mean, LinkedIn cracks down on scraping depending on what you're scraping.
...
**Imran Patel:** And the way we do it is also somewhat like we only do it through your browser.

**Imran Patel:** Like we don't even involve our
...
**Imran Patel:** It will show you the light.

**Imran Patel:** comments, engagers, and so you'll see, like, which, like, just in general, what your audience looks like across, across those posts, right?
...
**Imran Patel:** You can choose the metric on the, on the second hand, like you say, where it says showing post engagers on the right-hand side in the, where the dimensions are, not on this dropdown, but, right there.

**Imran Patel:** Yeah, just go where it says all dimensions on the top.

**Imran Patel:** There, and then next to it, they're showing post engager.

**Imran Patel:** So you can choose the metric that you want, and then it will slice it, slice that metric, by the way.
...
**Imran Patel:** Yeah, it's just, like, it's a background activity and Chrome extension.
...
**Imran Patel:** Yeah, so then it go in an inactive mode, but generally almost everybody is on LinkedIn.
...
**Jason Gong:** You don't need the tab open.

**Jason Gong:** I'm just curious what it's doing.

**Jason Gong:** Because I guess like it is scary, like when I log in to HeyGen a little bit and I give them access, you know, I give them like literally my password or something.

**Jason Gong:** the HeyReach.

**Jason Gong:** Or sorry, HeyReach.

**Jason Gong:** Yeah, HeyReach.

**Jason Gong:** No, so unlike, I don't know how they do that.
...
**Imran Patel:** One other thing that the extension will do is also when you send a growthx link in LinkedIn or Gmail, it will rewrite the link to include some tokens at the back to add tracking.

**Imran Patel:** So when somebody clicks on that link and then they come to your website, you will know who came to your website.

**Imran Patel:** very useful.

**Imran Patel:** Oh, like, only growthx links?

**Jason Gong:** Yeah, only growthx links, yeah.

**Imran Patel:** Yeah.

**Imran Patel:** It's, like, for example, I, like, send a link to this.

**Jason Gong:** Like, it's not...

**Jason Gong:** because our tag doesn't run on Luma, so we can't make the connection.
...
**Jason Gong:** Basically like everything I'm thinking of doing revolves around this next webinar, so I'll probably next week like the...

**Jason Gong:** playing around in this quite a bit, maybe, yeah, late Wednesday or the Monday after.
...
**Jason Gong:** See that's good.

**Jason Gong:** Make some run.
