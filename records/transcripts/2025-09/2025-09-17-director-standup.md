...
participants: Mara Leighton, Megan Dickey, Andi Bailey, Jakub Rudnik, Jason Gong, Kyle Gaudreau, Matthew Panzarino
...
Discuss scaling challenges and potential solutions for the director role as GrowthX expands its client base and ME team.
...
**Andi Bailey**
- Research CS tooling, sentiment analysis tools, client mgmt software (e.g. HubSpot, HockeyStack). Focus on options for tracking customer sentiment across calls/interactions.
...
**Mara Leighton:** So, goоф, goippen Follow-up,-up, follow-up.

**Mara Leighton:** Follow-up.
