...
participants: Cole Parker, Kali Wootton, Team GrowthX, Rory Conroy, Carrie Chowske, George Haikal, Darrell Etherington, Feyisayo, James Winter, Joel Murphy, Colm Shalvey, Kyle Gaudreau
...
Weekly sync to discuss Engine's content strategy, performance, and potential new initiatives.
...
- Set up quick Amplitude data review session w/ Kyle


**Kyle Gaudreau**
- Follow up w/ team on FAQ schema impl; validate HTML markup w/ data attributes approach

- Explore PSEO opps w/ team; analyze 4k-7k unpublished pages, develop indexing strategy

- Discuss Roomblocks SOW w/ Marcel; prep for potential mtg w/ Engine team, focus on flexibility/pricing


**Cole Parker**
- Schedule 15min sync w/ Joel, James, Colin re Roomblocks SOW
