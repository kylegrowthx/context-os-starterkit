...
participants: Richa Mehta, Daniel Lopes, Felipe, Bobowb, Natasha, Marcel Santilli, Bo Wang
...
Technical deep-dive on GrowthX's AI-powered content marketing platform and service offering.
...
- Continue scaling operations to support 5x customer growth over next few years
- Develop and launch marketplace for specialized content tasks
- Explore potential for open-sourcing parts of the framework or offering self-serve options
- Focus on improving workflow automation and reducing need for human intervention while maintaining quality
...
**Marcel Santilli:** So a quick background on me, I've been a CMO and growth leader for a

**Marcel Santilli:** For a little while at a couple of different companies like HashiCorp, ServiceTitan, ScaleAI, and a few others.
...
**Marcel Santilli:** And that building workflows was really freaking hard.

**Marcel Santilli:** And so...

**Marcel Santilli:** He started as services software for growth and mostly focused starting on content.
...
**Daniel Lopes:** I was building like a lot of these workflows that were very...

**Daniel Lopes:** Very to what we were doing, very similar to what we actually prototyped inside of IFTTT, but when we tested with, like, our 10 million user base, only, like, a tiny fraction actually engaged with that, and IFTTT's goal was to be mainstream instead of being, like, specific to businesses, to be, like, consumer-focused.
...
**Daniel Lopes:** All the small things that there's, like, last mile that LLMs couldn't do, actually, like, a year and a half ago, wasn't that last mile.

**Daniel Lopes:** It would like, it would do 70% and the other 30% of total crap.
...
**Daniel Lopes:** So we ended up building like, tapping on top of a bunch of open source stuff we have today, but very similar to the premises we did at IFTTT, and I can, so I was thinking like how I could explain this whole thing, and like was putting slides together yesterday, and like the best thing I could come up with is just like walk you all through the same onboarding process that we go with the engineering team when they join, and I can walk you through the area, so we have like a high level first, and then like the, so we okay.

**Daniel Lopes:** In the normal flow, it would be like second session with just like pair on buildings and workflows together and stuff like that.
...
**Daniel Lopes:** But when we actually start doing it professionally, like you hit all this like problems that like consistency, accuracy, tone, all these things are pretty hard to get out of the lens to behave well.

**Daniel Lopes:** And like at the same time,

**Daniel Lopes:** So you're to have people that will try to do internally, and then they'll be happy to buy from somebody afterwards.
...
**Daniel Lopes:** So we have, like, a team of 15 people today that we hired in just three months, and they're doing great.

**Daniel Lopes:** But essentially, the main thing that we're thinking is that, like, a year ago, and Marcelo and I were discussing,

**Daniel Lopes:** What are we going to do?

**Daniel Lopes:** Are we going to keep this input strapped?

**Daniel Lopes:** Are we going to do something in different space?

**Daniel Lopes:** Is the content the right place to be doing things?

**Daniel Lopes:** But the main thing was always like LLMs are essentially like these small reasoning units that you can mix with different kinds of software and you can get very natural language kind of input and get outputs that are pretty close to what somebody would do.

**Daniel Lopes:** So like if you have like small reasoning units like this and you can do a lot of automations like we were doing at my EFT days, but you have humans for the part that is a critical judgment or for training for the next loops and you build the UI that's specific to that task, but keep that as fast as possible.

**Daniel Lopes:** So that the UI for that specific task is not the core.

**Daniel Lopes:** The core is what is under the hood.

**Daniel Lopes:** That surface layer is just to make sure people can use this new kind of user interface in the best way possible for the process.

**Daniel Lopes:** Then you can probably get to the experience.

**Daniel Lopes:** That us programmers are getting, where you can just open like a cloud code and you can like now do like a lot of things that would take many days.

**Daniel Lopes:** And then one person can be super, super productive.
...
**Daniel Lopes:** So like, if you have like 10 million users, Canopy, the Basecamp spinoff, we have like 60,000 active users.

**Daniel Lopes:** Like every, every couple of thousands of users you add is just like that, that group of folks.

**Daniel Lopes:** You never use your new features.

**Daniel Lopes:** And what's happening with LLMs is just changing so fast that even like the UI or like whatever, the way you organize things, you have to shift in like almost on a weekly basis sometimes.

**Daniel Lopes:** And just doing out like self-serving products is just going to move too slow.

**Daniel Lopes:** So that was like one thing, having our own team, having our own users and paying our own users to use our own product is a great way to get them trained all the time.

**Daniel Lopes:** But then you have the problems like peer service just doesn't scale.

**Daniel Lopes:** And then like, can we figure out a way to scale?

**Daniel Lopes:** Can we decompose the parts that are less high leverage and figure out how to train the folks that are high leverage faster?

**Daniel Lopes:** So that I think is the component that the two things combined could work.
...
**Marcel Santilli:** But let me zoom out here.

**Marcel Santilli:** Super quick just to maybe...

**Marcel Santilli:** One thing that, I just took a quick screenshot here, if it's okay, I can spend like 60 seconds on just like framing before you go into services software, really quickly on services software, or the way you kind of approach it as well.

**Daniel Lopes:** I think we're going to touch that myself, because like we only have 30 minutes, so we have a lot to cover.

**Daniel Lopes:** Yeah, I think we're going to get to that.

**Daniel Lopes:** I think I have actually examples of that, that have like fun tuning examples coming out of the workflows and everything.

**Daniel Lopes:** Yeah, but essentially, what we're thinking is like, we're going to have like a bunch of vertical interfaces.
...
**Daniel Lopes:** we have this internal tool called Atlas.Perofax.ai.

**Daniel Lopes:** It has...

**Daniel Lopes:** It has insights and analytics.

**Daniel Lopes:** It has a knowledge base.

**Daniel Lopes:** The knowledge base, have a Neo4j graph reg.

**Daniel Lopes:** We started with graph reg, but it's too slow.

**Daniel Lopes:** So we ended up switching to light reg, which is like variation of it.

**Daniel Lopes:** And so it's a graph database tied with a reg.
...
**Daniel Lopes:** So there's usually acceptable, great, or bad, but it would do it in grading just to...

**Daniel Lopes:** Just to help us see internally, but we will unlock a certain amount of iterations here.
...
**Marcel Santilli:** So having everything here, like an editor, a context-aware assistant, as well as an execution layer that is based on the code that can run massive executions with tool calling and knowledge retrieval, it allows us to...

**Daniel Lopes:** To learn from the whole interaction as well.

**Daniel Lopes:** Yeah.

**Daniel Lopes:** So just to show you like the final pipeline here, essentially, the last thing we do is like effect checker, for example, we have a bunch of workflows, have like about 200 that we can stitch together or create customers.

**Daniel Lopes:** So this one would just like split the article chunks and then research the statements again, and it would extract passages like small passages and then verify them when they have the passages, this is the reason why I wanted to extract.

**Daniel Lopes:** The questions it should be searched and the confidence, like it thinks it's false, and then it will suggest a rewrite, and sometimes it's very nuanced.

**Daniel Lopes:** And the one thing that we learned is like if we search something with Excel or tabular perplexity, you should invert that and do the fact check with another one, so you get like a little bit of more validation.
...
**Daniel Lopes:** And then it will suggest suggest that we...

**Daniel Lopes:** Right?

**Daniel Lopes:** So that's what the forward deploy folks would do.
...
**Daniel Lopes:** No, not really.

**Daniel Lopes:** like the, Marcel, you can cover that if you want, but the before deploy, essentially to do, before deploy with engineers, is maybe like a day or two at most, on the harder spectrum of complexity.

**Daniel Lopes:** We will often do like, combine a bunch of complaints or challenges, and that might be a project that might take

**Daniel Lopes:** Like a week or two for them to adjust, create a new workflow, create a new version of the agents and validate.
...
**Marcel Santilli:** Then there's process architecture, right?

**Marcel Santilli:** Like you're shaping the process, like our chief content officer ran TechCrunch for 10 years.

**Marcel Santilli:** There's a lot of processes in his mind.

**Marcel Santilli:** do you're like I'm that...

**Marcel Santilli:** That are like really, really, they're not like an average person you get out of the street, right?
...
**Daniel Lopes:** So like we see a bunch of opportunities where we could do the ecosystem, or extract products out of the internet.

**Daniel Lopes:** So like, it's going to be like it's

**Daniel Lopes:** Actually, I think folks would be like, if they don't want us to run for them, then it might be like the cost of one employee performing for a thousand, for a hundred people, let's say.

**Daniel Lopes:** But if they don't run themselves, maybe we're going to have a cheaper self-serving product for agencies if we find the common denominator for everybody.
