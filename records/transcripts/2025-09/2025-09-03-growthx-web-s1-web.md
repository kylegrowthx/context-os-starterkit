...
**Joery Van Druten:** So to get access to ContentStack, you need Okta. We processed one person. I think only Sydney has access currently. I sent over four names: Sydney, Marisol, Nicolas, and Salomon. But I think only Sydney got approved.

**Nicolas Castellanos:** Okay.

**Joery Van Druten:** So Nicolas, where are you located?

**Nicolas Castellanos:** In Uruguay, South America — next to Argentina.

**Joery Van Druten:** Let me quickly see if that's going to be an issue.

**Nicolas Castellanos:** I can use our VPN if that's a problem.

**Joery Van Druten:** Oh, no, that is a problem. I don't make the rules. Trust me, Ankit and I are always saying, really? More red tape? But I saw that Uruguay is on the approved list, so that shouldn't be a problem. I can kick that off today. But you'll need a SentinelOne email, and that's going to take one to two weeks. In the meanwhile, let's get Sydney set up first since she already has an email. She should have gotten an email notification from IT a couple of weeks ago. You'll need to dial in with VDI, then go through Okta — it's not going to be ideal, it's going to be super slow. But that's out of Ankit and my control.

**Aida Knezevic:** Okay. I'll let her know she should have access. I'll double check with her and make sure nothing ended up in spam.

**Joery Van Druten:** She's in Vancouver, Canada, right?

**Aida Knezevic:** Yes.

**Joery Van Druten:** Then she should be fine. We couldn't get Chile approved, but Uruguay is on the list, so that's not a problem.
# GrowthX Web <> S1 Web
