...
participants: Michael Gulmann, Jason Flateboe, Erik O'Brien
...
Product deep dive into Otto, an AI-powered travel booking assistant for business travelers.
...
**Jason Flateboe**
- Send 5 one-time Otto beta access codes to Erik, mark as used
...
**Michael Gulmann:** why don't I – one of the things I like to do is analyze questions people ask to try to figure out conceptions, preconceptions.

**Michael Gulmann:** And so, Erik, by your question, I'm guessing you're thinking that it's mainly an app.

**Michael Gulmann:** And that's why I want to share is that auto in general, we think of it just as the best ever executive assistant to help you book your travel.
...
**Michael Gulmann:** And so what we designed auto to be is completely independent of the form factor or the mechanism by which to talk to auto.
...
**Michael Gulmann:** You can email auto, you know, in the very near future.
...
**Michael Gulmann:** You can Slack auto and ask auto questions.

**Michael Gulmann:** You can use Teams to contact auto.

**Michael Gulmann:** You can send auto an SMS or a WhatsApp or an iMessage.

**Michael Gulmann:** And then at some point in the future, you know, you pick up the phone and you call auto and you can talk to auto.

**Michael Gulmann:** And so think of it more as auto is a conversational agent that helps you book your travel.
...
**Michael Gulmann:** It's, know, it's kind of, you know, anywhere from anywhere.
...
**Jason Flateboe:** And then when they land, obviously I am a user who already has used auto, so you would not see this.

**Jason Flateboe:** But very quickly, we kind of talked through this.

**Jason Flateboe:** What auto does when you get on is it's learning very quickly about your home airport, your preferences in terms of brands for both flights, hotels, what times you like to travel.

**Jason Flateboe:** We've kind of gone through all that stuff, but right away, you can start interacting with auto to start planning a trip.
...
**Michael Gulmann:** And so auto will do the same thing.
...
**Michael Gulmann:** And the great thing is we haven't set up a, you know, kind of a, your typical key variable type of a thing where here are the 10 things that auto learns.
...
**Michael Gulmann:** He very excitedly told me that he was like, yeah, you know, I know I've used auto to go to Philadelphia three times.
...
**Michael Gulmann:** And that's that level of personalization where your auto by itself starts narrowing in and finding that particular hotel because it knows.
...
**Jason Flateboe:** And you can actually, this is made up, but there's actually a place where you can go interact with the auto and tell it, you know, like I said, copy, paste your travel policy.
...
**Michael Gulmann:** You say, you know, auto will tell you, that's going to cost an extra $79.

**Michael Gulmann:** say, great, add that in, and auto will handle all those things.
...
**Michael Gulmann:** With auto, you can just go to auto and say, hey, I'm not going to be able to make my flight back.
...
**Michael Gulmann:** And now with auto, you can just ask auto, and they'll handle things for you.
...
**Michael Gulmann:** Yeah, so here's an example of just kind of, you know, auto knowing more than even a human, if you call him, talk to travel agent.
...
**Michael Gulmann:** Um, day of, if you're already checked into your flight, then the airline has taken control of your ticket, which means auto, neither auto nor any travel agency can actually touch that.

**Michael Gulmann:** Um, in which case, you know, auto will spit you out and say, Hey, you need to call this number, uh, so someone can get ahold of the airline.

**Michael Gulmann:** Right.

**Michael Gulmann:** So we have not yet built auto to be able to make a phone call to the airline.

**Michael Gulmann:** Um, and so we'll spit it out for human, um, human kind of takeover in that case.

**Michael Gulmann:** Um, but what auto could do in that case as well is say, Hey, your, your, your flight's going to be severely delayed.
...
**Michael Gulmann:** If you notice, with auto, there is no specific flow.
...
**Michael Gulmann:** But if I was, you know, building out keywords and building out stories, it's how does auto compare against Concur?

**Michael Gulmann:** How does auto compare against Navon trip actions?

**Michael Gulmann:** How does auto compare against Amex GBT?
...
**Michael Gulmann:** That's a guide and a helpful thing for the users of auto.
...
**Jason Flateboe:** best go go Yeah.
