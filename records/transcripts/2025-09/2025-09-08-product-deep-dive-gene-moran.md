...
participants: Gene, Erik O'Brien
...
Product deep dive on hyperexponential's insurance technology platform, focusing on HX Renew, submission triage, and portfolio intelligence capabilities.
...
- GrowthX to use information to update content artifacts for hyperexponential
- Potential follow-up deep dive with solutions engineers if more detailed product information is needed
- Gene available to assist with any questions about system integrations
...
**Gene:** Usually as well within the demo, there's like, think That's Of I
...
**Gene:** So we're going to fill out certain things here.

**Gene:** figure it

**Gene:** Like a percentage of the type of work that they do.
...
**Gene:** Some people use like a workbench for that capability.

**Gene:** workbench?

**Gene:** use use but

**Gene:** Others can do it directly within here using the Python backend.
...
**Gene:** It adds a whole new module where you can see a reporting layer with everything that's been written.

**Gene:** It adds like.

**Gene:** you.

**Gene:** Data management, it replaces a large swath of BI tools and other ways that people were already doing this in the past, but it directly puts it on the platform.
...
**Gene:** It's like perfect right now, but it's like something that's can go a very long way for helping people get up on the platform pretty soon.
