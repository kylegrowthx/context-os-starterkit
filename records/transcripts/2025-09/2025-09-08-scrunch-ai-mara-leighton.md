...
participants: Vivek Shankar, Mariana Montezzana, Andrew Sorensen, Mara Leighton
...
To address questions about Scrunch AI's functionality and discuss reporting capabilities for client performance.
...
**Vivek Shankar**
- Submit Slack request to create Teams@growthxlabs.com user in Scrunch w/ all brand access + API permissions


**Mariana Montezzana**
- Log out & back into Scrunch to access newly added brands (Imbibit, Vallarta Adventures)

- Attempt reconnecting analytics in Scrunch using Teams@growthxlabs.com account (after account creation)
...
**Vivek Shankar:** No, it's not an error.

**Vivek Shankar:** It's a question.

**Andrew Sorensen:** Because what our chatbot is doing is our chatbot's hitting this URL and it's trying to confirm a certain criteria that they are present to optimize for visibility.
...
**Vivek Shankar:** No, it's just that webpage of that URL.

**Andrew Sorensen:** Oh, okay, just the homepage.
...
**Andrew Sorensen:** We're not seeing a

**Andrew Sorensen:** So of traffic there, then let's optimize for that, then I would run that through the site audit as well, just to make sure that it's got full visibility and it's being completely crawled and indexed.
...
**Andrew Sorensen:** Yeah, ChadGPT has different versions by country, and our default, if you, can you pull up your screen share again?
...
**Andrew Sorensen:** We just, we just created an updated Looker Studio report just for agencies and just for our largest, most enter.

**Andrew Sorensen:** Priced customers, there should be a, let me share my screen and we'll look at this together to keep me honest here.
...
**Mara Leighton:** Okay, yeah, because I think what we would be most interested in, or what clients might ask us about, is like.

**Mara Leighton:** To break it down into like individual seed prompts or which are the ones that are like performing best, what's there.

**Mara Leighton:** So I think they would be looking for that level of like granularity if we're talking about month over month reporting.

**Mara Leighton:** Yeah.

**Mara Leighton:** When we get in here to that, let's look at this here real quick.
...
**Andrew Sorensen:** We've gotten feedback that most of our clients would prefer a line as opposed to a donut.
...
**Andrew Sorensen:** That's coming soon as well.

**Andrew Sorensen:** But for right now, yeah, like this isn't really showing month over month.

**Andrew Sorensen:** I think this is just capturing everything that's in here.

**Andrew Sorensen:** Yeah.

**Mara Leighton:** So it sounds like right now we'll look at the Looker integration and see what's available through there.

**Mara Leighton:** And then otherwise, it seems like maybe right now, that's not something that we can report or Vivac, feel free to jump.

**Mara Leighton:** Ben, but if you maybe have another idea.

**Vivek Shankar:** Yeah, regarding the month-on-month, the only solution I found was to export the data, and then we used that spreadsheet, popped that into Looker, and then grouped the months together.

**Vivek Shankar:** Because if you say, like, 12 weeks, it actually lists a month in there.

**Vivek Shankar:** So there's no possibility it's constirectory, but if you export it, you can do it.

**Vivek Shankar:** All the days.
...
**Vivek Shankar:** And the other thing I just looked through the Looker instructions is, and this is part of

**Vivek Shankar:** Question for your team, we can generate the API key, but we want to integrate it with our existing Looker.
...
**Vivek Shankar:** Because I tried playing around.

**Vivek Shankar:** Let me do it right Because Looker is really finicky.

**Vivek Shankar:** tried popping in, seeing if I can put in an API key in Looker and get it that way, but it doesn't let me do it.

**Vivek Shankar:** So yeah, just those two things.

**Vivek Shankar:** One is like, you know, can we have a sort of shared email mailbox, basically, like Teams or whatever that has that access to generate the API key, and two is I will read through this doc, I guess.

**Vivek Shankar:** So here's the API documentation for you.

**Andrew Sorensen:** Hopefully that will help with that.

**Andrew Sorensen:** Let me go back real quick internal and just see how we have things set.

**Andrew Sorensen:** Because I thought we had one.

**Andrew Sorensen:** I thought we had a generic inbox.

**Andrew Sorensen:** I thought

**Andrew Sorensen:** Setup already, I just don't recall what it was.

**Vivek Shankar:** If it's set up as a user, then that's great.

**Vivek Shankar:** mean, but the main thing is like, you know, the guide is great.

**Vivek Shankar:** It's more that Looker doesn't allow me to enter an API key and pull in data.
...
**Mara Leighton:** Mariana, do you have any questions?

**Mara Leighton:** I want to give you a chance as well.

**Mara Leighton:** I do have questions, but I don't think it's for Andrew.

**Mariana Montezzana:** I want to know if it's possible to set up this for my other two clients.
...
**Mara Leighton:** For Scrunch, they should have dashboards.

**Mara Leighton:** Is that what you mean?

**Mara Leighton:** Yeah.

**Mara Leighton:** Yeah.

**Mara Leighton:** Like I have.

**Mariana Montezzana:** I got an invitation link to access abnormal space.

**Mariana Montezzana:** So the only access, I got another invitation to access ImmoBit space, but then when I click, it says no access to this client.

**Mariana Montezzana:** So I didn't understand it's because this client doesn't have the service or what do I need to do to set this up?

**Mariana Montezzana:** Mariana, what's your email, your work email?

**Andrew Sorensen:** Is it just Mariana?

**Andrew Sorensen:** Mariana, yeah.

**Andrew Sorensen:** At growthx.ai.

**Andrew Sorensen:** Growthx.ai.

**Andrew Sorensen:** I have X abnormal only.

**Andrew Sorensen:** Yep.

**Andrew Sorensen:** That's all that I see.
...
**Andrew Sorensen:** see if have them.

**Andrew Sorensen:** I don't see the Adventures Group.

**Mara Leighton:** I think it might be under maybe Cancun Adventures or Viacca Adventures.

**Mariana Montezzana:** see

**Mara Leighton:** Yeah, there's Vallarta Adventures, and then Imbibit, I did share access to, so I'm not sure why that one isn't working.

**Mara Leighton:** Let me click again on the email, see if I have access now.

**Mariana Montezzana:** No, I mean, yeah.
...
**Andrew Sorensen:** And then you said Vallarta, like V-A-L-L?

**Andrew Sorensen:** Yeah.

**Mariana Montezzana:** Vallarta Adventure, yep.

**Andrew Sorensen:** Layout to adventures.

**Andrew Sorensen:** Okay, Mariana, you should have access.

**Andrew Sorensen:** You'll have to log out and then log back in.

**Andrew Sorensen:** You should have access to all three of those now.

**Andrew Sorensen:** And going forward, you should have the ability to create brands when you need to as well.

**Andrew Sorensen:** Cool.

**Andrew Sorensen:** Okay.

**Mariana Montezzana:** And to connect everything with analytics, there's the AI traffic tab.

**Mariana Montezzana:** And then it says that I need to be logged in with the account I'm using to access analytics.

**Mariana Montezzana:** But the account we use to access analytics, it's Teams at growthx.

**Mariana Montezzana:** So, and I'm logged in with Mariana at growthx.

**Mariana Montezzana:** So how do I connect to their analytics?

**Andrew Sorensen:** You should be fine because it'll be, you'll just be logged into your GA4 and into scrunch in the same browser at the same time.

**Andrew Sorensen:** And then you should be able to, there should be a drop down and you should be able to select between whichever brand that you're running the data on.

**Andrew Sorensen:** Okay, I'll try this again.

**Mariana Montezzana:** Okay.

**Vivek Shankar:** Yeah, actually, I think we'll need to log in using the Teams ID when Andrew sets it up, and then we can see it for every account.

**Vivek Shankar:** Okay, thank you.

**Mariana Montezzana:** So they're all under Teams.

**Andrew Sorensen:** They're not under like individual.

**Andrew Sorensen:** There's not a GA4 instance for every individual brand.

**Andrew Sorensen:** Yeah, everything is under Teams.

**Vivek Shankar:** So that's why we connected our lookers to it as well.

**Vivek Shankar:** Got it, got got it.

**Vivek Shankar:** Okay, so perfect.
...
**Andrew Sorensen:** And Jaden's in there.

**Andrew Sorensen:** I know you've talked to Jaden, Mara, here recently.

**Andrew Sorensen:** Yeah.

**Andrew Sorensen:** So Jaden, I'll give him a heads up so we turn that around.

**Andrew Sorensen:** Awesome.

**Andrew Sorensen:** Well, thank you so much.

**Mara Leighton:** Really appreciate it.

**Mara Leighton:** I feel like that's probably a good amount for today.

**Mara Leighton:** But anything else, Mariana, Vivek, that you would like to ask?

**Mara Leighton:** Otherwise, we can give you five minutes back for.

**Mara Leighton:** For me.

**Mariana Montezzana:** Thank you.

**Mariana Montezzana:** Thank you so much.

**Andrew Sorensen:** Have a great week.
