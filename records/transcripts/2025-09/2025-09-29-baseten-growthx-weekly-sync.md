...
participants: Mike Bilodeau, Team GrowthX, Rachel Rapp, Kenzie Amack, Marylise Tauzia, Erik O'Brien
...
Weekly sync between BaseTen and GrowthX to discuss content strategy and generation process.
...
**Mike Bilodeau:** No, I think the, what I have run into in the past off of doing something sort of similar or what we see a lot is like blended context and timeframes on content.

**Mike Bilodeau:** Things go out of date really, really fast.

**Mike Bilodeau:** And in certain cases.

**Mike Bilodeau:** Things

**Mike Bilodeau:** Things, like, I'm just assuming these are models dealing with a lot of these things.

**Mike Bilodeau:** They have a tendency to get slightly confused on, like, context of where certain things are talked about.
...
**Mike Bilodeau:** Yeah, we just want, because, you know, even, I'm just looking at, it's like a lot of BLM, and I just want to make sure that we're, we're not getting attached to single architecture sort of views of the world, because like for us, there's CRT, VLM, which we are a lot more likely to recommend to folks, then there's VLM, which is also there, and there's SGLang as like kind of the primary engines that are out there.

**Mike Bilodeau:** And so I think, you know, getting citations, like we can dig through these and start to figure out where we want to, you know, avoid, but I think that would help us just be able to, yeah, make sure like one, we're linking to stuff that we would consider to be like high credibility, into into into into

**Mike Bilodeau:** That we're not sort of like out of date or even, yeah, I think, again, some of the stuff is going to be fine for us to test with.
...
**Mike Bilodeau:** Yeah, cool.

**Mike Bilodeau:** There are definitely things to wear.

**Mike Bilodeau:** Like, four.

**Mike Bilodeau:** Orbit weight quantization.

**Mike Bilodeau:** I don't think that we do that that way.

**Mike Bilodeau:** like, yeah, I think we'll just want to dig through some of these.

**Mike Bilodeau:** Because, again, this may be from what we did a year or two ago or three years ago.

**Mike Bilodeau:** Like, the products changed quite a lot.

**Mike Bilodeau:** So I just want to make sure we're to date.
...
**Mike Bilodeau:** I was going really quick, just when you're saying, it's like together modal fireworks dominate model release plus GPU content.

**Mike Bilodeau:** What does that mean specifically?

**Erik O'Brien:** Sorry, were you seeing seeing that?

**Mike Bilodeau:** that?

**Mike Bilodeau:** Sorry, Sorry, Thank

**Mike Bilodeau:** Top bullet that's currently visible, competitor, content, Gavin.
...
**Mike Bilodeau:** And so usually we would have to get there because I, I don't know, I'm just, you know, Google searching and kind of hitting like the new models that I know of, uh, for, for some things and like, I'm not a hundred percent seeing.

**Mike Bilodeau:** None.

**Mike Bilodeau:** Like, don't, I mean, if I put Kimmy K2, I'm on page, like, five now, but I don't see fireworks anywhere.

**Mike Bilodeau:** So I'm just, it would be good to understand, I think, like, like, part of this is, are they, like, we know everybody talks about the new models.

**Mike Bilodeau:** We do, too.

**Mike Bilodeau:** It's sort of a ubiquitous, everybody in the industry thing does it.

**Mike Bilodeau:** So I'd love to understand, like, is what they're doing working?

**Mike Bilodeau:** And there's something that we should be considering there, or, you know, my, my view on, like, when I look at their, how their stuff performs on social is unless they boost it, it really doesn't perform.

**Mike Bilodeau:** And I don't know, from the search perspective, I don't, I don't really see it, but I may not, I may just be missing what you guys are getting on the data side.
...
**Kenzie Amack:** I think think think think I I

**Kenzie Amack:** You know, view content, so like there's value there.
...
**Erik O'Brien:** If you guys have any issues with sharing with a team access account.

**Mike Bilodeau:** And just let us know.

**Mike Bilodeau:** We can give you individual names.
