...
Discuss progress on Sunbit's content automation and address technical requirements for seamless integration.
...
- New B2B and B2C topic clusters introduced to drive merchant signups and shop direct reviews
- Automation process nearly complete; final adjustments needed for webhook payload structure
- Traffic analysis revealed a slight dip; team to monitor for potential trends or anomalies
- Trey platform updates offer improved organization and navigation capabilities
...
**Ehtisham Hussain**
- Modify webhook payload - separate summary/key points from content, add cluster info (categories), include focus keywords, consider image. Test & send to Jason.
...
**Angel Kemper:** There's like two other squares.

**Kyle Gaudreau:** you my note takers?
...
**Angel Kemper:** Don't listen too hard.
...
**Kyle Gaudreau:** Uh, maybe he got a forced update.

**Jason Beltran:** I hope it's.

**Jason Beltran:** Yeah, probably.

**Kyle Gaudreau:** And he's back.

**Ehtisham Hussain:** I think I'm back.

**Ehtisham Hussain:** Yeah.

**Ehtisham Hussain:** So, uh, yeah, this has been happening for, I think the three days straight.
...
**Jason Beltran:** I have the same thing, yeah, I have like a match at work, and yeah, same thing happens to me.

**Ehtisham Hussain:** Right, so all these topics are up there, if you guys want to review them, these are kind of like middle of the funnel, bottom of the funnel topics, we are going up against some seriously high volume and high keyword difficulty keywords, but, you know, we've got traffic, we've got traction, we, I think we can, we are in a position to do this, we're going for, you know, what, high as 4,400 per month now, so, so let's look at these, I will continue with the other, like the general topics that we do on B2C.0 and B2C, you know, dentist, and dentistry cost, and those topics will be in there, but I've put these 40 new topics in there, so we can do

**Ehtisham Hussain:** Maybe five, or ten, and if you guys go through them.
...
**Jason Beltran:** All right, so...

**Jason Beltran:** so...

**Jason Beltran:** So...

**Jason Beltran:** Ehtisham Hussain, are you with us, or are you loose?

**Kyle Gaudreau:** I don't know.

**Jason Beltran:** That's all right.

**Ehtisham Hussain:** I think.
...
**Jason Beltran:** So let me show you what we got going on.

**Kyle Gaudreau:** So I had a couple of successful posts.

**Jason Beltran:** And he's out.

**Angel Kemper:** We'll get him back.

**Kyle Gaudreau:** Oh, my God.

**Ehtisham Hussain:** All right.

**Ehtisham Hussain:** Yeah, I'm sorry about that.

**Jason Beltran:** But please continue.

**Jason Beltran:** This is a recorded meeting.

**Ehtisham Hussain:** Okay.

**Ehtisham Hussain:** The devs are going to do the bulk of the work here anyway.
...
**Jason Beltran:** And then what I've also done within the script, and this is where I'm getting some failures, but I'm still working on it, is I'm trying to extract the submarine key points from the content and then have them output separately under separate keys.

**Jason Beltran:** to to from So what I'm script.

**Jason Beltran:** The summary and key points being the variables in HTML.
...
**Jason Beltran:** Right now, I'm using AI, it's a cloud.

**Jason Beltran:** It reads the content and then categorizes it for me.

**Jason Beltran:** But it would be nice if we just had that clean since we already have it in the clusters, like, if we can send that over.

**Jason Beltran:** And then I am, this is where I'm actually having Claude generate the focus keywords as well.

**Jason Beltran:** So.

**Jason Beltran:** So it would also be nice if, rather than having Cloud generate some focused keywords, actually having it in the trigger from growthx.

**Jason Beltran:** Yeah.

**Jason Beltran:** It's just, Cloud's just making stuff up for me, which is nice.

**Jason Beltran:** It's really nice.

**Jason Beltran:** It's like, here's some potential SEO meta keywords, and it gives me some, but it would be nice if they came from Cloud Yeah, we already have that in the US, so we can just put it in the document.
...
**Jason Beltran:** All of that's working really well, and the only thing right now, this morning, I'll fix it.

**Jason Beltran:** It'll be very quickly.

**Jason Beltran:** just this JavaScript that's extracting the key points in the summary, and then once I have that completed, or actually, it's, sorry, right now, what's failing is I'm trying to extract the actual key focus words from the generated text from Claude, so I'll fix that this morning, but hopefully, I can remove these two AI steps and have it all just in the post from growthx, and I'll be in a really good place.
...
**Ehtisham Hussain:** be, be, should be, we should should we

**Jason Beltran:** All right, all right.

**Jason Beltran:** Yeah, and also in the, I'm sorry, one other thing in the payload, there isn't an image.

**Jason Beltran:** And I didn't know if we were intending to have an image with the blog or not, but it's not necessary.

**Jason Beltran:** But we could, because we can go in and add our own images.

**Jason Beltran:** And also, I was just looking at it, and I was like, maybe we just don't even need an image.

**Jason Beltran:** But now that it's actually, we will need an image, yeah.

**Angel Kemper:** I have a question, too.

**Angel Kemper:** Are we still having to manually input, like, the related articles?

**Angel Kemper:** Okay, so it's automatically doing that, too?
...
**Kyle Gaudreau:** Yeah, generally, I would say we should.

**Kyle Gaudreau:** Plan for images.

**Kyle Gaudreau:** So certainly this is where we could advocate for not, but like to at least have the option.

**Jason Beltran:** Yeah, actually I was just thinking about it while talking.

**Jason Beltran:** And we actually do need the images.

**Jason Beltran:** Because the blog, when you get to the blog, the tiles have images.

**Jason Beltran:** Yeah, yeah, yeah.

**Kyle Gaudreau:** Before the excerpt somewhere.

**Kyle Gaudreau:** Yeah, we have had a couple customers who just go without that.

**Kyle Gaudreau:** And show the tile, you know, in a way that's like kind of, you know, in a certain wrapper.

**Kyle Gaudreau:** But you all weren't set up for that.

**Kyle Gaudreau:** So nor are we pushing for it either.
...
**Jason Beltran:** So what we're doing is in Canva, we'll get like an image and then we'll...

**Jason Beltran:** Angel will go in and like manipulate it a little bit, make sure the colors are all very similar.

**Jason Beltran:** But that's not a necessary thing.

**Jason Beltran:** It does look nice.

**Jason Beltran:** But if we're just getting stock imagery, that works as well.

**Ehtisham Hussain:** All right.

**Ehtisham Hussain:** All right.

**Ehtisham Hussain:** So I'll look into the image thing as well, and I've taken notes for all these requirements.

**Ehtisham Hussain:** So we'll do another test soon and see how it comes through.

**Jason Beltran:** That's good.

**Jason Beltran:** I'm excited.

**Jason Beltran:** This is going to be definitely step everything up and it'll be a game changer.

**Ehtisham Hussain:** So this is all there is from my side.

**Jason Beltran:** Cool.

**Jason Beltran:** Kyle, did you like looking at Trey again?

**Kyle Gaudreau:** You know, it's funny.

**Kyle Gaudreau:** was like, some things look different, some of it doesn't, but you know.

**Jason Beltran:** Yeah, they've changed up quite a bit.

**Jason Beltran:** So now they have this like project format and each of your workflows are within the product, like have a...

**Kyle Gaudreau:** Oh, that's huge that you can organize like that now.

**Jason Beltran:** Yeah.

**Jason Beltran:** And then you can actually go in if you have multiple, like here's our, I'll show you what Angel does on a day-to-day basis is building out our money.com.

**Jason Beltran:** So these are all of the workspaces.

**Jason Beltran:** So

**Jason Beltran:** Our workflows that we have for monday.com, but what's nice is we can go here and then navigate from one to the next.

**Jason Beltran:** We never had before.

**Jason Beltran:** You also have data tables, vector tables for AI.
...
**Jason Beltran:** And, you know, it's not make your life easier.

**Kyle Gaudreau:** Yeah, I think, you know, I get it, especially, you know, them leaning into the AI side more and more.

**Kyle Gaudreau:** And that touches a, there's, you know, some wild differences in how developers are thinking about that nowadays.

**Kyle Gaudreau:** You know, obviously being who we are and the types we hire, like it is like mandatory that like you are savvy in leveraging a cursor.

**Kyle Gaudreau:** But as a result, it is absolutely insane how fast this team can build things.

**Kyle Gaudreau:** Like our platform itself did not exist two, three months ago.

**Kyle Gaudreau:** And it is crazy what they've built in there and what's coming.

**Jason Beltran:** So it's, you know, pretty...

**Jason Beltran:** It's, it's pretty cool.
...
**Kyle Gaudreau:** Um, yeah, I'm curious, uh, what's had in the back of my head as you, uh, another time to pick your brain, just like how you interpret and think about things, uh, with the work auto.

**Kyle Gaudreau:** Um, they were, they were always like one of the biggest focus areas.

**Kyle Gaudreau:** They took a very different marketing strategy than we did at the time.

**Kyle Gaudreau:** And I think it was actually, uh, like we were beating them for a while and then they started to, uh, you know, go really get ahead of us.

**Kyle Gaudreau:** And I never knew though, how much in reality, you know, you hear internally, obviously the bias of what platforms better and what, but the reality of it.

**Jason Beltran:** So I'll give you a quick, quick, quick, um, perspective on that.

**Jason Beltran:** So I think all of the iPads are, um, at parity, um, as far as what their capabilities are, even when it comes to the AI agents, um, they all do the exact exact same thing.

**Jason Beltran:** I think, um,

**Jason Beltran:** There are layers of customization that you can do.

**Kyle Gaudreau:** So Zapier is very much like you can't really do much.

**Jason Beltran:** It's just easy and it's dummy proof.

**Jason Beltran:** It's like the iPhone of iPass.

**Jason Beltran:** And then you kind of go, you know, like then you have N8N, which is more for like your small business, but it doesn't have those enterprise features.

**Jason Beltran:** Then you go up to like Trey and Workato, and both of them have the customization capabilities, AI agents, very similar.

**Jason Beltran:** The UI of Trey is far superior.

**Jason Beltran:** Workato looks kind of like a child's software.

**Jason Beltran:** Like they didn't really put any time into the UI.

**Jason Beltran:** So that's a differentiator.

**Jason Beltran:** And then I think it comes to, it comes down right now to how they price.

**Kyle Gaudreau:** Yeah, totally.

**Jason Beltran:** So like the tasks that.

**Jason Beltran:** Trey prices on are much different than the way we're cut out of prices, what's different than A&N, and Zappier, they're all varied.

**Jason Beltran:** So, like, for us, it's more of, like, looking at what is that, what does their cost structure look like, and what's the most appealing to us, and then switching costs.

**Jason Beltran:** Yeah.

**Jason Beltran:** So much running through Trey.

**Kyle Gaudreau:** I understand why a lot of different platforms now in this current space have to think about things in terms of credits or tasks and things like that, but it is hard at times to think about, you know, for someone like yourself who's still in the weeds, I'm sure you can eventually connect the dots and, like, interpret.

**Kyle Gaudreau:** But, you know, I think it's such a tough barrier of entry of, like, well, I don't know, like, I haven't built these things yet, I don't know what to expect of how much I'm going to need, and what if I do something and I just blow through all of it, and, but I want to experiment.

**Kyle Gaudreau:** And so it's just the, yeah, it's a, I get it, but it's also a pretty interesting challenge to.

**Jason Beltran:** Yeah, I would assume because everyone's kind of gone to this consumption model, but the consumption model works for cloud because there's like greater understanding and everyone's kind of like you have teams that focus on it.

**Jason Beltran:** Same with like AI tokens, et cetera.

**Jason Beltran:** For something like this, I would assume that kind of just doing like the gym membership subscription model is the best.

**Jason Beltran:** You have like three or four tiers and depending on your use, you go from one tier to the next, but you know that you're going to have 20% of people who use the  out of it and 80% that never use it and they offset each other.

**Jason Beltran:** Yeah, it's just easier to price it and everyone kind of like digests it and they're like, okay, here's the pricing.

**Kyle Gaudreau:** very, it's like, you could use it as much as you want.
