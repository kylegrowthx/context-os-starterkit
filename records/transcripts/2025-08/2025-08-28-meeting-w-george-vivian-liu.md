...
participants: Vivian Liu, George Haikal
...
Catch up and discuss AI implementation challenges in Vivian's work at Mae.
...
**Vivian Liu**
- Break down AI process into detailed steps. Whiteboard each stage (transcript analysis, inventory matching, recommendation generation). Create Excel/chart view of workflow.

- Prep for potential call w/ Daniel (GrowthX CTO). List specific Qs, tech details. Determine abstraction level for discussion. Consider inviting Japnet.


**George Haikal**
- After fundraising (next week), arrange intro call between Vivian and Daniel re AI implementation strategies.
...
**George Haikal:** I'll be here.

**George Haikal:** Like.

**George Haikal:** Yeah, that's frustrating.

**Vivian Liu:** Yeah.

**George Haikal:** Some people just operate differently, Viv.

**Vivian Liu:** I know, but what if she's just like, I'll bring it back to you, like, one way or another next week.

**Vivian Liu:** Next  week?

**Vivian Liu:** Like.

**Vivian Liu:** don't Like.

**Vivian Liu:** What if she sloughs the diamond?
...
**Vivian Liu:** I'm like, trust me, don't give a  about your personal conversations.

**Vivian Liu:** Like, I don't want to store that .

**Vivian Liu:** It's going cost me money.
...
**George Haikal:** Hmm, hmm, hmm, hmm, hmm, hmm, hmm, hmm, hmm, hmm, hmm,
...
**George Haikal:** Let do that for every different vertical and part of the industry that you're in, and want to be in, then there's company context about your company, but as much research as possible on your company, and then blah, blah, blah.
