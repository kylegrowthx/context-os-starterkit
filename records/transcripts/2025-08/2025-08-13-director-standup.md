...
participants: Mara Leighton, Megan, darrell, jakubrudnik, Jason Gong, Matthew Panzarino, Dave Capone, Andi Bailey
...
Discuss content production processes and efficiency improvements across different pods.
...
**darrell:** It's been a client day.

**Andi Bailey:** Hmm.

**Andi Bailey:** Town is still...

**darrell:** Shant and E messaged me separately, but he's blaming Edasham, but it's not Edasham's fault, because that is the fix that we should have made.

**darrell:** He just likes rules.

**darrell:** What's that?

**darrell:** The other person put it in her hands.

**darrell:** Because it was the right fix.

**darrell:** It's the right fix.

**darrell:** But Jean-Denis, I told Edasham this, I was like...

**darrell:** You just have to understand that he is extremely rules and system-based, and so nothing can deviate from the established rules and systems without explicit direction.

**darrell:** That's just the way he works.

**darrell:** It doesn't matter if you have a good fix and you're just going to implement it.

**darrell:** He doesn't want that an issue.

**darrell:** He wants things to follow exactly the pattern we laid out.

**darrell:** But I got dot, dot, dot on him right now because he texted and he DMed me separately and was like, I don't like Eda Shum.
...
**darrell:** Jean Denis from town.

**darrell:** He's a very smart guy.

**darrell:** He's just extremely rules and system-oriented.

**Andi Bailey:** Yeah, we don't have anybody better than Eda Shum.

**darrell:** No, I know.

**darrell:** I was like, oh, I mean, I said, look, I think there are some specific tactical things that we'll work on.

**darrell:** But, you know, he's actually very competent on other broader things, like project management.

**darrell:** This isn't the thing that he usually spends time on.

**darrell:** So that was the excuse.

**darrell:** But like, I was like, we'll work on it.

**darrell:** And if there is no improvement over the next couple of weeks, let me know.

**Andi Bailey:** But yeah, so is he like, should we put him with somebody who's like, super editorially focused then?

**darrell:** Like, no, no, you should put him with someone who is like, just good at following very explicit directions and has no creative thought or agency whatsoever.

**darrell:** So I don't know who that would be.
...
**Andi Bailey:** Where we're bottlenecking in the process and trying to like fix things holistically.
...
**darrell:** For most of mine, tons, except for like a bit where they're like, oh, we just want to move super, super slow.

**darrell:** They won't even improve their outlines and batches greater than like two or three weeks, and they don't approve most of them.

**darrell:** I mean, you were on that call earlier, Andy.

**darrell:** So I thought we would get alignment by switching to thought leadership, but a part of it doesn't think we can do thought leadership.
...
**darrell:** But with the other ones, we have tons of approved topics, and similarly, we're doing this right now with Tanon, although John is still typing, so I do not like where this message is going.

**darrell:** But we are getting ahead to build a buffer, We're sprinting this week to get ahead with them.
...
**darrell:** Yeah, we're just going through the approved topics and then generating more articles because we have a huge backlog of approved topics.
...
**darrell:** Are you doing that?

**darrell:** Well, most of the clients don't require the outlines.

**darrell:** And I think this is unique maybe to the two that me and Matthew were referring to.

**darrell:** Maybe there's one or two others that had that.

**darrell:** Aftershoot had that for a while, but they've now given up on that and are very happy doing it with our bulk production.

**darrell:** But yeah, those are the other ones that have the outline thing.

**darrell:** On the topic thing, like we bring them up earlier.

**darrell:** Just meeting to meeting, Edith Shum and Carrie will bring like new topic clusters if we're running low on the previous ones.

**darrell:** But most of the other clients also don't have much to say or debate or go back and forth on when it comes to those.

**darrell:** They're kind of like, ah, I would order this one above this one.

**darrell:** But like, I agree.

**darrell:** And they really don't even look at the subtopics under the cluster.

**darrell:** They just kind of speak to the cluster.

**darrell:** And then they kind of trust our guidance to the topics within the cluster.
...
**darrell:** I have a notes thing that I use for cloud generation just in sequence.
...
**darrell:** So I think, I mean, there's some custom pipelines we're using that are in Atlas, but a lot of the generation, especially the generation that I'm doing, is happening just in Cloud, because eventually it gets too frustrating to try to use it in Atlas, because it was, like, even when...

**darrell:** Atlas was doing a good job.

**darrell:** If I looked at them side by side, I'm like, well, Claude's much better.

**darrell:** So I'm going to use that one.

**darrell:** This is my town one.

**darrell:** And I'll place it as like, I guess, plain text or code or something so that it doesn't expand.

**darrell:** But it's very simple.

**darrell:** And then I just like run that over and over again.

**darrell:** I changed the article topic.

**darrell:** Each paragraph break represents like a new prompt because otherwise I find it doesn't follow those instructions very closely.

**darrell:** Can you drop it?

**darrell:** In the Ddirector's channel in Slack.

**darrell:** But that's basically like I realized I was just doing this repetitively.

**darrell:** So I put them in a thing and then pasted it.

**darrell:** So like in theory, there's no reason you couldn't build that into a pipeline because all you have to do is call Claude Sonnet, which is what I'm using, and then do that with the project artifacts as reference.

**darrell:** Documents, as long as it can access those agentically, whatever sequence it wants.

**darrell:** But that produces stuff where, for everything else John Denis doesn't like about us, he does like the content, so they're very happy with that side of things, right?
