...
Weekly sync to discuss content creation, product integration, and process updates for Biologica's blog and marketing efforts.
...
- New content cluster focusing on ingredients and their combinations is prioritized
- Updates to content artifacts and review processes are ongoing, with feedback from multiple team members
- Technical integrations for Shopify and image creation are in progress
- Product card placement in blog posts needs clarification from the dev team
...
**Matthew Panzarino**
- Ensure Katya (design engineer) receives Future font files for blog title cards

- Follow up w/ Matthew (dev team) re product cards - templated page or embed code for body copy
...
**Brian Magida:** Brain, brain, brain.
...
**Brian Magida:** And when you're actually, like, it's pretty interesting, because I've gone through this process where I'm starting to learn a little bit more about.

**Brian Magida:** through process where I'm where where I'm I'm

**Brian Magida:** Like products that are targeting like a specific hormonal stage.
...
**Brian Magida:** And that also goes, I think in the content, there might have been stuff with like L-thalene and GABA.
...
**Brian Magida:** Oh, the other thing too, Liz is reviewing those inconvenient pages.
...
**Brian Magida:** Manufacturer, the dev team will be the right people to talk to you about that.

**Brian Magida:** Cool.

**Brian Magida:** then...

**Brian Magida:** Of I have to find the...

**Brian Magida:** ...

**Brian Magida:** ...

**Brian Magida:** Was it TM Actors?
...
**Brian Magida:** My, my assumption, I could very well be wrong, is the, the bit that I know about the, the way that manufacturers building is it'll, I forget the exact technical term, but it's going to be like, I think a block within the CMS.
