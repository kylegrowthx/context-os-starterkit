...
Weekly catch-up to discuss ongoing projects, updates, and blockers across various platforms and tools used by the GrowthX Labs team.
...
- Record videos for Zan - vendor vs pages publishing, alternatives. Highlight dependency order

- Inform Marcus about Zan automatic publishing issue instead of draft


**Oluwatimilehin Ademosu**
- Ping Paul and CEO for Strapi API key in new thread
...
**Vivek Shankar:** Publishing automation.

**Vivek Shankar:** Vivek, you follow up on Tuesday.

**Vivek Shankar:** Well, I didn't follow up.

**Vivek Shankar:** Okay.

**Vivek Shankar:** I need to do that.
...
**Nika Narimanidze:** I think Markus is very close.

**Nika Narimanidze:** I

**Nika Narimanidze:** We have some small details left.
...
**Nika Narimanidze:** I off."

**Nika Narimanidze:** So when we mapped, we had a different scenario, and now it's a different scenario.

**Nika Narimanidze:** The same thing was with data reprities, so it's a big different issue.
...
**Vivek Shankar:** We have Shrappy, think we had a couple, right, over here?
...
**Vivek Shankar:** just going back to the publishing, looking at the comments, you mentioned the locking, the API key, reached out the Strap key, did you reach out the Strap key, the API key?
...
**Vivek Shankar:** Just a reminder, again, you guys.

**Vivek Shankar:** Do Here

**Vivek Shankar:** Like, just make sure you, you know, follow all processes, et cetera.

**Vivek Shankar:** If there's something that's happening or just ask me.

**Vivek Shankar:** So, yeah, that's pretty much it from my end.
