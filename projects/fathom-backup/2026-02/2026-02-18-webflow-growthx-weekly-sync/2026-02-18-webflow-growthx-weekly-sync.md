...
participants: Kelly We, Meg Murray, Kirat Chhina, Colin Lateano, Michael Huard, Jason Gong, Luke Stahl, Vivian Hoang, Anushri Gupta, Darin LaFramboise, Rachel Wolan, Vic Plummer, Zach Plata, Liz Kushnereit, Raymond Camden, Kirkland Gee, Paige Kehoe, Adam Lehman, Team GrowthX
...
Align on the strategy, prioritization, and user experience for the new code component library.
...
**Liz Kushnereit:** So that's more just like an FYI to see how everything overall fits together.

**Liz Kushnereit:** and

**Liz Kushnereit:** And is useful for y'all in that like if you see something that doesn't align with the work we're doing on code components or like the cloud cookbook, if there's like something there that is like alarming, please escalate.
...
**Liz Kushnereit:** So this is our component prioritization framework.
...
**Liz Kushnereit:** But it's really up to y'all.

**Liz Kushnereit:** Thank

**Liz Kushnereit:** And it would obviously be helpful to like take the time to read through this, but, and not a question you have to answer today.
...
**Liz Kushnereit:** Like, I'll just reiterate like, like,

**Liz Kushnereit:** Overall, the relationship, so I have the little North Star, I think it's like we're creating content for that beginner dev or like enabling dev audience and truly, truly good content is like our North Star.

**Liz Kushnereit:** so like Code Components falls under that and like how do you actually enable someone to really, really build and learn how to build in Webflow.

**Liz Kushnereit:** And so all of our success, and that's kind of my last also two cents here is like all of our success is not necessarily hinging on conversion or anything like that.

**Liz Kushnereit:** Or, you know, we want to see the chart go up and to the right, but more so we want to create something that's actually, actually good, not slop.

**Liz Kushnereit:** And Colin has been very clear and reiterated that many, many times, and that would definitely still be an expectation here.

**Liz Kushnereit:** But then in working with y'all, we'd also like to better understand like what you would also see success being and how we might somehow measure that beyond, like we've talked about LLM visibility, but anything else.

**Liz Kushnereit:** Just to add a little more context for you, Adam.
...
**Liz Kushnereit:** I don't personally have an opinion on like stalling on anything there.

**Liz Kushnereit:** think, you know, work done should be like utilized, but it's, I don't know.
...
**Liz Kushnereit:** I'll post follow up notes.

**Liz Kushnereit:** Yeah.

**Liz Kushnereit:** Sorry.

**Liz Kushnereit:** And then we'll, we can talk more later, but thanks y'all.

**Kirkland Gee:** It good to meet you both.
