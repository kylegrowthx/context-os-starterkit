...
source: fathom
enriched_on: 2026-02-27T15:00:00Z
</metadata>
...
CheckThat pricing, answers, and reviews pages doubled in impressions this week, driving strong lower-funnel growth, while brand pages declined for the second consecutive week. A critical pipeline bug is halting all new content generation—the system generates articles from error messages instead of research data. Jason will escalate engineering priorities with Stevie to unblock high-impact tickets while the team develops GrowthX and AI-led Growth content strategies and example pages for Alternatives and Answer formats.

---

## Context

CheckThat's content pipeline generates SEO-optimized pages for SaaS alternatives, reviews, pricing pages, and answer content. The weekly sync reviews performance metrics, unblocks engineering issues, and coordinates content production across three properties: CheckThat (core product), GrowthX (bottom-funnel B2B content), and AI-led Growth (educational marketing content). The team is now expanding the pipeline model to power GrowthX and AI-led Growth through "example good" page templates that engineering can build toward, avoiding the need for manual production at scale.

---

## Relevance

- **Product Strategy:** Demonstrates how to replicate CheckThat's scalable content success (pricing, answers, reviews) across GrowthX and AI-led Growth properties. Clarifies the distinction between bottom-funnel (GrowthX) and educational (AI-led Growth) content.
- **Engineering Alignment:** Identifies critical misalignment between content growth goals and engineering capacity. Jason escalating to Stevie to resolve conflict between signup conversion focus and top-of-funnel content infrastructure.
- **Marketing Operations:** Establishes the "example good" page pattern to guide pipeline development and avoid manual production bottlenecks. Identifies need for Cursor setup session to improve team efficiency with AI-assisted content rewriting.
- **SEO & Performance:** Shows strong momentum in lower-funnel pages (pricing/answers/reviews doubled impressions) but reveals brand page cannibalization risk. Highlights index.me data lag issue and need for conversion tracking by page type.
...
- Set up Cursor with Saskia and Kavishka; walk through pipeline and process workflows

---

## Transcript

**Jason Gong:** I invited Danni because basically we're trying to do what we're doing here for CheckThat for GrowthX and AI-led growth as well. So the more context we can share, the better. I really like the kind of cadence we've been getting into, other than no engineering tickets are being done.

**Jason Gong:** For the data for today at the top, the first table, I don't have a login for PostHog, which I only figured out an hour ago. And Kavishka was struggling to figure out a way to get the stats.

**Saskia Wartnaby:** So if you could take us through that maybe at the end of the call, that would be great. And then my next question for you were the to-dos from the previous week. Did you want that to show like the leftover tasks, or was that all the tasks from last week?

**Jason Gong:** Just all the tasks, and then checked off. Okay, cool. Let me just take a quick browse. It looks like things are getting indexed and showing impressions fairly well.

**Saskia Wartnaby:** We've had a lot of impression growth like from the past week. I don't know if you had a look at the metrics review table, but yeah, there's been a lot of growth. Kavishka is struggling to get anything from index.me because it's just not updated. Answers like doubled in impressions. Same for reviews, alternatives went up a bit, pricing also like doubled. Brand pages have gone down two weeks in a row now in impressions, so that's just something to note.

**Jason Gong:** Is that like a setup thing or is it just because I feel like it should be up to date if it's working?

**Kavishka Kanayake:** It hasn't updated to what Search Console is on. Search Console shows the date up until the 21st and index shows first week of Feb.

**Jason Gong:** Yeah, that was quite a long time ago. Is that just a tool problem or do you think we set it up wrong?

**Kavishka Kanayake:** I'm not sure. I'll dig around and see if there's anything we could do. They aren't one-to-one. I just used it—that's like the closest thing to see if pages are getting indexed, because if a page is getting impressions, it's definitely indexed, right? So because I can't break down pricing, alternatives, reviews in Search Console in the indexing report, I've been using page impressions as a stopgap.

**Jason Gong:** It looks like on February 14th we had an indexing issue get fixed, and then this jumped up immediately after. I guess we can get to it once we get to the tickets, because it looks like they did merge some of the indexing-related tickets, so maybe those are helping. But I guess what I'm seeing is pricing is driving all the growth.

**Saskia Wartnaby:** One of the thoughts is like the more we publish here, the more it kind of cannibalizes this, because I've spot-checked a bunch of brand pages. Yeah, pricing is like one of the top things the brand pages rank for. So I would still like to try to see if we can improve them. If you, not refresh, but like reformat just for concision and readability, because yeah, they're just very dense. I wouldn't want to read it.

**Jason Gong:** Yeah, if it's worth it at all. I guess I'm thinking more of like across all the pages, are there things we can experiment with? Like the title is one that I think might be holding the page back, and I'm trying to think like how to restructure that. I would honestly look at that first. Like if you think there's a better meta title that these pages could have. Just for brand pages. Just better meta title and meta description.

**Saskia Wartnaby:** I'm also trying to publish a bunch of answer pages, and they seem to be doing quite well. I'm also trying a few refreshers, just with Kavishka's general research process. I'm not changing the information, just changing how we talk about it, and the structuring, and seeing if that makes any noticeable difference.

**Kavishka Kanayake:** I'll be fleshing out this page you're looking at, because we got the results back. It's mostly just that. I'll be doing that for reviews, and I think we could do that for alternatives as well. How we talk about the product, like instead of it being this very clinical, third-party sort of tone of voice, I just rewrite it to be we tried this, we experimented, we reviewed this. That's the editorial approach.

**Jason Gong:** One question on how you're rewriting. You're using Claude, just like Opus 4.6, or do you have kind of a special setup?

**Kavishka Kanayake:** No, I do use Claude.

**Jason Gong:** I've been getting a bunch of people on the team set up on Cursor, and that's been helping a ton. So maybe I might schedule a session later in the week where we all just set up Cursor together. Because that might make this slightly easier or faster.

**Jason Gong:** One of the tickets was about like adding authors to the page. So essentially is what you're doing, like kind of writing instead of saying like, you know, hey, tool A is, you know, it's a paid plan or whatever. Like you were more speaking from like first person.

**Kavishka Kanayake:** Pretty much, yeah. I'm trying to speak from personal experience.

**Jason Gong:** So maybe I feel like that changed with the author. Maybe that could help as well. So like who's the author of the page, they have a bio and the perspective they're writing from, and then you kind of tie that into how you're writing.

**Jason Gong:** For what it's worth, one of the things I'm going to set up is just like how these page types convert to signups. But I think these three here, like I'm just guessing, are much, much more likely to drive signups. So because they're like much lower in the funnel. You know, if any of these companies that we're writing about invest in SEO at all, like they're looking at this category of pages constantly. But pricing is less. Like you know, I'm thinking about all the stuff we do for clients, and like you know, often we write about kind of pricing, unless it's in the context of a listicle. So yeah, I guess like in a general sense, like I would much much prefer like prioritizing these if you think they're working and like doubling down, like publishing way more, you know, doing everything we were doing for pricing pages to get it to this point.

**Saskia Wartnaby:** Now, on that note, we kind of took a little bit of a step back this week because yeah, so we spoke with Stevie and she basically said like they are focusing heavily on something, so they have limited capacity at the moment for the next couple of weeks. And she's also focusing on higher priority things to do with converting signups. So she really said like she's really not sure when the team is going to get to any of our tickets.

**Jason Gong:** I'm trying to find the thread, because basically like what Marcel and Daniel are telling me for is like, cool, like pushing people really, really hard to like pay for CheckThat might not be the thing. Like we need more growth so we can use it to drive top of funnel for everything else for like the platform that we're releasing. So I feel like those two things are kind of contradictory, so I just want to see if there's any threads I can keep kind of hammering on. This is a P0 for me, just like sorting out this. Like we know what we need to do to grow, but these tickets have been sitting here for a month at this point and not really sure. I feel like Stevie's also getting maybe conflicted kind of stuff from Marcel and then from me, from us.

**Saskia Wartnaby:** And then we had a big fallback in quality with all of the pages this week, last week, basically they made some updates to make it so that the article generations didn't keep failing. But instead now, if it couldn't find the data, which was happening a lot, it generated a report to say it couldn't find the data. And then it used that as like research content for the article. So all of the pages had like, "this couldn't be verified from our research, blah blah blah blah blah." So they did push a fix, refresh all the pages, and that still hasn't helped.

**Jason Gong:** Okay, so it looks like that workflow problem is in review. Does it mean they're looking into it?

**Saskia Wartnaby:** Yeah, so they already did a fix, and then I went through some of the rerun articles today and shared it with the team, and now they're having to look into it again. I don't think he's updated the ticket to be honest. Let me get that complete. It's a very long thread. Basically, it started with Kavishka just reporting the issues we were having, and then the team were chatting about the issue, and then you'll see that we ran a whole bunch of articles, and then I replied with all the issues we're still having.

**Jason Gong:** Yeah, I guess like P0 for me is just like sorting out this. Like we know what we need to do to grow, but these tickets have been sitting here for a month at this point and not really sure. So I will sync with Stevie to align on P0 tickets.

**Saskia Wartnaby:** We've also published a bunch of answer pages, and they seem to be doing quite well. And we're working on implementing the editorial tone that Kavishka has been developing. We're also trying to map out the AI Visibility brands and publish missing brand pages and subpages.

**Jason Gong:** Okay cool. So let's move to the GrowthX and AI-led Growth strategy. I invited Danni because basically we're trying to do what we're doing here for CheckThat for GrowthX and AI-led growth as well. And I really like the kind of cadence we've been getting into. So the more context we can share, the better.

**Danni Roseman:** I'm just observing all of the greatness right now. What does this look like feasibly when it comes to timeline? Because I know I'm hearing that you guys are backed up with stuff with engineering team and when could we realistically have that goal?

**Jason Gong:** And then in the meantime, would you rather, like if the goal is under 100 or like 50 articles, what is the in-between goal since that won't be enough? So let's see, the things that are blocked now is like, hey, we already know what good content looks like and it is engineering's responsibility to create a pipeline that can generate, you know, that at scale and they need to fix it. Like that's where we're at now. And then the right mental model for publishing is like, you should almost never try to hit whatever number of pages we're trying to publish just manually because the pipelines are broken. The main thing you're responsible for and trying to do is to make it crystal clear to engineering what they need to fix. For clients, we do this a lot just because they're going to be like, who cares? It's like your problem that your pipelines don't work. Like I care about the quality out the door, but like for us, I just want to get into the mindset of like the only way any of this works is if we can get pipelines that spit out good content at scale. So as long as you have kind of that defined for engineering, you know, and cool engineering doesn't have time so we can't hit 50 in a week, that's fine. Does that make sense? So like for this week. Let's make the goal that all this is either defined or hopefully already on the way to getting set up. And then we have kind of at least a few examples of content that engineering can build towards when they're setting up the content generation pipelines.

**Jason Gong:** And then once we flesh out the content strategy, like generally what that looks like is you know, you'll have many types of content that you want to generate at quality and scale. Like so for example, for CheckThat, we have, you know, we have brand pages, pricing, alternatives, reviews, and then answers, actually like two or three different types. You know, so that's like five or six different, different pipelines, and I think we'll have, you know, probably the same for AI-led growth and growthx, but you don't need to know what all of them, all of them are from the beginning. So um. Yeah, let's start with these two that we know we'll need to have, and then once we do the content strategy, it'll be a little bit more clear what the other, you know, three or four are, and then we can kick those off next week.

**Saskia Wartnaby:** How do you want us to generate the example of good? Do you just want us to find an example in check that, or do you want us to try and create it with like code or something?

**Jason Gong:** I think because it's these two types and we have pretty good pipelines on CheckThat, we should just generate the like initial draft from there and then kind of like polish it a bit with Claude or, it sounds like Danni's pretty deep into Cursor, so maybe you can show Saskia and Kavishka how Cursor's working too before we get a chance to all set it up later. Yeah, but I would go about it that way, like I would start from CheckThat, just so you're not starting from zero, and then do a couple rounds with like Claude or Cursor.

**Danni Roseman:** One thing that's still kind of a little bit blurry for me is the difference between GrowthX and AI-led Growth content. It's only slightly nuanced where it's more agency-focused, but there's still the same types of content. But I also don't know if I fully understand how you all manage to make something sound authoritative from that perspective while using a pipeline as well. Maybe because I just, I'm sure it's possible, but I don't have that context fully. I like how you make it sound almost editorial, but like mass-produced.

**Jason Gong:** I think we need to think through that because I think you're right. There are overlapping a ton. This is hopefully we can think through in the content strategy a bit. Yeah, I don't think I have a good answer for that. Like the agency angle, I think is probably something that will just exist on GrowthX. But then as you start to get like a layer above to the platform, that's where AI-led Growth comes in.
