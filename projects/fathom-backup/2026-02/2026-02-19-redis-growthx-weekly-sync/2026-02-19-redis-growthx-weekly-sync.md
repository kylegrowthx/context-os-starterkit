...
participants: Andy Varshneya, Allison Gregory, Megan Boone, Fung-Lin Wu, Alexis Ruiz-Pedregon, Erik O'Brien, Reet Mand, Team GrowthX
...
Review performance and strategize for the upcoming e-staff review.
...
**Reet Mand:** And it was talking about, it was talking about how you guys launched something where you can see, I I you're helpful.

**Reet Mand:** I don't Thank
...
**Reet Mand:** I think so we're preparing preparing on.

**Reet Mand:** My e-staff review for the quarter and anything you can share from here that like you think, you know, would lack of a better way of saying it, blow the execs away.
...
**Erik O'Brien:** And so what we're, you know, the larger vision is that instead of having you, like, set up a new instance from scratch and have to come up with all these new prompts, you can literally just come in here and, like, add prompts from the shared library of everything.
...
**Erik O'Brien:** Whatever kind of category you want, and so you can just pick these, and once you upload them to your account, then you get all the historical data that comes with it to see kind of, have we been mentioned in these categories historically?
...
**Erik O'Brien:** But other than that, we had nine articles published last week, five more this week.

**Erik O'Brien:** So we're getting on a really good cadence.

**Erik O'Brien:** cadence.
...
**Fung-Lin Wu:** We actually have a paid advertising agency, and we've actually been working with them because I think Google might have just announced that they, I could try to find it and send it over, but we also did notice that our direct traffic went haywire, like the last December and January, where we saw this like crazy, like doubled amount of sessions.

**Fung-Lin Wu:** They said that our agency, they say that Google put some announcement that there's just like a lot of bots coming in from Singapore.

**Fung-Lin Wu:** I think it's Singapore, if remember, so they were able to filter it out on our reporting side, but within GA4, they're filtering it out for our reporting, but I'm guessing maybe that's the same, but I think these bots might just...
...
**Fung-Lin Wu:** Yeah, I just shared, I just shared.

**Fung-Lin Wu:** A Google support ticket, a Google support post, talking about these bots.
...
**Fung-Lin Wu:** How should I about it from, um, how should I think about it in terms of, like, obviously we care about, again, we care about the growth.

**Fung-Lin Wu:** We care about...

**Fung-Lin Wu:** Thank you.

**Fung-Lin Wu:** Traffic, growth from LLM, and then we care about conversion as a primary.
...
**Erik O'Brien:** And really it's ChatGPT, Gemini Perplexity, Claude is a really hard one to get a referral from just because unless you have web browsing on, they don't provide any citations.

**Erik O'Brien:** So more of a kind of platform nuance for them, but ChatGPT is I think about 90% of all LLM referral traffic.

**Erik O'Brien:** So it's good we're seeing a good split between Perplexity and Google too.

**Erik O'Brien:** And then conversions we did.

**Erik O'Brien:** So what is semantic caching is a refresh that we did and multi-agents versus single agents.

**Erik O'Brien:** So good to see continuing traffic.

**Erik O'Brien:** think we've got like one extra conversion compared to the last time I showed you guys the data.

**Erik O'Brien:** I don't know why these aren't registering visually, but overall still tracking for kind of goals for February is to kind of, at least double.

**Erik O'Brien:** I think we had two in January.

**Erik O'Brien:** So try to get four to five conversions.
...
**Erik O'Brien:** Yeah, so these are a lot of the landing pages, like Docs, Solutions.

**Erik O'Brien:** And what, I guess what the TLDR is, there's probably a couple blog posts overall that are leading to hand raisers, like, what is Valky?

**Erik O'Brien:** But, I think...

**Erik O'Brien:** Thank you.

**Erik O'Brien:** Something for us to kind of start thinking about more strategically is, you know, if we want to focus on hand raisers, then it might make sense for us to think through how we enter some, like, CTAs or callouts in the body itself versus a lot of what we're doing right now is having, like, the CTA or, like, talk to Redis at the very bottom of the article.

**Erik O'Brien:** So more so kind of, I guess, a question back to you guys is if we want to explore putting some of those, like, CTAs and callouts earlier on in the article, maybe around some more of the technical pieces that we typically link to.

**Fung-Lin Wu:** Like a more, like, book a meeting?

**Erik O'Brien:** Yeah, and we can experiment with different CTAs, like, book a meeting or talk to an expert or kind of different ways to...

**Fung-Lin Wu:** you saying?

**Fung-Lin Wu:** Like, putting it as a...

**Fung-Lin Wu:** Like, kind of like as, like a section break within the article.
