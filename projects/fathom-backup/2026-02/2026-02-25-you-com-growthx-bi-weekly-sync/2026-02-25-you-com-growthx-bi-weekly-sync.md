...
participants: Fred Fireflies, Team GrowthX, Justin Fink, Brooke Grief, Bailey Seybolt
...
Align on content pipeline and AI visibility strategy.
...
**Brooke Grief**
- Route 2 white-paper-derived posts to SMEs for review
- Test Check That data for Feb monthly report; send feedback to Bailey

**Bailey Seybolt**
- Send 'Emails' white paper to editorial; request blog breakdown w/ keyword validation
- Add persona labels in Airtable for Brooke
- Build AI visibility strategy (Notion) w/ constrained + ideal-state options; share w/ Brooke
- Send AI visibility/content-value docs to Brooke for exec convos
- Add marketing ops team member to Check That; ask Brooke for email if needed
- Resurface Check That Loom in Slack for Brooke; she'll share w/ team

---

## Transcript
**Bailey Seybolt:** I'll share our agenda.
