<metadata>
purpose: How to write prompts for reliable competitive intelligence from AI engines.
source: https://handbook.growthx.ai/guides/marketing/aeo-prompt-writing
sync_type: auto
access: build-team
last_synced: 2026-03-02
</metadata>

# AEO prompt writing methodology
...
This guide is not about *which tool* to use. It is about **how to write the inputs** (prompts) that feed those tools. For the general principles of prompt design — structure, techniques, and iteration — see [Prompt design fundamentals](/guides/ai/prompt-design-fundamentals). This guide applies those principles specifically to AEO monitoring.
