<metadata>
purpose: Giving AI systems the right context to work reliably.
source: https://handbook.growthx.ai/guides/ai/context-engineering
sync_type: auto
access: build-team
