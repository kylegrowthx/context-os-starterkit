<metadata>
purpose: The full product vision for CheckThat — the market shift, our approach, and why we'll win AI visibility.
source: https://handbook.growthx.ai/products/checkthat/vision
sync_type: auto
access: build-team
...
```mermaid
flowchart LR
    A["Public data"] --> B["Search rankings"]
    B --> C["Traffic"]
    C --> D["Brand tracking"]
    D --> E["More data"]
    E --> F["Better benchmarks"]
    F --> A
```
...
- [Architecture](/products/checkthat/architecture) — the six-layer system that powers CheckThat
- [Methodology](/products/checkthat/methodology) — the four-score measurement framework
- [AI Benchmark](/products/checkthat/benchmark) — the public category visualization
