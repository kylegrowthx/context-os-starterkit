<metadata>
purpose: Core messaging framework, positioning, differentiators, and voice guidelines for CheckThat.
source: https://handbook.growthx.ai/products/checkthat/messaging
sync_type: auto
access: build-team
...
- [CheckThat overview](/products/checkthat/overview) — quick intro and navigation hub
